...
#define TCC899X_PA_VIOC		0x12000000
#define TCC899X_PA_I2C0		0x16300000
#define TCC899X_PA_I2C1		0x16310000
#define TCC899X_PA_I2C2		0x16320000
#define TCC899X_PA_I2C3		0x16330000

#define TCC899X_PA_DWC3		0x11B00000
#define TCC899X_PA_EHCI		0x11A00000
#define TCC899X_PA_OHCI		0x11A80000
#define TCC899X_PA_EHCI_MUX	0x11900000
#define TCC899X_PA_OHCI_MUX	0x11940000
#define TCC899X_PA_DWC_OTG	0x11980000

extern void __init tcc_map_common_io(void);

static struct of_dev_auxdata tcc899x_auxdata_lookup[] __initdata = {
	OF_DEV_AUXDATA("telechips,vioc-fb", TCC899X_PA_VIOC, "tccfb", NULL),
	OF_DEV_AUXDATA("telechips,i2c", TCC899X_PA_I2C0, "i2c.0", NULL),
	OF_DEV_AUXDATA("telechips,i2c", TCC899X_PA_I2C1, "i2c.1", NULL),
	OF_DEV_AUXDATA("telechips,i2c", TCC899X_PA_I2C2, "i2c.2", NULL),
	OF_DEV_AUXDATA("telechips,i2c", TCC899X_PA_I2C3, "i2c.3", NULL),
