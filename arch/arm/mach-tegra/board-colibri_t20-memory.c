...
#if 1
//from Max: ap20_emc_reg_tool.exe -i MEM2G16D2DABG.par -o 333MHz.cfg
	{
		.rate = 333000,   /* SDRAM frquency */
		.regs = {
			0x00000014,   /* RC */
			0x00000041,   /* RFC */
			0x0000000f,   /* RAS */
...
#else
//ColibriTegra2_333_nand_512mb.cfg
	{
		.rate = 333000,   /* SDRAM frquency */
		.regs = {
			0x00000014,   /* RC */
...
{
	tegra_init_emc(colibri_t20_emc_chips,
		       ARRAY_SIZE(colibri_t20_emc_chips));
