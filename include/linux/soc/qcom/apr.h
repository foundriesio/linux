...
//int apr_init_client(struct apr_svc_ch_dev *apr);
//int apr_smd_write(struct apr_svc_ch_dev *apr_ch, void *data, int len);
//int apr_smd_close(struct apr_svc_ch_dev *apr_ch);
