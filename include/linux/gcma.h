...
inline int gcma_alloc_contig(struct gcma *gcma, unsigned long start,
		unsigned long end)
{
	return 0;
}

void gcma_free_contig(struct gcma *gcma, unsigned long pfn,
...
int gcma_alloc_contig(struct gcma *gcma, unsigned long start_pfn,
		unsigned long size);
void gcma_free_contig(struct gcma *gcma, unsigned long start_pfn,
		unsigned long size);
