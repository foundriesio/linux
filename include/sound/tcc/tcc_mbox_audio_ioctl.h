...
#define IOCTL_MBOX_AUDIO_DATA_TX_0_SET_CONTROL	_IOW(IOCTL_MBOX_AUDIO_MAGIC, 0x59, struct tcc_mbox_data)
#define IOCTL_MBOX_AUDIO_DATA_TX_0_GET_CONTROL	_IOWR(IOCTL_MBOX_AUDIO_MAGIC, 0x5A, struct tcc_mbox_data) //do not use

#define IOCTL_MBOX_AUDIO_DATA_TX_1_SET_CONTROL	_IOW(IOCTL_MBOX_AUDIO_MAGIC, 0x5B, struct tcc_mbox_data)
#define IOCTL_MBOX_AUDIO_DATA_TX_1_GET_CONTROL	_IOWR(IOCTL_MBOX_AUDIO_MAGIC, 0x5C, struct tcc_mbox_data) //do not use

#define IOCTL_MBOX_AUDIO_DATA_TX_2_SET_CONTROL	_IOW(IOCTL_MBOX_AUDIO_MAGIC, 0x5D, struct tcc_mbox_data)
#define IOCTL_MBOX_AUDIO_DATA_TX_2_GET_CONTROL	_IOWR(IOCTL_MBOX_AUDIO_MAGIC, 0x5E, struct tcc_mbox_data) //do not use

#define IOCTL_MBOX_AUDIO_DATA_RX_0_SET_CONTROL	_IOW(IOCTL_MBOX_AUDIO_MAGIC, 0x5F, struct tcc_mbox_data)
#define IOCTL_MBOX_AUDIO_DATA_RX_0_GET_CONTROL	_IOWR(IOCTL_MBOX_AUDIO_MAGIC, 0x60, struct tcc_mbox_data) //do not use

//if app makes header directly, use below ioctl
#define IOCTL_MBOX_AUDIO_CONTROL	_IOWR(IOCTL_MBOX_AUDIO_MAGIC, 0x61, struct tcc_mbox_data) 
