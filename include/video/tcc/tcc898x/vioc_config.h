...
#define CFG_PATH_FDLY1_OFFSET				(0x07C)
...
#define CFG_PATH_DTRC0_OFFSET				(0x300)
#define CFG_PATH_DTRC1_OFFSET				(0x304)
...
#define RAWSTATUS0_DTRC1_SHIFT				(26)	// DTRC1 interrupt Status
#define RAWSTATUS0_DTRC0_SHIFT				(25)	// DTRC0 interrupt Status
...
#define RAWSTATUS0_DTRC1_MASK				(0x1 <<	RAWSTATUS0_DTRC1_SHIFT)
#define RAWSTATUS0_DTRC0_MASK				(0x1 <<	RAWSTATUS0_DTRC0_SHIFT)
...
#define SYNCSTATUS0_DTRC1_SHIFT				(26)	// DTRC1 Sync Interrupt Status
#define SYNCSTATUS0_DTRC0_SHIFT				(25)	// DTRC0 Sync Interrupt Status
...
#define SYNCSTATUS0_DTRC1_MASK				(0x1 <<	SYNCSTATUS0_DTRC1_SHIFT)
#define SYNCSTATUS0_DTRC0_MASK				(0x1 <<	SYNCSTATUS0_DTRC0_SHIFT)
...
#define IRQSELECT0_DTRC1_SHIFT				(26)	// DTRC1 Sync Interrupt Select
#define IRQSELECT0_DTRC0_SHIFT				(25)	// DTRC0 Sync Interrupt Select
...
#define IRQSELECT0_DTRC1_MASK				(0x1 <<	IRQSELECT0_DTRC1_SHIFT)
#define IRQSELECT0_DTRC0_MASK				(0x1 <<	IRQSELECT0_DTRC0_SHIFT)
...
/*
 * Sync Interrupt Select 1 Registers
 * @Description: 0 - Normal, 1 - Interrupt
 */
...
#define IRQMASKSET0_DTRC1_SHIFT				(26)	// DTRC1 Interrupt Mask
#define IRQMASKSET0_DTRC0_SHIFT				(25)	// DTRC0 Interrupt Mask
...
#define IRQMASKSET0_DTRC1_MASK				(0x1 <<	IRQMASKSET0_DTRC1_SHIFT)
#define IRQMASKSET0_DTRC0_MASK				(0x1 <<	IRQMASKSET0_DTRC0_SHIFT)
...
#define IRQMASKCLR0_DTRC1_SHIFT				(26)	// DTRC1 Interrupt Mask Clear
#define IRQMASKCLR0_DTRC0_SHIFT				(25)	// DTRC0 Interrupt Mask Clear
...
#define IRQMASKCLR0_DTRC1_MASK				(0x1 <<	IRQMASKCLR0_DTRC1_SHIFT)
#define IRQMASKCLR0_DTRC0_MASK				(0x1 <<	IRQMASKCLR0_DTRC0_SHIFT)
 ...
 * Vector ID Registers
 */
#define VECTORID_IVALID_SHIFT				(31)	// Invalid Interrupt
#define	VECTORID_INDEX_SHIFT				(0)	// Interrupt Index

#define VECTORID_IVALID_MASK				(0x1 << VECTORID_IVALID_SHIFT)
#define	VECTORID_INDEX_MASK				(0x3F << VECTORID_INDEX_SHIFT)
 ...
 */
#define PWR_AUTOPD_NG_SHIFT				(17)	// VIDEOMARK Auto Power Down Mode
#define PWR_AUTOPD_DTRC_SHIFT				(16)	// DTRC Auto Power Down Mode
#define PWR_AUTOPD_MC_SHIFT				(15)	// Map Conv Auto Power Down Mode
#define PWR_AUTOPD_DENGX_SHIFT				(14)	// Mixer for DISP Auto Power Down Mode
...
#define PWR_AUTOPD_NG_MASK				(0x1 << PWR_AUTOPD_NG_SHIFT)
#define PWR_AUTOPD_DTRC_MASK				(0x1 << PWR_AUTOPD_DTRC_SHIFT)
#define PWR_AUTOPD_MC_MASK				(0x1 << PWR_AUTOPD_MC_SHIFT)
#define PWR_AUTOPD_DENGX_MASK				(0x1 << PWR_AUTOPD_DENGX_SHIFT)
...
#define PWR_BLK_PWDN1_DTRC1_SHIFT			(30)	// DTRC1 Power Down
...
#define PWR_BLK_PWDN1_DTRC0_SHIFT			(19)	// DTRC0 Power Down
...
#define PWR_BLK_PWDN1_DTRC1_MASK			(0x1 << PWR_BLK_PWDN1_DTRC1_SHIFT)
...
#define PWR_BLK_PWDN1_DTRC0_MASK			(0x1 << PWR_BLK_PWDN1_DTRC0_SHIFT)
...
#define PWR_BLK_SWR1_DTRC1_SHIFT			(30)	// DTRC1 Reset
...
#define PWR_BLK_SWR1_DTRC0_SHIFT			(19)	// DTRC0 Reset
...
#define PWR_BLK_SWR1_DTRC1_MASK				(0x1 << PWR_BLK_SWR1_DTRC1_SHIFT)
...
#define PWR_BLK_SWR1_DTRC0_MASK				(0x1 << PWR_BLK_SWR1_DTRC0_SHIFT)
 ...
 * @Description: 0 - Normal, 1 - Reset
 */
#define PWR_BLK_SWR4_NG_SHIFT				(8)	// NG Reset
...
#define PWR_BLK_SWR4_NG_MASK				(0xF << PWR_BLK_SWR4_NG_SHIFT)
 ...
 * @Description: 0 - Normal, 1 - PWDN
 */
#define PWR_BLK_PWDN4_NG_SHIFT				(8)	// NG Power Down
...
#define PWR_BLK_PWDN4_NG_MASK				(0xF << PWR_BLK_PWDN4_NG_SHIFT)
...
#define PWR_BLK_PWDN2_SC_MASK				(0x1F << PWR_BLK_PWDN2_SC_SHIFT)
...
#define PWR_BLK_SWR2_SC_MASK				(0x1F << PWR_BLK_SWR2_SC_SHIFT)
 ...
 * @Description: k=0,1
 */
#define CFG_PATH_NG0_EN_SHIFT				(31)	// PATH Enable
#define CFG_PATH_NG0_ERR_SHIFT				(18)	// Device Error
#define CFG_PATH_NG0_STS_SHIFT				(16)	// Path Status
#define CFG_PATH_NG0_SEL_SHIFT				(0)	// Path Selection

#define CFG_PATH_NG0_EN_MASK				(0x1 << CFG_PATH_NG0_EN_SHIFT)
#define CFG_PATH_NG0_ERR_MASK				(0x1 << CFG_PATH_NG0_ERR_SHIFT)
#define CFG_PATH_NG0_STS_MASK				(0x3 << CFG_PATH_NG0_STS_SHIFT)
#define CFG_PATH_NG0_SEL_MASK				(0xFF << CFG_PATH_NG0_SEL_SHIFT)

#define CFG_PATH_NG1_EN_SHIFT				(31)	// PATH Enable
#define CFG_PATH_NG1_ERR_SHIFT				(18)	// Device Error
#define CFG_PATH_NG1_STS_SHIFT				(16)	// Path Status
#define CFG_PATH_NG1_SEL_SHIFT				(0)	// Path Selection

#define CFG_PATH_NG1_EN_MASK				(0x1 << CFG_PATH_NG1_EN_SHIFT)
#define CFG_PATH_NG1_ERR_MASK				(0x1 << CFG_PATH_NG1_ERR_SHIFT)
#define CFG_PATH_NG1_STS_MASK				(0x3 << CFG_PATH_NG1_STS_SHIFT)
#define CFG_PATH_NG1_SEL_MASK				(0xFF << CFG_PATH_NG1_SEL_SHIFT)
...
/*
 * DTRC k Path Configuration k Registers
 * @Description: k=0,1
 */
#define CFG_PATH_DTRC0_EN_SHIFT				(31)	// PATH Enable
#define CFG_PATH_DTRC0_ERR_SHIFT			(18)	// Device Error
#define CFG_PATH_DTRC0_STS_SHIFT			(16)	// Path Status
#define CFG_PATH_DTRC0_SEL_SHIFT			(0)	// Path Selection

#define CFG_PATH_DTRC0_EN_MASK				(0x1 << CFG_PATH_DTRC0_EN_SHIFT)
#define CFG_PATH_DTRC0_ERR_MASK				(0x1 << CFG_PATH_DTRC0_ERR_SHIFT)
#define CFG_PATH_DTRC0_STS_MASK				(0x3 << CFG_PATH_DTRC0_STS_SHIFT)
#define CFG_PATH_DTRC0_SEL_MASK				(0x1F << CFG_PATH_DTRC0_SEL_SHIFT)

#define CFG_PATH_DTRC1_EN_SHIFT				(31)	// PATH Enable
#define CFG_PATH_DTRC1_ERR_SHIFT			(18)	// Device Error
#define CFG_PATH_DTRC1_STS_SHIFT			(16)	// Path Status
#define CFG_PATH_DTRC1_SEL_SHIFT			(0)	// Path Selection

#define CFG_PATH_DTRC1_EN_MASK				(0x1 << CFG_PATH_DTRC1_EN_SHIFT)
#define CFG_PATH_DTRC1_ERR_MASK				(0x1 << CFG_PATH_DTRC1_ERR_SHIFT)
#define CFG_PATH_DTRC1_STS_MASK				(0x3 << CFG_PATH_DTRC1_STS_SHIFT)
#define CFG_PATH_DTRC1_SEL_MASK				(0x1F << CFG_PATH_DTRC1_SEL_SHIFT)
