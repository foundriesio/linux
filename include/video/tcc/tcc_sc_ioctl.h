...
#define TCC_SC_IOCTL_SET_VCC_LEVEL		_IOW(TCC_SC_IOCTL_MAGIC, 0, unsigned)
#define TCC_SC_IOCTL_ENABLE				_IOW(TCC_SC_IOCTL_MAGIC, 1, unsigned) 
#define TCC_SC_IOCTL_ACTIVATE			_IOW(TCC_SC_IOCTL_MAGIC, 2, unsigned) 
#define TCC_SC_IOCTL_RESET				_IOW(TCC_SC_IOCTL_MAGIC, 3, stTCC_SC_BUF) 
#define TCC_SC_IOCTL_DETECT_CARD		_IOR(TCC_SC_IOCTL_MAGIC, 4, unsigned) 
#define TCC_SC_IOCTL_SET_CONFIG			_IOW(TCC_SC_IOCTL_MAGIC, 5, stTCC_SC_CONFIG) 
#define TCC_SC_IOCTL_GET_CONFIG			_IOR(TCC_SC_IOCTL_MAGIC, 6, stTCC_SC_CONFIG) 
#define TCC_SC_IOCTL_SEND				_IOW(TCC_SC_IOCTL_MAGIC, 7, stTCC_SC_BUF) 
#define TCC_SC_IOCTL_RECV				_IOR(TCC_SC_IOCTL_MAGIC, 8, stTCC_SC_BUF) 
#define TCC_SC_IOCTL_SEND_RCV			_IOWR(TCC_SC_IOCTL_MAGIC, 9, stTCC_SC_BUF) 
#define TCC_SC_IOCTL_SET_IO_PIN_CONFIG	_IOW(TCC_SC_IOCTL_MAGIC, 100, unsigned) 
#define TCC_SC_IOCTL_GET_IO_PIN_CONFIG	_IOR(TCC_SC_IOCTL_MAGIC, 101, unsigned) 
#define TCC_SC_IOCTL_NDS_SEND_RCV		_IOWR(TCC_SC_IOCTL_MAGIC, 102, stTCC_SC_BUF) 
