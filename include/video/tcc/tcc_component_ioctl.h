...
enum TCC_COMPONENT_LCDC_TYPE {
	COMPONENT_LCDC_0,
	COMPONENT_LCDC_1,
	COMPONENT_LCDC_MAX
};

enum TCC_COMPONENT_MODE_TYPE {
	COMPONENT_NTST_M,
	COMPONENT_PAL,
	COMPONENT_720P,
	COMPONENT_1080I,
...
struct TCC_COMPONENT_START_TYPE {
	unsigned char lcdc;
	unsigned char mode;
...
struct TCC_COMPONENT_DISPLAY_TYPE {
	enum TCC_COMPONENT_LAYER_TYPE layer;
	char enable;
...
struct TCC_COMPONENT_CGMS_TYPE {
