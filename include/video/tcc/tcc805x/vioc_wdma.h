...
/* Interface APIs. */
extern void VIOC_WDMA_SetImageEnable(void __iomem *reg, unsigned int nContinuous);
...
extern void VIOC_WDMA_SetDataFormat(void __iomem *reg, unsigned int fmt_type, unsigned int fill_mode);
extern void VIOC_WDMA_SetImageRGBSwapMode(void __iomem *reg, unsigned int rgb_mode);
...
extern void VIOC_WDMA_SetImageSize(void __iomem *reg, unsigned int sw, unsigned int sh);
extern void VIOC_WDMA_SetImageBase(void __iomem *reg, unsigned int nBase0, unsigned int nBase1, unsigned int nBase2);
extern void VIOC_WDMA_SetImageOffset(void __iomem *reg, unsigned int imgFmt, unsigned int imgWidth);
extern void VIOC_WDMA_SetImageOffset_withYV12(void __iomem *reg, unsigned int imgWidth);
extern void VIOC_WDMA_SetImageEnhancer(void __iomem *reg, unsigned int nContrast, unsigned int nBright, unsigned int nHue);
extern void VIOC_WDMA_SetIreqMask(void __iomem *reg, unsigned int mask, unsigned int set);
