...
/* Interface APIs */
extern void VIOC_DISP_SetDefaultTimingParam(void __iomem *reg, unsigned int nType);
extern void VIOC_DISP_SetControlConfigure(void __iomem *reg, stLCDCTR *pCtrlParam);
...
extern void VIOC_DISP_SetSize (void __iomem *reg, unsigned int nWidth, unsigned int nHeight);
extern void VIOC_DISP_GetSize(void __iomem *reg, unsigned int *nWidth, unsigned int *nHeight);
...
extern void VIOC_DISP_SetBGColor(void __iomem *reg, unsigned int BG0, unsigned int BG1, unsigned int BG2, unsigned int BG3);
extern void VIOC_DISP_SetPosition(void __iomem *reg, unsigned int startX, unsigned int startY );
extern void VIOC_DISP_GetPosition(void __iomem *reg, unsigned int *startX, unsigned int *startY );

extern void VIOC_DISP_SetColorEnhancement(void __iomem *reg, signed char contrast, signed char brightness, signed char hue );
extern void VIOC_DISP_GetColorEnhancement(void __iomem *reg, signed char *contrast, signed char *brightness, signed char *hue );
extern unsigned int VIOC_DISP_FMT_isRGB(unsigned int pxdw);
extern void VIOC_DISP_GetDisplayBlock_Info(void __iomem *reg, struct DisplayBlock_Info *DDinfo);
extern void VIOC_DISP_SetClippingEnable(void __iomem *reg, unsigned int enable);
extern void VIOC_DISP_GetClippingEnable(void __iomem *reg, unsigned int *enable);
extern void VIOC_DISP_SetClipping(void __iomem *reg, unsigned int uiUpperLimitY, unsigned int uiLowerLimitY, unsigned int uiUpperLimitUV, unsigned int uiLowerLimitUV);
extern void VIOC_DISP_GetClipping(void __iomem *reg, unsigned int *uiUpperLimitY, unsigned int *uiLowerLimitY, unsigned int *uiUpperLimitUV, unsigned int *uiLowerLimitUV);
extern void VIOC_DISP_SetDither(void __iomem *reg, unsigned int ditherEn, unsigned int ditherSel, unsigned char mat[4][4]);
extern void VIOC_DISP_SetTimingParam (void __iomem *reg, stLTIMING *pTimeParam);
//extern void VIOC_DISP_SetPixelClockDiv( void __iomem *reg, stLTIMING *pTimeParam);
extern void VIOC_DISP_SetPixelClockDiv(void __iomem *reg, unsigned int div);
extern void VIOC_DISP_TurnOn (void __iomem *reg);
#if defined(CONFIG_VIOC_DOLBY_VISION_EDR)
extern void VIOC_DISP_TurnOnOff_With_DV(void __iomem *reg, unsigned int bOn);
#endif
...
extern void VIOC_DISP_SetControl(void __iomem *reg, stLCDCPARAM *pLcdParam);
extern void VIOC_DISP_SetIreqMask(void __iomem * pDISP, unsigned int mask, unsigned int set);
extern void VIOC_DISP_SetStatus(void __iomem * pDISP, unsigned int set);
extern void VIOC_DISP_GetStatus(void __iomem * pDISP, unsigned int *status);
extern void VIOC_DISP_EmergencyFlagDisable(void __iomem *reg);
extern void VIOC_DISP_EmergencyFlag_SetEofm(void __iomem *reg, unsigned int eofm);
extern void VIOC_DISP_EmergencyFlag_SetHdmiVs(void __iomem *reg, unsigned int hdmivs);
