...
/* Interface APIs */
extern void VIOC_AFBCDec_GetBlockInfo(void __iomem *reg, unsigned int *productID, unsigned int *verMaj, unsigned int *verMin, unsigned int *verStat);
extern void VIOC_AFBCDec_SetContiDecEnable(void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetSurfaceN(void __iomem *reg, VIOC_AFBCDEC_SURFACE_NUM nSurface, unsigned int enable);
extern void VIOC_AFBCDec_SetAXICacheCfg(void __iomem *reg, unsigned int cache);
extern void VIOC_AFBCDec_SetAXIQoSCfg(void __iomem *reg, unsigned int qos);
extern void VIOC_AFBCDec_SetSrcImgBase(void __iomem *reg, unsigned int base0, unsigned int base1);
extern void VIOC_AFBCDec_SetWideModeEnable(void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetSplitModeEnable(void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetYUVTransEnable(void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetImgFmt(void __iomem *reg, unsigned int fmt, unsigned int enable_10bit);
extern void VIOC_AFBCDec_SetImgSize(void __iomem *reg, unsigned int width, unsigned int height);
extern void VIOC_AFBCDec_GetImgSize(void __iomem *reg, unsigned int *width, unsigned int *height);
extern void VIOC_AFBCDec_SetBoundingBox(void __iomem *reg, unsigned int minX, unsigned int maxX, unsigned int minY, unsigned int maxY);
extern void VIOC_AFBCDec_GetBoundingBox(void __iomem *reg, unsigned int *minX, unsigned int *maxX, unsigned int *minY, unsigned int *maxY);
extern void VIOC_AFBCDec_SetOutBufBase(void __iomem *reg, unsigned int base0, unsigned int base1, unsigned int fmt, unsigned int width);
extern void VIOC_AFBCDec_SetBufferFlipX(void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetBufferFlipY(void __iomem *reg, unsigned int enable);
extern unsigned int VIOC_AFBCDec_GetStatus(void __iomem *reg);
extern void VIOC_AFBCDec_SetIrqMask(void __iomem *reg, unsigned int enable, unsigned int mask);
extern void VIOC_AFBCDec_ClearIrq(void __iomem *reg, unsigned int mask);
extern void VIOC_AFBCDec_TurnOFF(void __iomem *reg);
extern void VIOC_AFBCDec_TurnOn(void __iomem *reg, VIOC_AFBCDEC_SWAP swapmode);
extern void VIOC_AFBCDec_SurfaceCfg(void __iomem *reg, unsigned int base,
...
extern void VIOC_AFBCDec_DUMP(void __iomem *reg, unsigned int vioc_id);
