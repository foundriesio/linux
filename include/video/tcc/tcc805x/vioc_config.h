...
#define CFG_WMIX_PATH_SWR_OFFSET		(0x0E8)
 ...
 */
#define RAWSTATUS0_DEV3_SHIFT				(30)	// Display Controller 3 Interrupt Status
...
#define RAWSTATUS0_DEV3_MASK				(0x1 << RAWSTATUS0_DEV3_SHIFT)
...
#define RAWSTATUS1_SC5_SHIFT				(12)	// Scaler5 Interrupt Status
...
#define RAWSTATUS1_SC5_MASK				(0x1 << RAWSTATUS1_SC5_SHIFT)
 ...
 */
#define RAWSTATUS2_WD13_SHIFT				(18)		// WD13 Interrupt Status
...
#define RAWSTATUS2_FBC_DEC1_SHIFT			(1)		// PVRIC_FBDC 01 Interrupt Status
#define RAWSTATUS2_FBC_DEC0_SHIFT			(0)		// PVRIC_FBDC_00 Interrupt Status

#define RAWSTATUS2_WD13_MASK				(0x1 << RAWSTATUS2_WD13_SHIFT)
 ...
 * @Description: 0 - Normal, 1 - Interrupt
 */
#define SYNCSTATUS0_DEV3_SHIFT				(30)	// Display Controller 3 Sync Interrupt Status
...
#define SYNCSTATUS0_DEV3_MASK				(0x1 <<	SYNCSTATUS0_DEV3_SHIFT)
 ...
 */
#define SYNCSTATUS2_WD13_SHIFT				(18)		// WDMA12 Sync Interrupt Status
...
#define SYNCSTATUS2_FBC_DEC1_SHIFT			(1)		// PVRIC_FBDC_01 Sync Interrupt Status
#define SYNCSTATUS2_FBC_DEC0_SHIFT			(0)		// PVRIC_FBDC_00 Sync Interrupt Status

#define SYNCSTATUS2_WD13_MASK				(0x1 << SYNCSTATUS2_WD13_SHIFT)
 ...
 */
#define TEST_LOOP_LVIN7_SHIFT				(14)	// Loopback select for VIN7 (FOR DEBUG)
#define TEST_LOOP_LVIN6_SHIFT				(12)	// Loopback select for VIN6 (FOR DEBUG)
#define TEST_LOOP_LVIN5_SHIFT				(10)	// Loopback select for VIN5 (FOR DEBUG)
#define TEST_LOOP_LVIN4_SHIFT				(8)	// Loopback select for VIN4 (FOR DEBUG)
...
#define TEST_LOOP_LVIN7_MASK				(0x3 << TEST_LOOP_LVIN7_SHIFT)
#define TEST_LOOP_LVIN6_MASK				(0x3 << TEST_LOOP_LVIN6_SHIFT)
#define TEST_LOOP_LVIN5_MASK				(0x3 << TEST_LOOP_LVIN5_SHIFT)
#define TEST_LOOP_LVIN4_MASK				(0x3 << TEST_LOOP_LVIN4_SHIFT)
 ...
 */
#define CFG_MISC1_LCD3_SEL_SHIFT			(30)	// LCD3 PATH select
...
#define CFG_MISC1_LCD3_SEL_MASK				( 0x3 << CFG_MISC1_LCD3_SEL_SHIFT)
 ...
 */
#define CFG_FBC_DEC_SEL_AXSM_SEL_SHIFT			(12)			// PVRIC_FBDC_AXSM Select
#define CFG_FBC_DEC_SEL_AD_PATH_SEL01_SHIFT		(5)			// RDMA number to use PVRIC_FBDC01
#define CFG_FBC_DEC_SEL_AD_PATH_SEL00_SHIFT		(0)			// RDMA number to use PVRIC_FBDC00
 ...
 */
#define CFG_DEV_SEL_P3_EN_SHIFT				(31)	// DEV3 Path Enable
#define CFG_DEV_SEL_DEV3_STAT_SHIFT			(28)	// DEV3 Path Status
#define CFG_DEV_SEL_DEV3_PATH_SHIFT			(24)	// DEV2 Path Select
...
#define CFG_DEV_SEL_P3_EN_MASK				(0x1 << CFG_DEV_SEL_P3_EN_SHIFT)
#define CFG_DEV_SEL_DEV3_STAT_MASK			(0x7 << CFG_DEV_SEL_DEV3_STAT_SHIFT)
#define CFG_DEV_SEL_DEV3_PATH_MASK			(0x3 << CFG_DEV_SEL_DEV3_PATH_SHIFT)
...
#define PWR_BLK_PWDN1_DEV3_SHIFT			(30)
...
#define PWR_BLK_PWDN1_DEV3_MASK				(0x1 << PWR_BLK_PWDN1_DEV3_SHIFT)
 ...
 */
#define WMIX_PATH_SWR_PF_SHIFT				(14)	// PVRIC_FBDC Reset
#define WMIX_PATH_SWR_MIX60_SHIFT			(12) // MIX60
#define WMIX_PATH_SWR_MIX50_SHIFT			(10) // MIX50
#define WMIX_PATH_SWR_MIX40_SHIFT			(8) // MIX40
#define WMIX_PATH_SWR_MIX30_SHIFT			(6) // MIX30
#define WMIX_PATH_SWR_MIX23_SHIFT			(5) // MIX23
#define WMIX_PATH_SWR_MIX20_SHIFT			(4) // MIX20
#define WMIX_PATH_SWR_MIX13_SHIFT			(3) // MIX13
#define WMIX_PATH_SWR_MIX10_SHIFT			(2) // MIX10
#define WMIX_PATH_SWR_MIX03_SHIFT			(1) // MIX03
#define WMIX_PATH_SWR_MIX00_SHIFT			(0) // MIX00

#define WMIX_PATH_SWR_PF_MASK				(0x3 << WMIX_PATH_SWR_PF_SHIFT)
#define WMIX_PATH_SWR_MIX60_MASK			(0x1 << WMIX_PATH_SWR_MIX60_SHIFT)
#define WMIX_PATH_SWR_MIX50_MASK			(0x1 << WMIX_PATH_SWR_MIX50_SHIFT)
#define WMIX_PATH_SWR_MIX40_MASK			(0x1 << WMIX_PATH_SWR_MIX40_SHIFT)
#define WMIX_PATH_SWR_MIX30_MASK			(0x1 << WMIX_PATH_SWR_MIX30_SHIFT)
#define WMIX_PATH_SWR_MIX23_MASK			(0x1 << WMIX_PATH_SWR_MIX23_SHIFT)
#define WMIX_PATH_SWR_MIX20_MASK			(0x1 << WMIX_PATH_SWR_MIX20_SHIFT)
#define WMIX_PATH_SWR_MIX13_MASK			(0x1 << WMIX_PATH_SWR_MIX13_SHIFT)
#define WMIX_PATH_SWR_MIX10_MASK			(0x1 << WMIX_PATH_SWR_MIX10_SHIFT)
 ...
 */
#define IRQSELECT0_DEV3_SHIFT				(30)	// Display Device 3 Sync Interrupt Select
...
#define IRQSELECT0_DEV3_MASK				(0x1 <<	IRQSELECT0_DEV3_SHIFT)
...
#define IRQSELECT1_SC5_SHIFT				(12)	// Scaler5 Sync Interrupt Select
...
#define IRQSELECT1_SC5_MASK				(0x1 << IRQSELECT1_SC5_SHIFT)
 ...
 */
#define IRQSELECT2_WD13_SHIFT			(18)	// WDMA13 Interrupt Select
...
#define IRQSELECT2_FBC_DEC1_SHIFT		(1)		// PVRIC_FBDC1 Interrupt Select
#define IRQSELECT2_FBC_DEC0_SHIFT		(0)		// PVRIC_FBDC0 Interrupt Select

#define IRQSELECT2_WD13_MASK			(0x1 << IRQSELECT2_WD13_SHIFT)
 ...
 */
#define IRQMASKSET0_DEV3_SHIFT				(30)	// Display Device 3 Interrupt Mask
...
#define IRQMASKSET0_DEV3_MASK				(0x1 <<	IRQMASKSET0_DEV3_SHIFT)
...
#define IRQMASKSET1_SC5_SHIFT				(12)	// Scaler5 Interrupt Mask
...
#define IRQMASKSET1_SC5_MASK				(0x1 << IRQMASKSET1_SC5_SHIFT)
...
#define IRQMASKSET2_WD13_MASK			(0x1 << IRQMASKSET2_WD13_SHIFT)
 ...
 */
#define IRQMASKCLR0_DEV3_SHIFT				(30)	// Display Device 3 Interrupt Mask Clear
...
#define IRQMASKCLR0_DEV3_MASK				(0x1 <<	IRQMASKCLR0_DEV3_SHIFT)
...
#define IRQMASKCLR1_SC5_SHIFT				(12)	// Scaler5 Interrupt Mask Clear
...
#define IRQMASKCLR1_SC5_MASK				(0x1 << IRQMASKCLR1_SC5_SHIFT)
 ...
 * Interrupt Mask Set k_2 Register
 */
#define IRQMASKCLR2_WD13_SHIFT			(18)		// WDMA13 Interrupt Mask
...
#define IRQMASKCLR2_FBC_DEC1_SHIFT		(1)		// PVRIC_FBDC1 Interrupt Mask
#define IRQMASKCLR2_FBC_DEC0_SHIFT		(0)		// PVRIC_FBDC0 Interrupt Mask

#define IRQMASKCLR2_WD13_MASK			(0x1 << IRQMASKCLR2_WD13_SHIFT)
...
extern void VIOC_CONFIG_WMIXPathReset(unsigned int Path, unsigned int reset);
