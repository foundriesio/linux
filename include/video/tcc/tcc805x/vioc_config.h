 ...
 * @Description: 0 - Normal, 1 - Interrupt
 */
#define SYNCSTATUS0_DEV3_SHIFT (30) // Display Controller3 Sync Interrupt Status
...
#define CFG_MISC0_L3_EVS_SEL_SHIFT (12) // Select VS signal for Display Port 3
...
#define CFG_FBC_DEC_SEL_AD_PATH_SEL01_SHIFT (5) // RDMA num to use PVRIC_FBDC01
#define CFG_FBC_DEC_SEL_AD_PATH_SEL00_SHIFT (0) // RDMA num to use PVRIC_FBDC00
 ...
 */
#define IRQSELECT0_DEV3_SHIFT (30)	// Display Device3 Sync Interrupt Select
...
extern int VIOC_CONFIG_MCPath(
	unsigned int component,
	unsigned int type);
extern void VIOC_CONFIG_WMIXPathReset(
	unsigned int Path, unsigned int reset);
