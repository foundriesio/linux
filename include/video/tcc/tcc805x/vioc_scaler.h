...
#define SCSSIZE_HEIGHT_MASK			(0xFFFF << SCSSIZE_HEIGHT_SHIFT)
#define SCSSIZE_WIDTH_MASK			(0xFFFF << SCSSIZE_WIDTH_SHIFT)
...
#define SCDSIZE_HEIGHT_MASK			(0xFFFF << SCDSIZE_HEIGHT_SHIFT)
#define SCDSIZE_WIDTH_MASK			(0xFFFF << SCDSIZE_WIDTH_SHIFT)
...
#define SCOPOS_YPOS_MASK			(0xFFFF << SCOPOS_YPOS_SHIFT)
#define SCOPOS_XPOS_MASK			(0xFFFF << SCOPOS_XPOS_SHIFT)
...
#define SCOSIZE_HEIGHT_MASK			(0xFFFF << SCOSIZE_HEIGHT_SHIFT)
#define SCOSIZE_WIDTH_MASK			(0xFFFF << SCOSIZE_WIDTH_SHIFT)
...
extern void VIOC_SC_SetSrcSize(void __iomem *reg, unsigned int nWidth, unsigned int nHeight);
extern void VIOC_SC_SetDstSize(void __iomem *reg, unsigned int nWidth, unsigned int nHeight);
extern void VIOC_SC_SetOutSize(void __iomem *reg, unsigned int nWidth, unsigned int nHeight);
extern void VIOC_SC_SetOutPosition(void __iomem *reg, unsigned int nXpos, unsigned int nYpos);
