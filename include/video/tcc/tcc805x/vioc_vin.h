...
/* Interface APIs. */
extern void VIOC_VIN_SetSyncPolarity (void __iomem *reg, unsigned int hs_active_low, unsigned int vs_active_low, unsigned int field_bfield_low, unsigned int de_active_low, unsigned int gen_field_en, unsigned int pxclk_pol);
extern void VIOC_VIN_SetCtrl (void __iomem *reg, unsigned int conv_en, unsigned int hsde_connect_en, unsigned int vs_mask, unsigned int fmt, unsigned int data_order);
extern void VIOC_VIN_SetInterlaceMode (void __iomem *reg, unsigned int intl_en, unsigned int intpl_en);
extern void VIOC_VIN_SetCaptureModeEnable(void __iomem *reg, unsigned int cap_en);
extern void VIOC_VIN_SetFrameSkipNumber(void __iomem *reg, unsigned int skip);
extern void VIOC_VIN_SetEnable (void __iomem *reg, unsigned int vin_en);
extern void VIOC_VIN_SetImageSize (void __iomem *reg, unsigned int width, unsigned int height);
extern void VIOC_VIN_SetImageOffset (void __iomem *reg, unsigned int offs_width, unsigned int offs_height, unsigned int offs_height_intl);
extern void VIOC_VIN_SetImageCropSize(void __iomem *reg, unsigned int width, unsigned int height);
extern void VIOC_VIN_SetImageCropOffset(void __iomem *reg, unsigned int offs_width, unsigned int offs_height);
...
extern void VIOC_VIN_SetLUTEnable(void __iomem *reg, unsigned int lut0_en, unsigned int lut1_en, unsigned int lut2_en);
extern void VIOC_VIN_IreqHandler(unsigned int vectorID);
extern unsigned int VIOC_VIN_IsEnable(void __iomem *reg);

extern void VIOC_VIN_SetDemuxPort(void __iomem *reg, unsigned int p0, unsigned int p1, unsigned int p2, unsigned int p3);
...
extern void VIOC_VIN_SetIreqMask(void __iomem *reg, unsigned int mask, unsigned int set);
extern void VIOC_VIN_GetStatus(void __iomem *reg, unsigned int *status);
