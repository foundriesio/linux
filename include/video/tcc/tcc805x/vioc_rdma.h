...
extern void VIOC_RDMA_SetImageScale(void __iomem *reg, unsigned int scaleX, unsigned int scaleY);
...
extern void VIOC_RDMA_SetIssue(void __iomem *reg, unsigned int burst_length, unsigned int issue_cnt);
