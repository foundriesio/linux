...
extern void VIOC_DDICONFIG_SetSWRESET(void __iomem *reg, unsigned int type, unsigned int set);
extern void VIOC_DDICONFIG_SetPWDN(void __iomem *reg, unsigned int type, unsigned int set);
extern int VIOC_DDICONFIG_GetPeriClock(void __iomem *reg, unsigned int num);
extern void VIOC_DDICONFIG_SetPeriClock(void __iomem *reg, unsigned int num, unsigned int set);
extern void VIOC_DDICONFIG_Set_hdmi_enable(void __iomem *reg, unsigned int enable);
extern void VIOC_DDICONFIG_Set_prng(void __iomem *reg, unsigned int enable);
extern void VIOC_DDICONFIG_Set_refclock(void __iomem *reg, unsigned int ref_clock);
extern int VIOC_DDICONFIG_get_phy_status(void __iomem *reg, unsigned int phy_mode);
extern void VIOC_DDICONFIG_Set_tmds_bit_order(void __iomem *reg, unsigned int phy_mode);
extern void VIOC_DDICONFIG_reset_hdmi_phy(void __iomem *reg, unsigned int reset_enable);
extern void VIOC_DDICONFIG_reset_hdmi_link(void __iomem *reg, unsigned int reset_enable);
extern void VIOC_DDICONFIG_NTSCPAL_SetEnable(void __iomem *reg, unsigned int enable, unsigned int lcdc_num);
extern void VIOC_DDICONFIG_MIPI_Reset_DPHY(void __iomem *reg, unsigned int reset);
extern void VIOC_DDICONFIG_MIPI_Reset_GEN(void __iomem *reg, unsigned int reset);
