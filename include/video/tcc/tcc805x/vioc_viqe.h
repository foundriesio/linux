 ...
 */
#define VCTRL_CGPMD_SHIFT		(26)
#define VCTRL_CGDND_SHIFT		(25) // (data sheet error)
#define VCTRL_CGDID_SHIFT		(24)
#define VCTRL_CFGUPD_SHIFT		(21)
#define VCTRL_UPD_SHIFT			(20)
#define VCTRL_FCF_SHIFT			(18)
#define VCTRL_FCDUF_SHIFT		(17)
#define VCTRL_FCD_SHIFT			(16)
#define VCTRL_NHINTPL_SHIFT		(8)
#define VCTRL_DIEN_SHIFT		(4)
#define VCTRL_DNEN_SHIFT		(3)
#define VCTRL_GMEN_SHIFT		(2)
#define VCTRL_HIEN_SHIFT		(1)
#define VCTRL_HILUT_SHIFT		(0)
 ...
 */
#define VTIMEGEN_Y2RMD_SHIFT		(9)
#define VTIMEGEN_Y2REN_SHIFT		(8)
#define VTIMEGEN_H2H_SHIFT			(0)
 ...
 */
#define DI_SIZE_HEIGHT_SHIFT		(16)
#define DI_SIZE_WIDTH_SHIFT		(0)
 ...
 */
#define DI_OFFS_OFFS1_SHIFT		(16)
#define DI_OFFS_OFFS0_SHIFT		(0)
 ...
 */
#define DI_CTRL_H2H_SHIFT		(24)
#define DI_CTRL_FRD_SHIFT		(18)
#define DI_CTRL_CFGUPD_SHIFT		(17)
#define DI_CTRL_EN_SHIFT		(16)
#define DI_CTRL_FRMNUM_SHIFT		(8)
#define DI_CTRL_UVINTPL_SHIFT		(2)
#define DI_CTRL_SDDU_SHIFT		(1)
#define DI_CTRL_TSDU_SHIFT		(0)
 ...
 */
#define DI_DEC_MISC_FMT_SHIFT			(12)
#define DI_DEC_MISC_DEC_DIV_SHIFT		(8)
#define DI_DEC_MISC_SF_SHIFT			(3)
#define DI_DEC_MISC_ECR_SHIFT			(2)
 ...
 */
#define DI_DEC_SIZE_HEIGHT_SHIFT	(16)
#define DI_DEC_SIZE_WIDTH_SHIFT		(0)
 ...
 */
#define DI_DEC_STS_DEC_STS_SHIFT				(28)
#define DI_DEC_STS_DEC_ER_SHIFT					(27)
#define DI_DEC_STS_HR_ER_SHIFT					(26)
#define DI_DEC_STS_EOFO_SHIFT					(25)
#define DI_DEC_STS_EOFI_SHIFT					(24)
#define DI_DEC_STS_EMPTY_SHIFT					(20)
#define DI_DEC_STS_FULL_SHIFT					(16)
 ...
 */
#define DI_DEC_CTRL_EN_SHIFT			(31)
#define DI_DEC_CTRL_STS_SHIFT			(16)
#define DI_DEC_CTRL_HEADER_EN_SHIFT		(9)
#define DI_DEC_CTRL_ER_CK_SHIFT			(8)
 ...
 */
#define DI_COM0_MISC_FMT_SHIFT			(12)
#define DI_COM0_MISC_ENC_DIV_SHIFT		(8)
#define DI_COM0_MISC_SF_SHIFT			(3)
 ...
 */
#define DI_COM0_STS_EOFO_SHIFT			(25)
#define DI_COM0_STS_EOFI_SHIFT			(24)
#define DI_COM0_STS_EMPTY_SHIFT			(20)
#define DI_COM0_STS_FULL_SHIFT			(16)
 ...
 */
#define DI_COM0_CTRL_EN_SHIFT			(31)
#define DI_COM0_CTRL_STS_SHIFT			(16)
 ...
 */
#define DI_COM0_AC_K2_AC_SHIFT			(16)
#define DI_COM0_AC_K1_AC_SHIFT			(8)
#define DI_COM0_AC_K0_AC_SHIFT			(0)
 ...
 */
#define DI_CTRL2_CLRIR_SHIFT  (31)
#define DI_CTRL2_FLSFF_SHIFT  (30)
#define DI_CTRL2_BYPASS_SHIFT (29)
#define DI_CTRL2_SPA_SHIFT    (17)
#define DI_CTRL2_BFMD_SHIFT   (16)
#define DI_CTRL2_PDCLFI_SHIFT (15)
#define DI_CTRL2_PDPF_SHIFT   (11)
#define DI_CTRL2_PDJUD_SHIFT  (9)
#define DI_CTRL2_PDEN_SHIFT   (8)
#define DI_CTRL2_YDM_SHIFT    (7)
#define DI_CTRL2_GTHSJ_SHIFT  (6)
#define DI_CTRL2_MRSP_SHIFT   (5)
#define DI_CTRL2_MRTM_SHIFT   (4)
#define DI_CTRL2_JT_SHIFT     (2)
#define DI_CTRL2_JSP_SHIFT    (1)
#define DI_CTRL2_JS_SHIFT     (0)
...
#define DI_CTRL2_SPA_MASK    (0x1 << DI_CTRL2_SPA_SHIFT)
#define DI_CTRL2_BFMD_MASK   (0x1 << DI_CTRL2_BFMD_SHIFT)
 ...
 */
#define DI_ENGINE0_DMTSADC_SHIFT (24)
#define DI_ENGINE0_DMTPXLC_SHIFT (16)
#define DI_ENGINE0_DMTPXL_SHIFT  (8)
#define DI_ENGINE0_DMTSAD_SHIFT  (0)
 ...
 */
#define DI_ENGINE1_THSJMAX_SHIFT (24)
#define DI_ENGINE1_THSJMIN_SHIFT (16)
#define DI_ENGINE1_LRT_SHIFT     (14)
#define DI_ENGINE1_LRL_SHIFT     (9)
#define DI_ENGINE1_LRD_SHIFT     (8)
#define DI_ENGINE1_DIRLT_SHIFT   (4)
#define DI_ENGINE1_GLD_SHIFT     (3)
#define DI_ENGINE1_JDH_SHIFT     (2)
 ...
 */
#define DI_ENGINE2_A_THS_SHIFT  (20)
#define DI_ENGINE2_E_THS_SHIFT  (8)
#define DI_ENGINE2_EP2_SHIFT    (7)
#define DI_ENGINE2_EP1_SHIFT    (6)
#define DI_ENGINE2_OPPD_SHIFT   (2)
#define DI_ENGINE2_EARLYD_SHIFT (1)
#define DI_ENGINE2_ADAPD_SHIFT  (0)
 ...
 */
#define DI_ENGINE3_STTHW_SHIFT (20)
#define DI_ENGINE3_STTHM_SHIFT (8)
#define DI_ENGINE3_STTHD_SHIFT (0)
 ...
 */
#define DI_ENGINE4_VARLG_SHIFT  (28)
#define DI_ENGINE4_VARR1_SHIFT  (24)
#define DI_ENGINE4_VARR0_SHIFT  (20)
#define DI_ENGINE4_DYNVAR_SHIFT (16)
#define DI_ENGINE4_HPFVAR_SHIFT (12)
#define DI_ENGINE4_HPFFLD_SHIFT (8)
#define DI_ENGINE4_HPFFRM_SHIFT (4)
#define DI_ENGINE4_DMDC_SHIFT   (1)
#define DI_ENGINE4_DMDL_SHIFT   (0)
 ...
 */
#define PD_THRES0_ZP_SHIFT      (24)
#define PD_THRES0_CNTSCO_SHIFT  (20)
#define PD_THRES0_CO_SHIFT      (16)
#define PD_THRES0_UVALDIS_SHIFT (15)
#define PD_THRES0_WEIGHT_SHIFT  (10)
#define PD_THRES0_CNTS_SHIFT    (0)
 ...
 */
#define PD_THRES1_THRES2_SHIFT (16)
#define PD_THRES1_THRES1_SHIFT (8)
#define PD_THRES1_THRES0_SHIFT (0)
 ...
 */
#define PD_JUDDER_THSJDMAX_SHIFT (24)
#define PD_JUDDER_THSJDMIN_SHIFT (16)
#define PD_JUDDER_HORLINE_SHIFT  (12)
#define PD_JUDDER_DNLINE_SHIFT   (8)
#define PD_JUDDER_CNTS_SHIFT     (0)
 ...
 */
#define PD_JUDDER_M_MULDMT_SHIFT  (17)
#define PD_JUDDER_M_NOJDS_SHIFT   (16)
#define PD_JUDDER_M_THSJDS2_SHIFT (8)
#define PD_JUDDER_M_JDH_SHIFT     (0)
 ...
 */
#define PD_STATUS_MPOFF_SHIFT		(8)
#define PD_STATUS_CO_SHIFT			(4)
#define PD_STATUS_STATE_SHIFT		(0)
 ...
 */
#define DI_REGION0_EN_SHIFT			(31)
#define DI_REGION0_XEND_SHIFT		(16)
#define DI_REGION0_XSTART_SHIFT		(0)
 ...
 */
#define DI_REGION1_YEND_SHIFT		(16)
#define DI_REGION1_YSTART_SHIFT		(0)
