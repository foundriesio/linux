 ...
 * \return
 *	If successful, TCC_JPU_DEC returns 0 or plus.
...
typedef struct jpu_enc_init_t {
	...
	// physical address : multiple of 4, virtual address : multiple of 4
 ...
 *	[in]pParam2		: output or info parameter
 * \return
 *	If successful, TCC_JPU_ENC returns 0 or plus.
 *	Otherwise, it returns a minus value.
 ***********************************************************************
 */
codec_result_t TCC_JPU_ENC(int Op, codec_handle_t *pHandle,
