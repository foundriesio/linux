...
#define V4L2_CAP_HANDOVER_NONE		0
#define V4L2_CAP_HANDOVER_NEED		1
#define V4L2_CAP_CTRL_SKIP_NONE		(0)
#define V4L2_CAP_CTRL_SKIP_ALL		(1 << V4L2_CAP_ALL)
#define V4L2_CAP_CTRL_SKIP_SUBDEV	(1 << V4L2_CAP_SUBDEV)
#define V4L2_CAP_CTRL_SKIP_DEV		(1 << V4L2_CAP_DEV)
#define V4L2_CAP_PATH_NOT_WORKING	0
