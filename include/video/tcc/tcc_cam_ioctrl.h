...
#define VIDIOC_G_OPERATION_MODE					_IOWR ('V', BASE_VIDIOC_PRIVATE+16, int)
#define VIDIOC_S_OPERATION_MODE					_IOWR ('V', BASE_VIDIOC_PRIVATE+17, int)
#define VIDIOC_SET_VIDEOSOURCE_FORMAT			_IOWR ('V', BASE_VIDIOC_PRIVATE+18, videosource_format_t)
