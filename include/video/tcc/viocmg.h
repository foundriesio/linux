...
// WMIX
extern int  viocmg_set_wmix_position(unsigned int caller_id,
	unsigned int wmix_id, unsigned int wmix_channel,
	unsigned int nX, unsigned int nY);
extern void viocmg_get_wmix_position(unsigned int caller_id,
	unsigned int wmix_id, unsigned int wmix_channel,
	unsigned int *nX, unsigned int *nY);
extern int  viocmg_set_wmix_ovp(unsigned int caller_id,
	unsigned int wmix_id, unsigned int ovp);
extern void viocmg_get_wmix_ovp(unsigned int wmix_id, unsigned int *ovp);
extern int  viocmg_set_wmix_chromakey_enable(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int enable);
extern void viocmg_get_wmix_chromakey_enable(unsigned int wmix_id,
	unsigned int layer, unsigned int *enable);
extern int  viocmg_set_wmix_chromakey(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int enable,
...
extern int  viocmg_set_wmix_overlayalphavaluecontrol(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int region,
	unsigned int acon0, unsigned int acon1);
extern int  viocmg_set_wmix_overlayalphacolorcontrol(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int region,
	unsigned int ccon0, unsigned int ccon1);
extern int  viocmg_set_wmix_overlayalpharopmode(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int opmode);
extern int  viocmg_set_wmix_overlayalphaselection(unsigned int caller_id,
	unsigned int wmix_id, unsigned int layer, unsigned int asel);
extern int  viocmg_set_wmix_overlayalphavalue(unsigned int caller_id,
...
extern void viocmg_set_rear_cam_mode(unsigned int caller_id,
	unsigned int mode);
