...
enum VIOC_WMIX_ALPHA_SELECT_Type {
	...
	VIOC_WMIX_ALPHA_SEL3,     // image alpha 0~127, 129~256
				  // (0%~49.6%, 50.3%~100%)
...
enum VIOC_WMIX_ALPHA_ACON0_Type {
	VIOC_WMIX_ALPHA_ACON0_0 =
		0, // Result_A = ALPHA0 * SEL0_Out, SEL0_Out = ALPHA1
	VIOC_WMIX_ALPHA_ACON0_1, // Result_A = ALPHA0 * SEL0_Out, SEL0_Out = 256
				 // - ALPHA1
	VIOC_WMIX_ALPHA_ACON0_2, // Result_A = ALPHA0 * 256, SEL0_Out = ALPHA1
	VIOC_WMIX_ALPHA_ACON0_3, // Result_A = ALPHA0 * 256, SEL0_Out = 256 -
				 // ALPHA1
	VIOC_WMIX_ALPHA_ACON0_4, // Result_A = ALPHA0 * 128, SEL0_Out = ALPHA1
	VIOC_WMIX_ALPHA_ACON0_5, // Result_A = ALPHA0 * 128, SEL0_Out = 256 -
				 // ALPHA1
	VIOC_WMIX_ALPHA_ACON0_6, // Result_A = 0, SEL0_Out = ALPHA1
	VIOC_WMIX_ALPHA_ACON0_7, // Result_A = 0, SEL0_Out = 256 - ALPHA1
	VIOC_WMIX_ALPHA_ACON0_MAX // Result : AlphaDataOut = (Result_A +
				  // Result_B + 128) / 256
};

enum VIOC_WMIX_ALPHA_ACON1_Type {
	VIOC_WMIX_ALPHA_ACON1_0 =
		0, // Result_B = ALPHA1 * SEL1_Out, SEL1_Out = ALPHA0
	VIOC_WMIX_ALPHA_ACON1_1, // Result_B = ALPHA1 * SEL1_Out, SEL1_Out = 256
				 // - ALPHA0
	VIOC_WMIX_ALPHA_ACON1_2, // Result_B = ALPHA1 * 256, SEL1_Out = ALPHA0
	VIOC_WMIX_ALPHA_ACON1_3, // Result_B = ALPHA1 * 256, SEL1_Out = 256 -
				 // ALPHA0
	VIOC_WMIX_ALPHA_ACON1_4, // Result_B = ALPHA1 * 128, SEL1_Out = ALPHA0
	VIOC_WMIX_ALPHA_ACON1_5, // Result_B = ALPHA1 * 128, SEL1_Out = 256 -
				 // ALPHA0
	VIOC_WMIX_ALPHA_ACON1_6, // Result_B = 0, SEL1_Out = ALPHA0
	VIOC_WMIX_ALPHA_ACON1_7, // Result_B = 0, SEL1_Out = 256 - ALPHA0
	VIOC_WMIX_ALPHA_ACON1_MAX // Result : AlphaDataOut = (Result_A +
				  // Result_B + 128) / 256
};

enum VIOC_WMIX_ALPHA_CCON0_Type {
	VIOC_WMIX_ALPHA_CCON0_0 =
		0, // Result_A = PixelDataA * SEL0_Out, SEL0_Out = ALPHA0
	VIOC_WMIX_ALPHA_CCON0_1, // Result_A = PixelDataA * SEL0_Out, SEL0_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON0_2, // Result_A = PixelDataA * SEL0_Out, SEL0_Out =
				 // 256 - ALPHA0
	VIOC_WMIX_ALPHA_CCON0_3, // Result_A = PixelDataA * SEL0_Out, SEL0_Out =
				 // 256 - ALPHA1
	VIOC_WMIX_ALPHA_CCON0_4, // Result_A = PixelDataA * 256, SEL0_Out =
				 // ALPHA0
	VIOC_WMIX_ALPHA_CCON0_5, // Result_A = PixelDataA * 256, SEL0_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON0_6, // Result_A = PixelDataA * 256, SEL0_Out = 256
				 // - ALPHA0
	VIOC_WMIX_ALPHA_CCON0_7, // Result_A = PixelDataA * 256, SEL0_Out = 256
				 // - ALPHA1
	VIOC_WMIX_ALPHA_CCON0_8, // Result_A = PixelDataA * 128, SEL0_Out =
				 // ALPHA0
	VIOC_WMIX_ALPHA_CCON0_9, // Result_A = PixelDataA * 128, SEL0_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON0_10, // Result_A = PixelDataA * 128, SEL0_Out = 256
				  // - ALPHA0
	VIOC_WMIX_ALPHA_CCON0_11, // Result_A = PixelDataA * 128, SEL0_Out = 256
				  // - ALPHA1
	...
	VIOC_WMIX_ALPHA_CCON0_MAX // Result : PixelDataOut = (Result_A +
				  // Result_B + 128) / 256
};

enum VIOC_WMIX_ALPHA_CCON1_Type {
	VIOC_WMIX_ALPHA_CCON1_0 =
		0, // Result_B = PixelDataB * SEL1_Out, SEL1_Out = ALPHA0
	VIOC_WMIX_ALPHA_CCON1_1, // Result_B = PixelDataB * SEL1_Out, SEL1_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON1_2, // Result_B = PixelDataB * SEL1_Out, SEL1_Out =
				 // 256 - ALPHA0
	VIOC_WMIX_ALPHA_CCON1_3, // Result_B = PixelDataB * SEL1_Out, SEL1_Out =
				 // 256 - ALPHA1
	VIOC_WMIX_ALPHA_CCON1_4, // Result_B = PixelDataB * 256, SEL1_Out =
				 // ALPHA0
	VIOC_WMIX_ALPHA_CCON1_5, // Result_B = PixelDataB * 256, SEL1_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON1_6, // Result_B = PixelDataB * 256, SEL1_Out = 256
				 // - ALPHA0
	VIOC_WMIX_ALPHA_CCON1_7, // Result_B = PixelDataB * 256, SEL1_Out = 256
				 // - ALPHA1
	VIOC_WMIX_ALPHA_CCON1_8, // Result_B = PixelDataB * 128, SEL1_Out =
				 // ALPHA0
	VIOC_WMIX_ALPHA_CCON1_9, // Result_B = PixelDataB * 128, SEL1_Out =
				 // ALPHA1
	VIOC_WMIX_ALPHA_CCON1_10, // Result_B = PixelDataB * 128, SEL1_Out = 256
				  // - ALPHA0
	VIOC_WMIX_ALPHA_CCON1_11, // Result_B = PixelDataB * 128, SEL1_Out = 256
				  // - ALPHA1
	...
	VIOC_WMIX_ALPHA_CCON1_MAX // Result : PixelDataOut = (Result_A +
				  // Result_B + 128) / 256
};
 ...
 */
#define MCCON_CCON1_11_SHIFT (28) // CCON1 for Region C
#define MCCON_CCON0_11_SHIFT (24) // CCON0 for Region C
#define MCCON_CCON1_10_SHIFT (20) // CCON1 for Region B
#define MCCON_CCON0_10_SHIFT (16) // CCON0 for Region B
#define MCCON_CCON1_01_SHIFT (12) // CCON1 for Region D
#define MCCON_CCON0_01_SHIFT (8)  // CCON0 for Region D
#define MCCON_CCON1_00_SHIFT (4)  // CCON1 for Region A
#define MCCON_CCON0_00_SHIFT (0)  // CCON0 for Region A
...
/* Interface APIs */
extern void
VIOC_WMIX_SetOverlayPriority(void __iomem *reg, unsigned int nOverlayPriority);
extern void
VIOC_WMIX_GetOverlayPriority(void __iomem *reg, unsigned int *nOverlayPriority);
extern int VIOC_WMIX_GetLayer(unsigned int vioc_id, unsigned int image_num);
extern int VIOC_WMIX_GetMixerType(unsigned int vioc_id);
extern void VIOC_WMIX_SetUpdate(void __iomem *reg);
extern void
VIOC_WMIX_SetSize(void __iomem *reg, unsigned int nWidth, unsigned int nHeight);
extern void VIOC_WMIX_GetSize(
	void __iomem *reg, unsigned int *nWidth, unsigned int *nHeight);
extern void VIOC_WMIX_SetBGColor(
	void __iomem *reg, unsigned int nBG0, unsigned int nBG1,
	unsigned int nBG2, unsigned int nBG3);
extern void VIOC_WMIX_SetPosition(
	void __iomem *reg, unsigned int nChannel, unsigned int nX,
	unsigned int nY);
extern void VIOC_WMIX_GetPosition(
	void __iomem *reg, unsigned int nChannel, unsigned int *nX,
	unsigned int *nY);
extern void VIOC_WMIX_SetChromaKey(
...
extern void VIOC_WMIX_GetChromaKey(
	void __iomem *reg, unsigned int nLayer, unsigned int *nKeyEn,
	unsigned int *nKeyR, unsigned int *nKeyG, unsigned int *nKeyB,
...
extern void VIOC_WMIX_ALPHA_SetColorControl(
	void __iomem *reg, unsigned int layer, unsigned int region,
	unsigned int ccon0, unsigned int ccon1);
extern void VIOC_WMIX_ALPHA_SetROPMode(
...
extern void VIOC_WMIX_ALPHA_SetAlphaValue(
	void __iomem *reg, unsigned int layer, unsigned int alpha0,
	unsigned int alpha1);
extern void VIOC_WMIX_ALPHA_SetROPPattern(
...
extern void VIOC_API_WMIX_SetOverlayAlphaROPMode(
	void __iomem *reg, unsigned int layer, unsigned int opmode);
extern void VIOC_API_WMIX_SetOverlayAlphaValue(
	void __iomem *reg, unsigned int layer, unsigned int alpha0,
	unsigned int alpha1);
extern void VIOC_API_WMIX_SetOverlayAlphaSelection(
	void __iomem *reg, unsigned int layer, unsigned int asel);
