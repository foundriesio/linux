...
typedef enum VIOC_VIQE_DEINTL_MODE {
...
typedef enum VIOC_VIQE_FMT_TYPE {
...
#define VCTRL_CGDND_SHIFT \
	(25) // Clock Gate Disable for De-nosier (data sheet error)
...
#define VTIMEGEN_H2H_SHIFT \
	(0) // the pixel count between the ending pixel of the line and the
...
#define DI_CTRL_H2H_SHIFT \
	(24) // the pixel count between the ending pixel of the line and the
	     // first pixel of the next line
...
#define DI_DEC_MISC_DEC_DIV_SHIFT \
	(8) // The divisor value of stream decompressor
#define DI_DEC_MISC_SF_SHIFT \
	(3) // Set to change the stream size to maximum value
...
#define DI_CTRL2_MRSP_SHIFT \
	(5) // Pixel Output Range Enable in Spatial Processing
#define DI_CTRL2_MRTM_SHIFT \
	(4) // Pixel Output Range Enable in Temporal Processing
...
#define DI_ENGINE0_DMTSADC_SHIFT \
	(24) // SAD Threshold in Motion Detection for Chrominance
#define DI_ENGINE0_DMTPXLC_SHIFT \
	(16) // Pixel Threshold in Motion Detection for Chrominance
#define DI_ENGINE0_DMTPXL_SHIFT \
	(8) // Pixel Threshold in Motion Detection for Luminance
#define DI_ENGINE0_DMTSAD_SHIFT \
	(0) // SAD Threshold in Motion Detection for Luminance
...
#define DI_ENGINE1_THSJMAX_SHIFT \
	(24) // Maximum Threshold in Jaggy Threshold Generator
#define DI_ENGINE1_THSJMIN_SHIFT \
	(16) // Minimum Threshold in Jaggy Threshold Generator
...
#define DI_ENGINE1_DIRLT_SHIFT \
	(4)			 // Spatial Edge Direction Detector Length Type
...
#define DI_ENGINE2_EP2_SHIFT \
	(7) // Early determination Suppress Algorithm 2 Disable
#define DI_ENGINE2_EP1_SHIFT \
	(6) // Early determination Suppress Algorithm 1 Disable
#define DI_ENGINE2_OPPD_SHIFT \
	(2) // Edge Adaptive Direction determination Disable
...
#define DI_ENGINE3_STTHW_SHIFT \
	(20) // Threshold Weight Parameter of Stationary Detection
#define DI_ENGINE3_STTHM_SHIFT \
	(8) // Threshold Multiplier Parameter of Stationary Detection
...
#define DI_ENGINE4_HPFVAR_SHIFT \
	(12) // Derivative Variance Threshold for HPF output
...
#define PD_THRES0_CNTSCO_SHIFT \
	(20) // Threshold for counter value of Pulldown Prevention-Flag
#define PD_THRES0_CO_SHIFT (16) // Value of Pulldown Detection type
#define PD_THRES0_UVALDIS_SHIFT \
	(15) // Not Use User-defined Threshold Value in Prevention-Flag
#define PD_THRES0_WEIGHT_SHIFT \
	(10) // Weight Value for Threshold of Pull Prevention-Flag
#define PD_THRES0_CNTS_SHIFT \
	(0) // Threshold for counter value of Pulldown checker
 ...
 */
#define PD_THRES1_THRES2_SHIFT \
	(16) // Threshold for pixel difference value of third level
#define PD_THRES1_THRES1_SHIFT \
	(8) // Threshold for pixel difference value of second level
#define PD_THRES1_THRES0_SHIFT \
	(0) // Threshold for pixel difference value of first level
 ...
 */
#define PD_JUDDER_THSJDMAX_SHIFT \
	(24) // Threshold maximum boundary for Pulldown Judder Detector
#define PD_JUDDER_THSJDMIN_SHIFT \
	(16) // Threshold Minimum boundary for Pulldown Judder Detector
#define PD_JUDDER_HORLINE_SHIFT \
	(12) // Horizontal Margin for Judder Elimination Processing
#define PD_JUDDER_DNLINE_SHIFT \
	(8) // Downward Margin for Judder Elimination Processor
...
#define PD_JUDDER_M_THSJDS2_SHIFT \
	(8) // Threshold Pulldown Judder for Two Buffers mode
...
#define DI_REGION0_XEND_SHIFT \
	(16) // Last Horizontal Position of Region Selection
#define DI_REGION0_XSTART_SHIFT \
	(0) // First Horizontal Position of Region Selection
...
#define DI_REGION1_YSTART_SHIFT \
	(0) // First Vertical Position of Region Selection
...
extern void
VIOC_VIQE_SetDeintlMode(void __iomem *reg, enum VIOC_VIQE_DEINTL_MODE mode);
...
extern void VIOC_VIQE_SetDeintlRegister(
	...
	enum VIOC_VIQE_DEINTL_MODE mode, unsigned int base0, unsigned int base1,
...
extern void
VIOC_VIQE_IgnoreDecError(void __iomem *reg, int sf, int er_ck, int hrer_en);
