...
typedef struct _VIOC_CPUIF_CHANNEL {
	volatile VIOC_CPUIF_CTRL_u
		uCS0_CMD0_CTRL; // 0x00	0xA0229011 CS0 CMD0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS0_DAT0_CTRL; // 0x04	0xA0429021 CS0 DAT0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS0_CMD1_CTRL; // 0x08	0xA0229011 CS0 CMD0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS0_DAT1_CTRL; // 0x0C	0xA0429021 CS0 DAT0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS1_CMD0_CTRL; // 0x10	0xA0129009 CS1 CMD0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS1_DAT0_CTRL; // 0x14	0xA0229011 CS1 DAT0 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS1_CMD1_CTRL; // 0x18	0xA0129009 CS1 CMD1 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_CTRL_u
		uCS1_DAT1_CTRL; // 0x1C	0xA0229011 CS1 DAT1 (XA[1]==0)
				// Control Register
	volatile VIOC_CPUIF_BSWAP_u
		uCS0_BSWAP; // 0x20~0x24 0xE4E4E4E4	CS0 Byte Swap 0 register
	volatile VIOC_CPUIF_BSWAP_u
