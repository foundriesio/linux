...
#define VIN_MISC_Y2RM_MASK			(0x3 << VIN_MISC_Y2RM_SHIFT)
...
/*
 * VIN Look-up Table k in Ch.0 Register
 */
#define VIN_LUT_K_C0_VALUE_4N_PLUS_3_SHIFT	(24)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_2_SHIFT	(16)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_1_SHIFT	(8)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_0_SHIFT	(0)

#define VIN_LUT_K_C0_VALUE_4N_PLUS_3_MASK	(0xFF << VIN_LUT_K_C0_VALUE_4N_PLUS_3_SHIFT)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_2_MASK	(0xFF << VIN_LUT_K_C0_VALUE_4N_PLUS_2_SHIFT)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_1_MASK	(0xFF << VIN_LUT_K_C0_VALUE_4N_PLUS_1_SHIFT)
#define VIN_LUT_K_C0_VALUE_4N_PLUS_0_MASK	(0xFF << VIN_LUT_K_C0_VALUE_4N_PLUS_0_SHIFT)

/*
 * VIN Look-up Table k in Ch.1 Register
 */
#define VIN_LUT_K_C1_VALUE_4N_PLUS_3_SHIFT	(24)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_2_SHIFT	(16)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_1_SHIFT	(8)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_0_SHIFT	(0)

#define VIN_LUT_K_C1_VALUE_4N_PLUS_3_MASK	(0xFF << VIN_LUT_K_C1_VALUE_4N_PLUS_3_SHIFT)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_2_MASK	(0xFF << VIN_LUT_K_C1_VALUE_4N_PLUS_2_SHIFT)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_1_MASK	(0xFF << VIN_LUT_K_C1_VALUE_4N_PLUS_1_SHIFT)
#define VIN_LUT_K_C1_VALUE_4N_PLUS_0_MASK	(0xFF << VIN_LUT_K_C1_VALUE_4N_PLUS_0_SHIFT)

/*
 * VIN Look-up Table k in Ch.2 Register
 */
#define VIN_LUT_K_C2_VALUE_4N_PLUS_3_SHIFT	(24)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_2_SHIFT	(16)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_1_SHIFT	(8)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_0_SHIFT	(0)

#define VIN_LUT_K_C2_VALUE_4N_PLUS_3_MASK	(0xFF << VIN_LUT_K_C2_VALUE_4N_PLUS_3_SHIFT)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_2_MASK	(0xFF << VIN_LUT_K_C2_VALUE_4N_PLUS_2_SHIFT)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_1_MASK	(0xFF << VIN_LUT_K_C2_VALUE_4N_PLUS_1_SHIFT)
#define VIN_LUT_K_C2_VALUE_4N_PLUS_0_MASK	(0xFF << VIN_LUT_K_C2_VALUE_4N_PLUS_0_SHIFT)
