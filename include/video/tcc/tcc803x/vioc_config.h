...
#define CFG_FBC_DEC_SEL_AD_PATH_SEL01_SHIFT (5) // RDMA num to use AFBC_DEC01
#define CFG_FBC_DEC_SEL_AD_PATH_SEL00_SHIFT (0) // RDMA num to use AFBC_DEC00
...
#define PWR_BLK_PWDN3_VIN_MASK (0x7 << PWR_BLK_PWDN3_VIN_SHIFT)
#define PWR_BLK_PWDN3_WD_MASK (0x7 << PWR_BLK_PWDN3_WD_SHIFT)
...
#define PWR_BLK_SWR4_VIN_MASK (0x7 << PWR_BLK_SWR4_VIN_SHIFT)
#define PWR_BLK_SWR4_WD_MASK (0x7 << PWR_BLK_SWR4_WD_SHIFT)
