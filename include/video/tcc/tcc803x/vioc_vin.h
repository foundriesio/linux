...
#define VIN_CTRL_DO_MASK		(0x7 << VIN_CTRL_DO_SHIFT)
 ...
 */
#define VIN_LUT_K_C_VALUE_4K_PLUS_3_SHIFT	(24)
#define VIN_LUT_K_C_VALUE_4K_PLUS_2_SHIFT	(16)
#define VIN_LUT_K_C_VALUE_4K_PLUS_1_SHIFT	(8)
#define VIN_LUT_K_C_VALUE_4K_PLUS_0_SHIFT	(0)

#define VIN_LUT_K_C_VALUE_4K_PLUS_3_MASK \
				(0xFF << VIN_LUT_K_C_VALUE_4K_PLUS_3_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_2_MASK \
				(0xFF << VIN_LUT_K_C_VALUE_4K_PLUS_2_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_1_MASK \
				(0xFF << VIN_LUT_K_C_VALUE_4K_PLUS_1_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_0_MASK \
				(0xFF << VIN_LUT_K_C_VALUE_4K_PLUS_0_SHIFT)
