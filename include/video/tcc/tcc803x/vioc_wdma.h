...
#define WDMABG_OFFSET				(0x24)
#define WDMAPTS_OFFSET				(0x28)
#define WDMADMAT0_OFFSET			(0x2C)
#define WDMADMAT1_OFFSET			(0x30)
#define WDMAROLL_OFFSET				(0x38)
#define WDMASBASE_OFFSET			(0x3C)
#define WDMAIRQSTS_OFFSET			(0x40)
#define WDMAIRQMSK_OFFSET			(0x44)
 ...
 */
#define WDMAOFFS_OFFSET1_SHIFT (16) // The 2nd offset for each image
#define WDMAOFFS_OFFSET0_SHIFT (0)  // The 1st offset for each image
 ...
 */
#define WDMABG_BG3_SHIFT (24) // Background Color 3 (Alpha)
#define WDMABG_BG2_SHIFT (16) // Background Color 2 (Y/B)
 ...
 */
#define WDMAIRQMSK_SEOFF_SHIFT (8) // Sync EOF Falling Intr. Masked
#define WDMAIRQMSK_SEOFR_SHIFT (7) // Sync EOF Rising Intr. Masked
#define WDMAIRQMSK_EOFF_SHIFT  (6) // EOF Falling Intr. Masked
#define WDMAIRQMSK_EOFR_SHIFT  (5) // EOF Rising Intr. Masked
#define WDMAIRQMSK_ENF_SHIFT   (4) // Synchronized Enable Falling Intr. Masked
#define WDMAIRQMSK_ENR_SHIFT   (3) // Synchronized Enable Rising Intr. Masked
#define WDMAIRQMSK_ROL_SHIFT   (2) // Rolling Intr. Masked
#define WDMAIRQMSK_SREQ_SHIFT  (1) // Stop Request Intr. Masked
#define WDMAIRQMSK_UPD_SHIFT   (0) // Register Update Intr. Masked
...
extern unsigned int VIOC_WDMA_Get_CAddress(volatile void __iomem *reg);
