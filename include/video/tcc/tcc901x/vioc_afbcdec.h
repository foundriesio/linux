...
#define AFBCDEC_IRQ_DETILING_ERR_MASK \
	(0x1 << AFBCDEC_IRQ_DETILING_ERR_SHIFT)
#define AFBCDEC_IRQ_DECODE_ERR_MASK \
	(0x1 << AFBCDEC_IRQ_DECODE_ERR_SHIFT)
#define AFBCDEC_IRQ_CONFIG_SWAPPED_MASK \
	(0x1 << AFBCDEC_IRQ_CONFIG_SWAPPED_SHIFT)
#define AFBCDEC_IRQ_SURF_COMPLETED_MASK \
	(0x1 << AFBCDEC_IRQ_SURF_COMPLETED_SHIFT)
...
#define AFBCDEC_HEADERBUF_ADDR_LOW_MASK \
	(0x3FFFFFF << AFBCDEC_HEADERBUF_ADDR_LOW_SHIFT)
#define AFBCDEC_HEADERBUF_ADDR_HIGH_MASK \
	(0xFFFF << AFBCDEC_HEADERBUF_ADDR_HIGH_SHIFT)
...
#define AFBCDEC_OUTBUF_ADDR_LOW_MASK \
	(0x1FFFFFF << AFBCDEC_OUTBUF_ADDR_LOW_SHIFT)
#define AFBCDEC_OUTBUF_ADDR_HIGH_MASK \
	(0xFFFF << AFBCDEC_OUTBUF_ADDR_HIGH_SHIFT)
#define AFBCDEC_OUTBUF_STRIDE_MASK \
	(0x1FF << AFBCDEC_OUTBUF_STRIDE_SHIFT)
...
extern void VIOC_AFBCDec_TurnOn(volatile void __iomem *reg,
	enum VIOC_AFBCDEC_SWAP swapmode);
