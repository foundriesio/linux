...
#define DCTRL_R2YMD_SHIFT		(27)	// RGB to YCbCr Conversion Option
#define DCTRL_ADVI_SHIFT		(26)	// Advanced interlaced mode
#define DCTRL_656_SHIFT			(25)	// CCIR 656 Mode
#define DCTRL_CKG_SHIFT			(24)	// Clock Gating Enable for Timing Generator
#define DCTRL_Y2RMD_SHIFT		(21)	// YUV to RGB converter mode register
#define DCTRL_PXDW_SHIFT		(16)	// PXDW
#define DCTRL_SREQ_SHIFT		(15)	// Stop Request
#define DCTRL_ID_SHIFT			(14)	// Inverted Data Enable
#define DCTRL_IV_SHIFT			(13)	// Inverted Vertical Sync
#define DCTRL_IH_SHIFT			(12)	// Inverted Horizontal Sync
#define DCTRL_IP_SHIFT			(11)	// Inverted Pixel Clock
#define DCTRL_CLEN_SHIFT		(10)	// Clipping Enable
#define DCTRL_R2Y_SHIFT			(9)		// RGB to YCbCr Converter Enable for Output
#define DCTRL_DP_SHIFT			(8)		// Double Pixel Data
#define DCTRL_NI_SHIFT			(7)		// Non-Interlace
#define DCTRL_TV_SHIFT			(6)		// TV mode
#define DCTRL_SRST_SHIFT		(5)		// Device display reset
...
extern void VIOC_DISP_SetY2RMD(volatile void __iomem *reg, unsigned char Y2RMD);
extern void VIOC_DISP_SetY2R(volatile void __iomem *reg, unsigned char Y2R);
extern void VIOC_DISP_SetSWAP(volatile void __iomem *reg, unsigned char SWAP);
...
extern void VIOC_DISP_SetAlign(volatile void __iomem *reg, unsigned int align);
extern void VIOC_DISP_GetAlign(volatile void __iomem *reg, unsigned int *align);
...
extern void VIOC_DISP_GetPosition(volatile void __iomem *reg, unsigned int *startX, unsigned int *startY );
...
extern void VIOC_DISP_SetCENH_contrast(volatile void __iomem *reg, unsigned int val);
extern void VIOC_DISP_GetCENH_hue(volatile void __iomem *reg, unsigned int *val);
extern void VIOC_DISP_GetCENH_brightness(volatile void __iomem *reg, unsigned int *val);
extern void VIOC_DISP_GetCENH_saturation(volatile void __iomem *reg, unsigned int *val);
extern void VIOC_DISP_GetCENH_contrast(volatile void __iomem *reg, unsigned int *val);
#endif
extern unsigned int VIOC_DISP_FMT_isRGB(unsigned int pxdw);
extern void VIOC_DISP_GetDisplayBlock_Info(volatile void __iomem *reg, struct DisplayBlock_Info *DDinfo);
extern void VIOC_DISP_SetClippingEnable(volatile void __iomem *reg, unsigned int enable);
extern void VIOC_DISP_GetClippingEnable(volatile void __iomem *reg, unsigned int *enable);
...
extern void VIOC_DISP_TurnOnOff_With_DV(volatile void __iomem *reg, unsigned int bOn);
#endif
...
extern void VIOC_DISP_EmergencyFlag_SetEofm(volatile void __iomem *reg, unsigned int eofm);
extern void VIOC_DISP_EmergencyFlag_SetHdmiVs(volatile void __iomem *reg, unsigned int hdmivs);
