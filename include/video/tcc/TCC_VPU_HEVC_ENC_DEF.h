 ...
 *		Definition
  * version
 *		0.0.0.2(2020/05/27) : first release
 */
...
#define VPU_HEVC_ENC_WORK_CODE_BUF_SIZE	(VPU_HEVC_ENC_SIZE_BIT_WORK + ((VPU_HEVC_ENC_WORKBUF_SIZE+VPU_HEVC_ENC_HEADER_BUF_SIZE)*VPU_HEVC_ENC_MAX_NUM_INSTANCE))  // 16MB
