...
#define PMAP_REARCAMERA4_SIZE		0
#define PMAP_REARCAMERA5_SIZE		0
#define PMAP_REARCAMERA6_SIZE		0
#define PMAP_REARCAMERA7_SIZE		0
#define PMAP_PARKING_GUI_SIZE		0
#else
#define PMAP_REARCAMERA_VIQE_SIZE	ARRAY_MBYTE((CAMERA_INPUT_WIDTH * (CAMERA_INPUT_HEIGHT / 2 ) * 4 * 4 * 3) / 2)
#define PMAP_REARCAMERA_SIZE		ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA1_SIZE		0//ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA2_SIZE		0//ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA3_SIZE		0//ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA4_SIZE		ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA5_SIZE		ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA6_SIZE		ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
#define PMAP_REARCAMERA7_SIZE		ARRAY_MBYTE(CAMERA_MAX_OUTPUT_WIDTH * CAMERA_MAX_OUTPUT_HEIGHT * 4 * 4)
...
#define PMAP_SIZE_EARLY_REARCAM		( 0x0	\
					...
					+ PMAP_REARCAMERA6_SIZE	\
					+ PMAP_REARCAMERA7_SIZE	\
