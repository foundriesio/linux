 ...
 */
#ifndef __DT_BINDINGS_TCC898X_VIOC_H
#define __DT_BINDINGS_TCC898X_VIOC_H
...
#define VIOC_SCALER_MAX		(0x0005)

/* DTRC : 0x06XX */
#define VIOC_DTRC			(0x0600)
#define VIOC_DTRC0			(0x0600)
#define VIOC_DTRC1			(0x0601)
#define VIOC_DTRC_MAX		(0x0002)
...
/* VIOC_DV_DISP : 0x18XX */
#define VIOC_DV_DISP		(0x1800)
#define VIOC_DV_DISP0		(0x1800)
#define VIOC_DV_DISP1		(0x1801)
#define VIOC_DV_DISP2		(0x1802)
#define VIOC_DV_DISP3		(0x1803)
#define VIOC_DV_DISP_MAX	(0x0004)

/* VIOC_V_DV : 0x19XX */
#define VIOC_V_DV			(0x1900)
...
#endif /* __DT_BINDINGS_TCC898X_VIOC_H */
