...
#define VIOC_RDMA06			(0x0206)	//TODO:TCC897X tcc_overlay_drv dt
...
#define FBX_SC_RDMA_UPDATE		FBX_UPDATE(0x1)
#define FBX_M2M_RDMA_UPDATE		FBX_UPDATE(0x2)
#define FBX_ATTACH_UPDATE		FBX_UPDATE(0x3)
#define FBX_OVERLAY_UPDATE		FBX_UPDATE(0x4)
