 ...
 */
#ifndef DT_BINDINGS_PMAP_TCC805X_LINUX_CLUSTER_DISPLAY_H
#define DT_BINDINGS_PMAP_TCC805X_LINUX_CLUSTER_DISPLAY_H
...
#define PMAP_SIZE_CAMERA_PGL		\
	ARRAY_MBYTE(CAMERA_OUTPUT_WIDTH * CAMERA_OUTPUT_HEIGHT * 4 * \
		FRAMES_CAMERA_PGL)
#define PMAP_SIZE_CAMERA_LASTFRAME	\
	ARRAY_MBYTE(CAMERA_OUTPUT_WIDTH * CAMERA_OUTPUT_HEIGHT * 4 * \
		FRAMES_CAMERA_LASTFRAME)
#define PMAP_SIZE_EARLY_REARCAM		(\
	...
	PMAP_SIZE_CAMERA_LASTFRAME + \
	PMAP_SIZE_CAMERA_PGL)

#endif//DT_BINDINGS_PMAP_TCC805X_LINUX_CLUSTER_DISPLAY_H
