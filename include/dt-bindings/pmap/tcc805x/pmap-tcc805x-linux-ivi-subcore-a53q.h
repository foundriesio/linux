...
#define	CAMERA_PGL_BASE			(RESERVED_MEM_BASE + PMAP_SIZE_FB_VIDEO)
...
#define	CAMERA_LASTFRAME_BASE		(CAMERA_PREVIEW7_BASE + PMAP_SIZE_CAMERA_PREVIEW7)

#define	ION_CARVEOUT_CAM_MEM_BASE	(CAMERA_LASTFRAME_BASE + PMAP_SIZE_CAMERA_LASTFRAME)
