...
static void spk_mute(void)
{
	...
	{
		gpio_set_value(TCC_GPE(14), 0); // tcc892x : gpio_e(18)	
	}
#endif
...
static void spk_un_mute(void)
{
	...
	if(machine_is_m805_893x())
	{
		gpio_set_value(TCC_GPE(14), 1);	// tcc892x : gpio_e(18)
	}
#endif
}
...
static void hp_mute(void)
{
	...
	if(machine_is_m805_893x())
	{
		gpio_set_value(TCC_GPE(13), 0);	// tcc892x : gpio_e(17)
	}
#endif
}
...
static void hp_un_mute(void)
{
	...
	if(machine_is_m805_893x())
	{
		gpio_set_value(TCC_GPE(13), 1); // tcc892x : gpio_e(17)	
	}
#endif
}
...
int tcc_hp_is_valid(void)
{
	...
	if(machine_is_m805_893x())
	{
		gpio_get_value(TCC_GPE(12)); // tcc892x : gpio_e(16)	
	}
#endif
...
static void __exit tcc_exit_es8388(void)
{
    printk("%s() \n", __func__);
...
module_init(tcc_init_es8388);
module_exit(tcc_exit_es8388);
