/*
 * linux/sound/soc/tcc/tcc5700_board_HD-DMB.c
 *
...
static struct snd_soc_card tcc_soc_card = {
	...
	.long_name		= "TCC5700 HD-DMB Audio",
	.dai_link		= tcc_dai,
...
static int tcc_audio_probe(struct platform_device *pdev)
{
	...
	line_out_mute = of_get_named_gpio(pdev->dev.of_node, "codec_mute_ctl-gpios", 0);
...
static const struct of_device_id tcc_audio_of_match[] = {
	{ .compatible = "telechips,snd-tcc5700-hd-dmb", },
	{},
};

static struct platform_driver tcc_audio_driver = {
	.driver = {
		.name = "tcc5700-audio-hd-dmb",
		.owner = THIS_MODULE,
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:tcc5700-audio-hd-dmb");
