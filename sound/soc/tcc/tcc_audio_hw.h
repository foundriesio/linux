...
#define TCC_CDIF_CDDI0_OFFSET \
	(0x0000)
#define TCC_CDIF_CDDI1_OFFSET \
	(0x0004)
#define TCC_CDIF_CDDI2_OFFSET \
	(0x0008)
#define TCC_CDIF_CDDI3_OFFSET \
	(0x000C)
#define TCC_CDIF_CDDI4_OFFSET \
	(0x0010)
#define TCC_CDIF_CDDI5_OFFSET \
	(0x0014)
#define TCC_CDIF_CDDI6_OFFSET \
	(0x0018)
#define TCC_CDIF_CDDI7_OFFSET \
	(0x001C)
#define TCC_CDIF_CICR_OFFSET \
	(0x0020)
...
#define TCC_SPDIF_TX_SAMPLEDATA_BUF_OFFSET \
	(0x0200)
#define TCC_SPDIF_TX_DMACFG_OFFSET \
	(0x0400)

#define TCC_SPDIF_RX_VERSION_OFFSET \
	(0x0800)
...
#define IOBUS_CFG_DAI1_CHMUX \
	(0x0060)
#define IOBUS_CFG_CDIF0_CHMUX \
	(0x0064)
#define IOBUS_CFG_CDIF1_CHMUX \
	(0x0068)
...
#define CDDI_LDATA_Pos \
	(16)
#define CDDI_LDATA_Msk \
	(0xFFFFU << CDDI_LDATA_Pos)

#define CDDI_RDATA_Pos \
	(0)
#define CDDI_RDATA_Msk \
	(0xFFFFU << CDDI_RDATA_Pos)

/****** CDIF CD Interface Control Register (CICR), Offset:0x10A0 ******/
#define CICR_CDIF_ENABLE_Pos \
	(7)
#define CICR_CDIF_ENABLE_Msk \
	((uint32_t)1U << CICR_CDIF_ENABLE_Pos)
#define CICR_CDIF_ENABLE \
	((uint32_t)1U << CICR_CDIF_ENABLE_Pos)
#define CICR_CDIF_DISABLE \
	((uint32_t)1U << CICR_CDIF_ENABLE_Pos)

#define CICR_CDIF_BCLK_SEL_Pos \
	(2)
#define CICR_CDIF_BCLK_SEL_Msk \
	((uint32_t)0x3U << CICR_CDIF_BCLK_SEL_Pos)
#define CICR_CDIF_BCLK_SEL_64FS \
	((uint32_t)0x0U << CICR_CDIF_BCLK_SEL_Pos)
#define CICR_CDIF_BCLK_SEL_48FS \
	((uint32_t)0x1U << CICR_CDIF_BCLK_SEL_Pos)
#define CICR_CDIF_BCLK_SEL_32FS \
	((uint32_t)0x2U << CICR_CDIF_BCLK_SEL_Pos)

#define CICR_CDIF_INTERFACE_MODE_Pos \
	(1)
#define CICR_CDIF_INTERFACE_MODE_Msk \
	((uint32_t)0x1U << CICR_CDIF_INTERFACE_MODE_Pos)
#define CICR_CDIF_INTERFACE_IIS \
	((uint32_t)0x0U << CICR_CDIF_INTERFACE_MODE_Pos)
#define CICR_CDIF_INTERFACE_RJUSTIFIED \
	((uint32_t)0x1U << CICR_CDIF_INTERFACE_MODE_Pos)

#define CICR_CDIF_BCLK_POLARITY_Pos \
	(0)
#define CICR_CDIF_BCLK_POLARITY_Msk \
	((uint32_t)0x1U << CICR_CDIF_BCLK_POLARITY_Pos)
#define CICR_CDIF_BCLK_POSITIVE \
	((uint32_t)0x0U << CICR_CDIF_BCLK_POLARITY_Pos)
#define CICR_CDIF_BCLK_NEGATIVE \
	((uint32_t)0x1U << CICR_CDIF_BCLK_POLARITY_Pos)
...
#define SPDIF_TX_VERSION_ADDRESS_WIDTH_Pos \
	(5)
#define SPDIF_TX_VERSION_ADDRESS_WIDTH_Msk \
	((uint32_t)0x3fU << SPDIF_TX_VERSION_ADDRESS_WIDTH_Pos)

#define SPDIF_TX_VERSION_USER_DATA_BUF_Pos \
	(11)
#define SPDIF_TX_VERSION_USER_DATA_BUF_Msk \
	((uint32_t)0x1U << SPDIF_TX_VERSION_USER_DATA_BUF_Pos)
...
#define SPDIF_TX_CONFIG_CHSTAT_ENABLE_Pos \
	(4)
#define SPDIF_TX_CONFIG_CHSTAT_ENABLE_Msk \
	((uint32_t)0x3U << SPDIF_TX_CONFIG_CHSTAT_ENABLE_Pos)
#define SPDIF_TX_CONFIG_CHSTAT_FROM_TXCHSTAT \
	((uint32_t)0x0U << SPDIF_TX_CONFIG_CHSTAT_ENABLE_Pos)
#define SPDIF_TX_CONFIG_CHSTAT_FROM_CHSTAT0 \
	((uint32_t)0x1U << SPDIF_TX_CONFIG_CHSTAT_ENABLE_Pos)
#define SPDIF_TX_CONFIG_CHSTAT_FROM_CHSTAT1 \
	((uint32_t)0x2U << SPDIF_TX_CONFIG_CHSTAT_ENABLE_Pos)

#define SPDIF_TX_CONFIG_USERDATA_ENABLE_Pos \
	(6)
#define SPDIF_TX_CONFIG_USERDATA_ENABLE_Msk \
	((uint32_t)0x3U << SPDIF_TX_CONFIG_USERDATA_ENABLE_Pos)
#define SPDIF_TX_CONFIG_USERDATA_ZERO \
	((uint32_t)0x0U << SPDIF_TX_CONFIG_USERDATA_ENABLE_Pos)
#define SPDIF_TX_CONFIG_USERDATA_FROM_USERDATA0 \
	((uint32_t)0x1U << SPDIF_TX_CONFIG_USERDATA_ENABLE_Pos)
#define SPDIF_TX_CONFIG_USERDATA_FROM_USERDATA1 \
	((uint32_t)0x2U << SPDIF_TX_CONFIG_USERDATA_ENABLE_Pos)
...
#define SPDIF_TX_INTMASK_LOW_DATA_BUF_EMP_Pos \
	(1)
#define SPDIF_TX_INTMASK_LOW_DATA_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTMASK_LOW_DATA_BUF_EMP_Pos)

#define SPDIF_TX_INTMASK_HIGH_DATA_BUF_EMP_Pos \
	(2)
#define SPDIF_TX_INTMASK_HIGH_DATA_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTMASK_HIGH_DATA_BUF_EMP_Pos)

#define SPDIF_TX_INTMASK_LOW_CH_BUF_EMP_Pos \
	(3)
#define SPDIF_TX_INTMASK_LOW_CH_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTMASK_LOW_CH_BUF_EMP_Pos)

#define SPDIF_TX_INTMASK_HIGH_CH_BUF_EMP_Pos \
	(4)
#define SPDIF_TX_INTMASK_HIGH_CH_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTMASK_HIGH_CH_BUF_EMP_Pos)

/****** SPDIF Tx INTSTAT, Offset:0x10 ******/
#define SPDIF_TX_INTSTAT_LOW_DATA_BUF_EMP_Pos \
	(1)
#define SPDIF_TX_INTSTAT_LOW_DATA_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTSTAT_LOW_DATA_BUF_EMP_Pos)

#define SPDIF_TX_INTSTAT_HIGH_DATA_BUF_EMP_Pos \
	(2)
#define SPDIF_TX_INTSTAT_HIGH_DATA_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTSTAT_HIGH_DATA_BUF_EMP_Pos)

#define SPDIF_TX_INTSTAT_LOW_CH_BUF_EMP_Pos \
	(3)
#define SPDIF_TX_INTSTAT_LOW_CH_BUF_EMP_Msk	\
	((uint32_t)0x1U << SPDIF_TX_INTSTAT_LOW_CH_BUF_EMP_Pos)

#define SPDIF_TX_INTSTAT_HIGH_CH_BUF_EMP_Pos \
	(4)
#define SPDIF_TX_INTSTAT_HIGH_CH_BUF_EMP_Msk \
	((uint32_t)0x1U << SPDIF_TX_INTSTAT_HIGH_CH_BUF_EMP_Pos)

/****** SPDIF Tx USERDATA_BUF, Offset:0x80~DC ******/
#define SPDIF_TX_USERDATA_BUF_COUNT \
	(24)
#define SPDIF_TX_USERDATA_BUF_CHANNEL_A_Pos \
	(0)
#define SPDIF_TX_USERDATA_BUF_CHANNEL_A_Msk \
	((uint32_t)0xffU << SPDIF_TX_USERDATA_BUF_CHANNEL_A_Pos)

#define SPDIF_TX_USERDATA_BUF_CHANNEL_B_Pos \
	(8)
#define SPDIF_TX_USERDATA_BUF_CHANNEL_B_Msk \
	((uint32_t)0xffU << SPDIF_TX_USERDATA_BUF_CHANNEL_B_Pos)
...
#define SPDIF_TX_SAMPLEDATA_BUF_COUNT \
	(16)
#define SPDIF_TX_SAMPLEDATA_BUF_LOWER_16BIT_Pos \
	(0)
#define SPDIF_TX_SAMPLEDATA_BUF_LOWER_16BIT_Msk \
	(0xffffU << SPDIF_TX_SAMPLEDATA_BUF_LOWER_16BIT_Pos)

#define SPDIF_TX_SAMPLEDATA_BUF_HIGH_8BIT_Pos \
	(16)
#define SPDIF_TX_SAMPLEDATA_BUF_HIGH_8BIT_Msk \
	(0xffU << SPDIF_TX_SAMPLEDATA_BUF_HIGH_8BIT_Pos)


/****** SPDIF Tx SAMPLEDATA_BUF, Offset:0x400 ******/
#define SPDIF_TX_DMACFG_FIFO_THRESHOLD_Pos \
	(0)
#define SPDIF_TX_DMACFG_FIFO_THRESHOLD_Msk \
	((uint32_t)0xfU << SPDIF_TX_DMACFG_FIFO_THRESHOLD_Pos)

#define SPDIF_TX_DMACFG_FIFO_CLEAR_Pos \
	(7)
#define SPDIF_TX_DMACFG_FIFO_CLEAR_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_FIFO_CLEAR_Pos)
#define SPDIF_TX_DMACFG_FIFO_CLEAR_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_FIFO_CLEAR_Pos)
#define SPDIF_TX_DMACFG_FIFO_CLEAR_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_FIFO_CLEAR_Pos)

#define SPDIF_TX_DMACFG_AMODE0_Pos \
	(8)
#define SPDIF_TX_DMACFG_AMODE0_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_AMODE0_Pos)
#define SPDIF_TX_DMACFG_AMODE0_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_AMODE0_Pos)
#define SPDIF_TX_DMACFG_AMODE0_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_AMODE0_Pos)

#define SPDIF_TX_DMACFG_AMODE1_Pos \
	(9)
#define SPDIF_TX_DMACFG_AMODE1_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_AMODE1_Pos)
#define SPDIF_TX_DMACFG_AMODE1_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_AMODE1_Pos)
#define SPDIF_TX_DMACFG_AMODE1_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_AMODE1_Pos)

#define SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_Pos \
	(10)
#define SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_Pos)
#define SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_Pos)
#define SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_SAMPDATA_DMAREQ_Pos)

#define SPDIF_TX_DMACFG_USERDATA_DMAREQ_Pos \
	(11)
#define SPDIF_TX_DMACFG_USERDATA_DMAREQ_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_USERDATA_DMAREQ_Pos)
#define SPDIF_TX_DMACFG_USERDATA_DMAREQ_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_USERDATA_DMAREQ_Pos)
#define SPDIF_TX_DMACFG_USERDATA_DMAREQ_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_USERDATA_DMAREQ_Pos)

#define SPDIF_TX_DMACFG_READADDR_MODE_Pos \
	(12)
#define SPDIF_TX_DMACFG_READADDR_MODE_Msk \
	((uint32_t)0x3U << SPDIF_TX_DMACFG_READADDR_MODE_Pos)
#define SPDIF_TX_DMACFG_READADDR_24BIT \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_READADDR_MODE_Pos)
#define SPDIF_TX_DMACFG_READADDR_24BIT_LR \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_READADDR_MODE_Pos)
#define SPDIF_TX_DMACFG_READADDR_16BIT \
	((uint32_t)0x2U << SPDIF_TX_DMACFG_READADDR_MODE_Pos)
#define SPDIF_TX_DMACFG_READADDR_16BIT_LR \
	((uint32_t)0x3U << SPDIF_TX_DMACFG_READADDR_MODE_Pos)

#define SPDIF_TX_DMACFG_SWAP_Pos \
	(14)
#define SPDIF_TX_DMACFG_SWAP_Msk \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_SWAP_Pos)
#define SPDIF_TX_DMACFG_SWAP_DISABLE \
	((uint32_t)0x0U << SPDIF_TX_DMACFG_SWAP_Pos)
#define SPDIF_TX_DMACFG_SWAP_ENABLE \
	((uint32_t)0x1U << SPDIF_TX_DMACFG_SWAP_Pos)

#define SPDIF_TX_DMACFG_VALID_ENTRY_CNT_Pos \
	(16)
#define SPDIF_TX_DMACFG_VALID_ENTRY_CNT_Msk \
	((uint32_t)0x1fU << SPDIF_TX_DMACFG_VALID_ENTRY_CNT_Pos)

/****** SPDIF Rx Version, Offset:0x800 ******/
#define SPDIF_RX_VERSION_VER_Pos \
	(0)
#define SPDIF_RX_VERSION_VER_Msk \
	((uint32_t)0xfU << SPDIF_RX_VERSION_VER_Pos)

#define SPDIF_RX_VERSION_DATA_WIDTH_Pos \
	(4)
#define SPDIF_RX_VERSION_DATA_WIDTH_Msk \
	((uint32_t)0x1U << SPDIF_RX_VERSION_DATA_WIDTH_Pos)
#define SPDIF_RX_VERSION_DATA_WIDTH_16BIT \
	((uint32_t)0x0U << SPDIF_RX_VERSION_DATA_WIDTH_Pos)
#define SPDIF_RX_VERSION_DATA_WIDTH_24BIT \
	((uint32_t)0x1U << SPDIF_RX_VERSION_DATA_WIDTH_Pos)

#define SPDIF_RX_VERSION_ADDR_WIDTH_Pos \
	(5)
#define SPDIF_RX_VERSION_ADDR_WIDTH_Msk \
	((uint32_t)0x7fU << SPDIF_RX_VERSION_ADDR_WIDTH_Pos)

#define SPDIF_RX_VERSION_BUF_AVAIL_BIT_Pos \
	(16)
#define SPDIF_RX_VERSION_BUF_AVAIL_BIT_Msk \
	((uint32_t)0xfU << SPDIF_RX_VERSION_BUF_AVAILABLE_BIT_Pos)
...
#define SPDIF_RX_CONFIG_STORE_VALID_TYPE_Pos \
	(4)
#define SPDIF_RX_CONFIG_STORE_VALID_TYPE_Msk \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_VALID_TYPE_Pos)
#define SPDIF_RX_CONFIG_STORE_VALID_REGARDLESS \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_STORE_VALID_TYPE_Pos)
#define SPDIF_RX_CONFIG_STORE_VALID_ONLY \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_VALID_TYPE_Pos)

#define SPDIF_RX_CONFIG_STORE_VALID_BIT_Pos \
	(16)
#define SPDIF_RX_CONFIG_STORE_VALID_BIT_Msk \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_VALID_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_VALID_BIT_DISABLE \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_STORE_VALID_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_VALID_BIT_ENABLE \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_VALID_BIT_Pos)

#define SPDIF_RX_CONFIG_STORE_USERDATA_Pos \
	(17)
#define SPDIF_RX_CONFIG_STORE_USERDATA_Msk \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_USERDATA_Pos)
#define SPDIF_RX_CONFIG_STORE_USERDATA_DISABLE \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_STORE_USERDATA_Pos)
#define SPDIF_RX_CONFIG_STORE_USERDATA_ENABLE \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_USERDATA_Pos)

#define SPDIF_RX_CONFIG_STORE_STATUS_BIT_Pos (18)
#define SPDIF_RX_CONFIG_STORE_STATUS_BIT_Msk \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_STATUS_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_STATUS_BIT_DISABLE \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_STORE_STATUS_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_STATUS_BIT_ENABLE \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_STATUS_BIT_Pos)

#define SPDIF_RX_CONFIG_STORE_PARITY_BIT_Pos (19)
#define SPDIF_RX_CONFIG_STORE_PARITY_BIT_Msk \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_PARITY_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_PARITY_BIT_DISABLE \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_STORE_PARITY_BIT_Pos)
#define SPDIF_RX_CONFIG_STORE_PARITY_BIT_ENABLE \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_STORE_PARITY_BIT_Pos)
...
#define SPDIF_RX_CONFIG_BLK_MARK_DISABLE \
	((uint32_t)0x0U << SPDIF_RX_CONFIG_BLK_MARK_Pos)
#define SPDIF_RX_CONFIG_BLK_MARK_ENABLE \
	((uint32_t)0x1U << SPDIF_RX_CONFIG_BLK_MARK_Pos)
...
#define SPDIF_RX_SIGSTAT_FORMAT_PROFESSIONAL \
	((uint32_t)0x1U << SPDIF_RX_SIGSTAT_FORMAT_Pos)
#define SPDIF_RX_SIGSTAT_FORMAT_CONSUMER \
	((uint32_t)0x0U << SPDIF_RX_SIGSTAT_FORMAT_Pos)

#define SPDIF_RX_SIGSTAT_DATA_TYPE_Pos \
	(2)
#define SPDIF_RX_SIGSTAT_DATA_TYPE_Msk \
	((uint32_t)0x1U << SPDIF_RX_SIGSTAT__Pos)
#define SPDIF_RX_SIGSTAT_DATA_TYPE_AUDIO \
	((uint32_t)0x1U << SPDIF_RX_SIGSTAT__Pos)
#define SPDIF_RX_SIGSTAT_DATA_TYPE_NON_AUDIO \
	((uint32_t)0x0U << SPDIF_RX_SIGSTAT__Pos)

#define SPDIF_RX_SIGSTAT_EMPHASIS_CODE_Pos \
	(3)
#define SPDIF_RX_SIGSTAT_EMPHASIS_CODE_Msk \
	((uint32_t)0x7U << SPDIF_RX_SIGSTAT_EMPHASIS_CODE_Pos)
...
#define SPDIF_RX_INTMASK_LOCK_BIT_CHAGED_Pos \
	(0)
#define SPDIF_RX_INTMASK_LOCK_BIT_CHAGED_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTMASK_LOCK_BIT_CHAGED_Pos)

#define SPDIF_RX_INTMASK_LOWER_SAMP_BUF_FULL_Pos \
	(1)
#define SPDIF_RX_INTMASK_LOWER_SAMP_BUF_FULL_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTMASK_LOWER_SAMP_BUF_FULL_Pos)

#define SPDIF_RX_INTMASK_HIGHER_SAMP_BUF_FULL_Pos \
	(2)
#define SPDIF_RX_INTMASK_HIGHER_SAMP_BUF_FULL_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTMASK_HIGHER_SAMP_BUF_FULL_Pos)

#define SPDIF_RX_INTMASK_PARITY_ERR_CH_A_Pos \
	(3)
#define SPDIF_RX_INTMASK_PARITY_ERR_CH_A_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTMASK_PARITY_ERR_CH_A_Pos)

#define SPDIF_RX_INTMASK_PARITY_ERR_CH_B_Pos \
	(4)
#define SPDIF_RX_INTMASK_PARITY_ERR_CH_B_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTMASK_PARITY_ERR_CH_B_Pos)
...
#define SPDIF_RX_INTSTAT_LOCK_BIT_CHAGED_Pos \
	(0)
#define SPDIF_RX_INTSTAT_LOCK_BIT_CHAGED_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTSTAT_LOCK_BIT_CHAGED_Pos)

#define SPDIF_RX_INTSTAT_LOWER_SAMP_BUF_FULL_Pos \
	(1)
#define SPDIF_RX_INTSTAT_LOWER_SAMP_BUF_FULL_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTSTAT_LOWER_SAMP_BUF_FULL_Pos)

#define SPDIF_RX_INTSTAT_HIGHER_SAMP_BUF_FULL_Pos \
	(2)
#define SPDIF_RX_INTSTAT_HIGHER_SAMP_BUF_FULL_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTSTAT_HIGHER_SAMP_BUF_FULL_Pos)

#define SPDIF_RX_INTSTAT_PARITY_ERR_CH_A_Pos \
	(3)
#define SPDIF_RX_INTSTAT_PARITY_ERR_CH_A_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTSTAT_PARITY_ERR_CH_A_Pos)

#define SPDIF_RX_INTSTAT_PARITY_ERR_CH_B_Pos \
	(4)
#define SPDIF_RX_INTSTAT_PARITY_ERR_CH_B_Msk \
	((uint32_t)0x1U << SPDIF_RX_INTSTAT_PARITY_ERR_CH_B_Pos)
...
#define SPDIF_RX_CAP_CHCTRL_BIT_POSITION_Pos \
	(8)
#define SPDIF_RX_CAP_CHCTRL_BIT_POSITION_Msk \
	((uint32_t)0xffU << SPDIF_RX_CAP_CHCTRL_BIT_POSITION_Pos)
...
#define IOBUS_CFG_CHMUX_SEL_Msk \
	...
	defined(CONFIG_ARCH_TCC806X)
#if defined(CONFIG_ARCH_TCC805X) || defined(CONFIG_ARCH_TCC806X)
#define IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Pos \
	(0)
#define IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Msk \
	((uint32_t)0x1FU << IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Pos \
	(8)
#define IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Msk \
	((uint32_t)0x1FU << IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Pos \
	(16)
#define IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Msk \
	((uint32_t)0x1FU << IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_71CH_3_SEL_Pos \
	(24)
#define IOBUS_CFG_DAI_CHMUX_71CH_3_SEL_Msk \
	((uint32_t)0x1FU << IOBUS_CFG_DAI_CHMUX_71CH_3_SEL_Pos)
#else
#define IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Pos \
	(0)
#define IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Msk \
	((uint32_t)0xFU << IOBUS_CFG_DAI_CHMUX_71CH_0_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Pos \
	(8)
#define IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Msk \
	((uint32_t)0xFU << IOBUS_CFG_DAI_CHMUX_71CH_1_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Pos\
	(16)
#define IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Msk \
	((uint32_t)0xFU << IOBUS_CFG_DAI_CHMUX_71CH_2_SEL_Pos)
#endif

#define IOBUS_CFG_DAI_CHMUX_SRCH_0_SEL_Pos \
	(0)
#define IOBUS_CFG_DAI_CHMUX_SRCH_0_SEL_Msk \
	((uint32_t)0x3FU << IOBUS_CFG_DAI_CHMUX_SRCH_0_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_SRCH_1_SEL_Pos \
	(8)
#define IOBUS_CFG_DAI_CHMUX_SRCH_1_SEL_Msk \
	((uint32_t)0x3FU << IOBUS_CFG_DAI_CHMUX_SRCH_1_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_SRCH_2_SEL_Pos \
	(16)
#define IOBUS_CFG_DAI_CHMUX_SRCH_2_SEL_Msk \
	((uint32_t)0x3FU << IOBUS_CFG_DAI_CHMUX_SRCH_2_SEL_Pos)

#define IOBUS_CFG_DAI_CHMUX_SRCH_3_SEL_Pos \
	(24)
#define IOBUS_CFG_DAI_CHMUX_SRCH_3_SEL_Msk \
	((uint32_t)0x3FU << IOBUS_CFG_DAI_CHMUX_SRCH_3_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_71CH0_0_SEL_Pos \
	(0)
#define IOBUS_CFG_SPDIF_CHMUX_71CH0_0_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_71CH0_0_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_71CH0_1_SEL_Pos \
	(16)
#define IOBUS_CFG_SPDIF_CHMUX_71CH0_1_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_71CH0_1_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_71CH1_2_SEL_Pos \
	(0)
#define IOBUS_CFG_SPDIF_CHMUX_71CH1_2_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_71CH1_2_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_SRCH0_0_SEL_Pos \
	(0)
#define IOBUS_CFG_SPDIF_CHMUX_SRCH0_0_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_SRCH0_0_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_SRCH0_1_SEL_Pos \
	(16)
#define IOBUS_CFG_SPDIF_CHMUX_SRCH0_1_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_SRCH0_1_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_SRCH1_2_SEL_Pos \
	(0)
#define IOBUS_CFG_SPDIF_CHMUX_SRCH1_2_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_SRCH1_2_SEL_Pos)

#define IOBUS_CFG_SPDIF_CHMUX_SRCH1_3_SEL_Pos \
	(16)
#define IOBUS_CFG_SPDIF_CHMUX_SRCH1_3_SEL_Msk \
	((uint32_t)0x7FU << IOBUS_CFG_SPDIF_CHMUX_SRCH1_3_SEL_Pos)
