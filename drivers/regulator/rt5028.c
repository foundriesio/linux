...
static struct rt5028_voltage_t buck12_voltages[] = {
	{700000, 0x00}, {725000, 0x01},
	{750000, 0x02}, {775000, 0x03},
	{800000, 0x04}, {825000, 0x05},
	{850000, 0x06}, {875000, 0x07},
	{900000, 0x08}, {925000, 0x09},
	{950000, 0x0A}, {975000, 0x0B},
	{1000000, 0x0C}, {1025000, 0x0D},
	{1050000, 0x0E}, {1075000, 0x0F},	// 16
	{1100000, 0x10}, {1125000, 0x11},
	{1150000, 0x12}, {1175000, 0x13},
	{1200000, 0x14}, {1225000, 0x15},
	{1250000, 0x16}, {1275000, 0x17},
	{1300000, 0x18}, {1325000, 0x19},
	{1350000, 0x1A}, {1375000, 0x1B},
	{1400000, 0x1C}, {1425000, 0x1D},
	{1450000, 0x1E}, {1475000, 0x1F},	// 32
	{1500000, 0x20}, {1525000, 0x21},
	{1550000, 0x22}, {1575000, 0x23},
	{1600000, 0x24}, {1625000, 0x25},
	{1650000, 0x26}, {1675000, 0x27},
	{1700000, 0x28}, {1725000, 0x29},
	{1750000, 0x2A}, {1775000, 0x2B},
	{1800000, 0x2C}, {1800000, 0x2D},
	{1800000, 0x2E}, {1800000, 0x2F},	// 48
	{1800000, 0x30}, {1800000, 0x31},
	{1800000, 0x32}, {1800000, 0x33},
	{1800000, 0x34}, {1800000, 0x35},
	{1800000, 0x36}, {1800000, 0x37},
	{1800000, 0x38}, {1800000, 0x39},
	{1800000, 0x3A}, {1800000, 0x3B},
	{1800000, 0x3C}, {1800000, 0x3D},
	{1800000, 0x3E}, {1800000, 0x3F},	// 64
};

#define NUM_BUCK12    ARRAY_SIZE(buck12_voltages)	/* 700mV~1800mV */

static struct rt5028_voltage_t buck34_voltages[] = {
	{700000, 0x00}, {750000, 0x01},
	{800000, 0x02}, {850000, 0x03},
	{900000, 0x04}, {950000, 0x05},
	{1000000, 0x06}, {1050000, 0x07},
	{1100000, 0x08}, {1150000, 0x09},
	{1200000, 0x0A}, {1250000, 0x0B},
	{1300000, 0x0C}, {1350000, 0x0D},
	{1400000, 0x0E}, {1450000, 0x0F},	// 16
	{1500000, 0x10}, {1550000, 0x11},
	{1600000, 0x12}, {1650000, 0x13},
	{1700000, 0x14}, {1750000, 0x15},
	{1800000, 0x16}, {1850000, 0x17},
	{1900000, 0x18}, {1950000, 0x19},
	{2000000, 0x1A}, {2050000, 0x1B},
	{2100000, 0x1C}, {2150000, 0x1D},
	{2200000, 0x1E}, {2250000, 0x1F},	// 32
	{2300000, 0x20}, {2350000, 0x21},
	{2400000, 0x22}, {2450000, 0x23},
	{2500000, 0x24}, {2550000, 0x25},
	{2600000, 0x26}, {2650000, 0x27},
	{2700000, 0x28}, {2750000, 0x29},
	{2800000, 0x2A}, {2850000, 0x2B},
	{2900000, 0x2C}, {2950000, 0x2D},
	{3000000, 0x2E}, {3050000, 0x2F},	// 48
	{3100000, 0x30}, {3150000, 0x31},
	{3200000, 0x32}, {3250000, 0x33},
	{3300000, 0x34}, {3350000, 0x35},
	{3400000, 0x36}, {3450000, 0x37},
	{3500000, 0x38}, {3550000, 0x39},
	{3600000, 0x3A}, {3600000, 0x3B},
	{3600000, 0x3C}, {3600000, 0x3D},
	{3600000, 0x3E}, {3600000, 0x3F},	// 64
};

#define NUM_BUCK34    ARRAY_SIZE(buck34_voltages)	/* 700mV~3600mV */

static struct rt5028_voltage_t ldo12378_voltages[] = {
	{1600000, 0x00}, {1625000, 0x01},
	{1650000, 0x02}, {1675000, 0x03},
	{1700000, 0x04}, {1725000, 0x05},
	{1750000, 0x06}, {1775000, 0x07},
	{1800000, 0x08}, {1825000, 0x09},
	{1850000, 0x0A}, {1875000, 0x0B},
	{1900000, 0x0C}, {1925000, 0x0D},
	{1950000, 0x0E}, {1975000, 0x0F},	// 16
	{2000000, 0x10}, {2025000, 0x11},
	{2050000, 0x12}, {2075000, 0x13},
	{2100000, 0x14}, {2125000, 0x15},
	{2150000, 0x16}, {2175000, 0x17},
	{2200000, 0x18}, {2225000, 0x19},
	{2250000, 0x1A}, {2275000, 0x1B},
	{2300000, 0x1C}, {2325000, 0x1D},
	{2350000, 0x1E}, {2375000, 0x1F},	// 32
	{2400000, 0x20}, {2425000, 0x21},
	{2450000, 0x22}, {2475000, 0x23},
	{2500000, 0x24}, {2525000, 0x25},
	{2550000, 0x26}, {2575000, 0x27},
	{2600000, 0x28}, {2625000, 0x29},
	{2650000, 0x2A}, {2675000, 0x2B},
	{2700000, 0x2C}, {2725000, 0x2D},
	{2750000, 0x2E}, {2775000, 0x2F},	// 48
	{2800000, 0x30}, {2825000, 0x31},
	{2850000, 0x32}, {2875000, 0x33},
	{2900000, 0x34}, {2925000, 0x35},
	{2950000, 0x36}, {2975000, 0x37},
	{3000000, 0x38}, {3025000, 0x39},
	{3050000, 0x3A}, {3075000, 0x3B},
	{3100000, 0x3C}, {3125000, 0x3D},
	{3150000, 0x3E}, {3175000, 0x3F},	// 64
	{3200000, 0x40}, {3225000, 0x41},
	{3250000, 0x42}, {3275000, 0x43},
	{3300000, 0x44}, {3325000, 0x45},
	{3350000, 0x46}, {3375000, 0x47},
	{3400000, 0x48}, {3425000, 0x49},
	{3450000, 0x4A}, {3475000, 0x4B},
	{3500000, 0x4C}, {3525000, 0x4D},
	{3550000, 0x4E}, {3575000, 0x4F},	// 80
	{3600000, 0x50}, {3600000, 0x51},
	{3600000, 0x52}, {3600000, 0x53},
	{3600000, 0x54}, {3600000, 0x55},
	{3600000, 0x56}, {3600000, 0x57},
	{3600000, 0x58}, {3600000, 0x59},
	{3600000, 0x5A}, {3600000, 0x5B},
	{3600000, 0x5C}, {3600000, 0x5D},
	{3600000, 0x5E}, {3600000, 0x5F},	// 96
	{3600000, 0x60}, {3600000, 0x61},
	{3600000, 0x62}, {3600000, 0x63},
	{3600000, 0x64}, {3600000, 0x65},
	{3600000, 0x66}, {3600000, 0x67},
	{3600000, 0x68}, {3600000, 0x69},
	{3600000, 0x6A}, {3600000, 0x6B},
	{3600000, 0x6C}, {3600000, 0x6D},
	{3600000, 0x6E}, {3600000, 0x6F},	// 112
	{3600000, 0x70}, {3600000, 0x71},
	{3600000, 0x72}, {3600000, 0x73},
	{3600000, 0x74}, {3600000, 0x75},
	{3600000, 0x76}, {3600000, 0x77},
	{3600000, 0x78}, {3600000, 0x79},
	{3600000, 0x7A}, {3600000, 0x7B},
	{3600000, 0x7C}, {3600000, 0x7D},
	{3600000, 0x7E}, {3600000, 0x7F},
};

#define NUM_LDO12378     ARRAY_SIZE(ldo12378_voltages)

static struct rt5028_voltage_t ldo456_voltages[] = {
	{3000000, 0x00}, {3025000, 0x01},
	{3050000, 0x02}, {3075000, 0x03},
	{3100000, 0x04}, {3125000, 0x05},
	{3150000, 0x06}, {3175000, 0x07},
	{3200000, 0x08}, {3225000, 0x09},
	{3250000, 0x0A}, {3275000, 0x0B},
	{3300000, 0x0C}, {3325000, 0x0D},
	{3350000, 0x0E}, {3375000, 0x0F},	// 16
	{3400000, 0x10}, {3425000, 0x11},
	{3450000, 0x12}, {3475000, 0x13},
	{3500000, 0x14}, {3525000, 0x15},
	{3550000, 0x16}, {3575000, 0x17},
	{3600000, 0x18}, {3600000, 0x19},
	{3600000, 0x1A}, {3600000, 0x1B},
	{3600000, 0x1C}, {3600000, 0x1D},
	{3600000, 0x1E}, {3600000, 0x1F},	// 32
	{3600000, 0x20}, {3600000, 0x21},
	{3600000, 0x22}, {3600000, 0x23},
	{3600000, 0x24}, {3600000, 0x25},
	{3600000, 0x26}, {3600000, 0x27},
	{3600000, 0x28}, {3600000, 0x29},
	{3600000, 0x2A}, {3600000, 0x2B},
	{3600000, 0x2C}, {3600000, 0x2D},
	{3600000, 0x2E}, {3600000, 0x2F},	// 48
	{3600000, 0x30}, {3600000, 0x31},
	{3600000, 0x32}, {3600000, 0x33},
	{3600000, 0x34}, {3600000, 0x35},
	{3600000, 0x36}, {3600000, 0x37},
	{3600000, 0x38}, {3600000, 0x39},
	{3600000, 0x3A}, {3600000, 0x3B},
	{3600000, 0x3C}, {3600000, 0x3D},
	{3600000, 0x3E}, {3600000, 0x3F},	// 64
	{3600000, 0x40}, {3600000, 0x41},
	{3600000, 0x42}, {3600000, 0x43},
	{3600000, 0x44}, {3600000, 0x45},
	{3600000, 0x46}, {3600000, 0x47},
	{3600000, 0x48}, {3600000, 0x49},
	{3600000, 0x4A}, {3600000, 0x4B},
	{3600000, 0x4C}, {3600000, 0x4D},
	{3600000, 0x4E}, {3600000, 0x4F},	// 80
	{3600000, 0x50}, {3600000, 0x51},
	{3600000, 0x52}, {3600000, 0x53},
	{3600000, 0x54}, {3600000, 0x55},
	{3600000, 0x56}, {3600000, 0x57},
...
static struct i2c_client *rt5028_i2c_client;
static unsigned int rt5028_suspend_status;
...
static void rt5028_work_func(struct work_struct *work)
{
	struct rt5028_data *rt5028 =
	    container_of(work, struct rt5028_data, work);
...
#ifdef USE_REGMAP
	ret =
	    regmap_read(rt5028->regmap, RT5028_IRQ1_STATUS_REG,
			(unsigned int *)&data[0]);
	if (ret < 0)
...
#else
	data[0] =
	    (unsigned char)i2c_smbus_read_byte_data(rt5028->client,
						    RT5028_IRQ1_STATUS_REG);
	data[1] =
	    (unsigned char)i2c_smbus_read_byte_data(rt5028->client,
						    RT5028_IRQ2_STATUS_REG);
#endif
	// Reset after read.
...
static int rt5028_buck_set_voltage(struct regulator_dev *rdev, int min_uV,
				   int max_uV, unsigned int *selector)
{
	...
	if (ret != 0)
		dev_info(&rt5028_i2c_client->dev,
			 "%s(reg:%x, val:%x) - fail(%d)\n", __func__, reg,
			 value, ret);
...
#ifdef USE_REGMAP
	ret =
	    regmap_read(rt5028->regmap, RT5028_BUCK_ON_OFF_REG,
			(unsigned int *)&old_value);
	if (ret < 0)
		return -EINVAL;
#else
	old_value =
	    (u8) i2c_smbus_read_byte_data(rt5028->client,
					  RT5028_BUCK_ON_OFF_REG);
#endif
...
#else
	return i2c_smbus_write_byte_data(rt5028->client, RT5028_BUCK_ON_OFF_REG,
					 value);
#endif
...
static int rt5028_ldo_set_voltage(struct regulator_dev *rdev, int min_uV,
				  int max_uV, unsigned int *selector)
{
	struct rt5028_data *rt5028 = rdev_get_drvdata(rdev);
	int id = rdev_get_id(rdev);
...
#ifdef USE_REGMAP
	ret =
	    regmap_read(rt5028->regmap, RT5028_LDO_ON_OFF_REG,
			(unsigned int *)&old_value);
	if (ret < 0)
		return -EINVAL;
#else
...
#else
	return i2c_smbus_write_byte_data(rt5028->client, RT5028_LDO_ON_OFF_REG,
					 value);
#endif
}
...
static int rt5028_pmic_probe(struct i2c_client *client,
			     const struct i2c_device_id *i2c_id)
{
	...
	if (!regulators_np) {
		dev_err(&client->dev,
			"Regulators(rt5028) device node not found\n");
		return -ENODEV;
	}
	...
	ret =
	    regmap_read(rt5028->regmap, RT5028_DEVICE_ID_REG,
			(unsigned int *)&i2c_data);
	if (ret < 0)
		return -EINVAL;
#else
	i2c_data =
	    i2c_smbus_read_byte_data(rt5028_i2c_client, RT5028_DEVICE_ID_REG);
#endif
...
//      }
	...
	for_each_child_of_node(regulators_np, reg_np) {
		...
		id = rt5028_reg[i].id;
		config.init_data =
		    of_get_regulator_init_data(&client->dev, reg_np,
					       rt5028_reg);
	...
	if (client->irq) {
...
#ifdef USE_REGMAP
		ret =
		    regmap_write(rt5028->regmap, RT5028_IRQ1_ENABLE_REG,
				 RT5028_IRQ1);
		if (ret < 0)
			dev_err(&client->dev,
				"failed to write IRQ1 enable (res=%d) !\n",
				ret);

		ret =
		    regmap_write(rt5028->regmap, RT5028_IRQ2_ENABLE_REG,
				 RT5028_IRQ2);
		if (ret < 0)
			dev_err(&client->dev,
				"failed to write IRQ2 enable (res=%d) !\n",
				ret);
		...
		if (ret < 0)
			dev_err(&client->dev,
				"failed to read IRQ1 status (res=%d) !\n", ret);

		ret =
		    regmap_read(rt5028->regmap, RT5028_IRQ2_STATUS_REG,
				(unsigned int *)&status);
		if (ret < 0)
			dev_err(&client->dev,
				"failed to read IRQ2 status(res=%d) !\n", ret);
		// Reset after read.
		...
		if (ret < 0)
			dev_err(&client->dev,
				"failed to write IRQ1 status (res=%d) !\n",
				ret);
		...
		if (ret < 0)
			dev_err(&client->dev,
				"failed to write IRQ2 status (res=%d) !\n",
				ret);
#else
		status =
		    i2c_smbus_write_byte_data(rt5028_i2c_client,
					      RT5028_IRQ1_ENABLE_REG,
					      RT5028_IRQ1);
		if (status < 0)
			dev_err(&client->dev,
				"failed to write IRQ1 enable (res=%d) !\n",
		...
		// TODO:
		status =
		    i2c_smbus_read_byte_data(rt5028_i2c_client,
					     RT5028_IRQ1_STATUS_REG);
		if (status < 0)
			dev_err(&client->dev,
				"failed to read IRQ1 status (res=%d) !\n",
...
#endif
		if (request_irq
		    (client->irq, rt5028_interrupt, IRQ_TYPE_EDGE_FALLING,
		     "rt5028_irq", rt5028)) {
			dev_err(&client->dev,
				"could not allocate IRQ_NO(%d) !\n",
				client->irq);
			ret = -EBUSY;
			goto err;
		}
...
static SIMPLE_DEV_PM_OPS(rt5028_pmic_pm_ops, rt5028_pmic_suspend,
			 rt5028_pmic_resume);
