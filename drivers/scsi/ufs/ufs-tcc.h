...
#if 0
#define  UP_DME_USER_REGION_DME_POWERON_REQ                             (0x7890U)
#define  UP_DME_USER_REGION_DME_POWERON_CNF_RESULT                      (0x7894U)
#define  UP_DME_USER_REGION_DME_POWEROFF_REQ                            (0x7810U)
#define  UP_DME_USER_REGION_DME_POWEROFF_CNF_RESULT                     (0x7814U)
#define  UP_DME_USER_REGION_DME_RESET_REQ                               (0x7820U)
#define  UP_DME_USER_REGION_DME_RESET_REQ_LEVEL                         (0x7824U)
#define  UP_DME_USER_REGION_DME_ENABLE_REQ                              (0x7830U)
#define  UP_DME_USER_REGION_DME_ENABLE_CNF_RESULT                       (0x7834U)
#define  UP_DME_USER_REGION_DME_ENDPOINTRESET_REQ                       (0x7840U)
#define  UP_DME_USER_REGION_DME_ENDPOINTRESET_CNF_RESULT                (0x7844U)
#define  UP_DME_USER_REGION_DME_LINKSTARTUP_REQ                         (0x7850U)
#define  UP_DME_USER_REGION_DME_LINKSTARTUP_CNF_RESULT                  (0x7854U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_ENTER_REQ                     (0x7860U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_ENTER_CNF_RESULT              (0x7864U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_ENTER_IND_RESULT              (0x7868U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_EXIT_REQ                      (0x7870U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_EXIT_CNF_RESULT               (0x7874U)
#define  UP_DME_USER_REGION_DME_HIBERNATE_EXIT_IND_RESULT               (0x7878U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ                           (0x7880U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_POWERMODE                 (0x7884U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER0             (0x7888U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER1             (0x788cU)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER2             (0x7890U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER3             (0x7894U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER4             (0x7898U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_LOCALL2TIMER5             (0x789cU)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER0            (0x78b8U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER1            (0x78bcU)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER2            (0x78c0U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER3            (0x78c4U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER4            (0x78c8U)
#define  UP_DME_USER_REGION_DME_POWERMODE_REQ_REMOTEL2TIMER5            (0x78ccU)
#define  UP_DME_USER_REGION_DME_POWERMODE_CNF_RESULT                    (0x78e8U)
#define  UP_DME_USER_REGION_DME_POWERMODE_IND_RESULT                    (0x78ecU)
#define  UP_DME_USER_REGION_DME_TEST_MODE_REQ                           (0x7900U)
#define  UP_DME_USER_REGION_DME_TEST_MODE_CNF_RESULT                    (0x7904U)
#define  UP_DME_USER_REGION_DME_DEEPSTALL_ENTER_REQ                     (0x7910U)
#define  UP_DME_USER_REGION_DME_GETSET_CONTROL                          (0x7a00U)
#define  UP_DME_USER_REGION_DME_GETSET_ADDR                             (0x7a04U)
#define  UP_DME_USER_REGION_DME_GETSET_WDATA                            (0x7a08U)
#define  UP_DME_USER_REGION_DME_GETSET_RDATA                            (0x7a0cU)
#define  UP_DME_USER_REGION_DME_GETSET_RESULT                           (0x7a10U)
#define  UP_DME_USER_REGION_DME_PEER_GETSET_CONTROL                     (0x7a20U)
#define  UP_DME_USER_REGION_DME_PEER_GETSET_ADDR                        (0x7a24U)
#define  UP_DME_USER_REGION_DME_PEER_GETSET_WDATA                       (0x7a28U)
#define  UP_DME_USER_REGION_DME_PEER_GETSET_RDATA                       (0x7a2cU)
#define  UP_DME_USER_REGION_DME_PEER_GETSET_RESULT                      (0x7a30U)
#define  UP_DME_USER_REGION_DME_INTR_STATUS_LSB                         (0x7b00U)
#define  UP_DME_USER_REGION_DME_INTR_STATUS_MSB                         (0x7b04U)
#define  UP_DME_USER_REGION_DME_INTR_ENABLE_LSB                         (0x7b10U)
#define  UP_DME_USER_REGION_DME_INTR_ENABLE_MSB                         (0x7b14U)
#define  UP_DME_USER_REGION_DME_INTR_ERROR_CODE                         (0x7b20U)
#define  UP_DME_USER_REGION_DME_DISCARD_CPORT_ID                        (0x7b24U)
#define  UP_DME_USER_REGION_DME_DL_FRAME_IND                            (0x7b30U)
#define  UP_DME_USER_REGION_DME_DBG_OPTION_SUITE                        (0x7c00U)
#define  UP_DME_USER_REGION_DME_DBG_CTRL_FSM                            (0x7d00U)
#define  UP_DME_USER_REGION_DME_DBG_FORCE_CTRL_FSM                      (0x7d04U)
#define  UP_DME_USER_REGION_DME_DBG_FREEZE_CTRL_FSM                     (0x7d08U)
#define  UP_DME_USER_REGION_DME_DBG_STEP_CTRL_FSM                       (0x7d0cU)
#define  UP_DME_USER_REGION_DME_DBG_HALT_CTRL_FSM                       (0x7d10U)
#define  UP_DME_USER_REGION_DME_DBG_FLAG_STATUS                         (0x7d14U)
#define  UP_DME_USER_REGION_DME_DBG_LINKCFG_FSM                         (0x7d18U)
#define  UP_DME_USER_REGION_DME_DBG_LINKCFG_FSM_HALT_CTRL               (0x7d1cU)
#define  UP_DME_USER_REGION_DME_DBG_LINKCFG_FSM_FORCE                   (0x7d20U)
#define  UP_DME_STD_REGION_DME_DDBL1_REVISION                           (0x7000U)
#define  UP_DME_STD_REGION_DME_DDBL1_LEVEL                              (0x7004U)
#define  UP_DME_STD_REGION_DME_DDBL1_DEVICECLASS                        (0x7008U)
#define  UP_DME_STD_REGION_DME_DDBL1_MANUFACTURERID                     (0x700cU)
#define  UP_DME_STD_REGION_DME_DDBL1_PRODUCTID                          (0x7010U)
#define  UP_DME_STD_REGION_DME_DDBL1_LENGTH                             (0x7014U)
#define  UP_N_USER_REGION_N_DBG_L3S                                     (0x5800U)
#define  UP_N_USER_REGION_N_DBG_ERROR_IRQ_MASK                          (0x5840U)
#define  UP_N_USER_REGION_N_DBG_ERROR_IRQ_FLAG                          (0x5844U)
#define  UP_T_USER_REGION_T_DBG_CTRL_FSM                                (0x6800U)
#define  UP_T_USER_REGION_T_DBG_CMN_OPTION_SUITE                        (0x6804U)
#define  UP_T_USER_REGION_T_DBG_CPORT_L4S                               (0x6880U)
#define  UP_T_USER_REGION_T_DBG_CPORT_T_MTU                             (0x6884U)
#define  UP_T_USER_REGION_T_DBG_CPORT_TX_ENDIAN                         (0x6888U)
#define  UP_T_USER_REGION_T_DBG_CPORT_RX_ENDIAN                         (0x688cU)
#define  UP_T_USER_REGION_T_DBG_CPORT_OPTION_SUITE                      (0x6890U)
#define  UP_T_USER_REGION_T_DBG_CPORT_ERROR_IRQ_MASK                    (0x6894U)
#define  UP_T_USER_REGION_T_DBG_CPORT_ERROR_IRQ_FLAG                    (0x6898U)
#define  UP_T_USER_REGION_T_DBG_CPORT_TX_FSM                            (0x68a0U)
#define  UP_T_USER_REGION_T_DBG_CPORT_RX_FSM                            (0x68a4U)
#define  UP_PA_USER_REGION_PA_DBG_TX_INFO_RECEIVED                      (0x3804U)
#define  UP_PA_USER_REGION_PA_DBG_RX_INFO_RECEIVED                      (0x380cU)
#define  UP_PA_USER_REGION_PA_DBG_RECEIVED_TRG0_NUM                     (0x3840U)
#define  UP_PA_USER_REGION_PA_DBG_RECEIVED_TRG1_NUM                     (0x3844U)
#define  UP_PA_USER_REGION_PA_DBG_RECEIVED_TRG2_NUM                     (0x3848U)
#define  UP_PA_USER_REGION_PA_DBG_LINK_STARTUP_TIMER_THLD               (0x384cU)
#define  UP_PA_USER_REGION_PA_DBG_CLK_PERIOD                            (0x3850U)
#define  UP_PA_USER_REGION_PA_DBG_TXPHY_CFGUPDT                         (0x3860U)
#define  UP_PA_USER_REGION_PA_DBG_RXPHY_CFGUPDT                         (0x3864U)
#define  UP_PA_USER_REGION_PA_DBG_SEND_TRG0_NUM                         (0x3880U)
#define  UP_PA_USER_REGION_PA_DBG_SEND_TRG1_NUM                         (0x3884U)
#define  UP_PA_USER_REGION_PA_DBG_SEND_TRG2_NUM                         (0x3888U)
#define  UP_PA_USER_REGION_PA_DBG_INLNCFG                               (0x3890U)
#define  UP_PA_USER_REGION_PA_DBG_FORCE_FSM_START                       (0x3898U)
#define  UP_PA_USER_REGION_PA_DBG_MODE                                  (0x38a4U)
#define  UP_PA_USER_REGION_PA_DBG_RAWCAP                                (0x38d0U)
#define  UP_PA_USER_REGION_PA_DBG_IGNORE_CAP                            (0x38d4U)
#define  UP_PA_USER_REGION_PA_DBG_AUTOMODE_THLD                         (0x38d8U)
#define  UP_PA_USER_REGION_PA_DBG_SKIP_RESET_PHY                        (0x38e4U)
#define  UP_PA_USER_REGION_PA_DBG_SKIP_LINE_RESET                       (0x3904U)
#define  UP_PA_USER_REGION_PA_DBG_SEND_NO_DATA_DURING_DEEP_SYNC         (0x3908U)
#define  UP_PA_USER_REGION_PA_DBG_LINE_RESET_REQ                        (0x390cU)
#define  UP_PA_USER_REGION_PA_DBG_CMNPHY_CFGUPDT                        (0x3910U)
#define  UP_PA_USER_REGION_PA_DBG_MIB_CAP_SEL                           (0x3918U)
#define  UP_PA_USER_REGION_PA_DBG_RESUME_HIBERNATE                      (0x3940U)
#define  UP_PA_USER_REGION_PA_DBG_PHY_RESET_DELAY                       (0x3950U)
#define  UP_PA_USER_REGION_PA_DBG_RESET_DURATION                        (0x3954U)
#define  UP_PA_USER_REGION_PA_DBG_PA_ERROR_FLAGS                        (0x3958U)
#define  UP_PA_USER_REGION_PA_DBG_PA_ERROR_IRQ_MASK                     (0x395cU)
#define  UP_PA_USER_REGION_PA_DBG_LINE_RESET_THLD                       (0x3984U)
#define  UP_PA_USER_REGION_PA_DBG_LOCAL_PHY_ACTIVATE_TIME               (0x3988U)
#define  UP_PA_USER_REGION_PA_DBG_PEERWAKE_TIMEOUT                      (0x398cU)
#define  UP_PA_USER_REGION_PA_DBG_OPTION_SUITE_LSB                      (0x3990U)
#define  UP_PA_USER_REGION_PA_DBG_OPTION_SUITE_DYNAMIC                  (0x3994U)
#define  UP_PA_USER_REGION_PA_DBG_LOCAL_TX_CONNECTED_LANE_MASK          (0x3998U)
#define  UP_PA_USER_REGION_PA_DBG_PEER_TX_CONNECTED_LANE_MASK           (0x399cU)
#define  UP_PA_USER_REGION_PA_DBG_RECV_PEER_TX_LANE_NUMBER              (0x39a0U)
#define  UP_PA_USER_REGION_PA_DBG_FSM_POWER_CTRL                        (0x39a4U)
#define  UP_PA_USER_REGION_PA_DBG_OPTION_SUITE_MSB                      (0x39a8U)
#define  UP_PA_USER_REGION_PA_DBG_FSM_POWER_EXPECTED_STATE              (0x39acU)
#define  UP_PA_USER_REGION_PA_DBG_FSM_POWER_EXPECTED_NEXT_STATE         (0x39b0U)
#define  UP_PA_USER_REGION_PA_DBG_EXCEPTION_FLAGS                       (0x39c0U)
#define  UP_PA_USER_REGION_PA_DBG_EXCEPTION_IRQ_MASK                    (0x39c4U)
#define  UP_PA_USER_REGION_PA_DBG_DESKEW_NUM_FILLED                     (0x39c8U)
#define  UP_PA_USER_REGION_PA_DBG_START_FSM_BREAK                       (0x39ccU)
#define  UP_PA_USER_REGION_PA_DBG_PACP_SELECTOR                         (0x39d0U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER0                       (0x39d4U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER2                       (0x39d8U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER4                       (0x39dcU)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER6                       (0x39e0U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER8                       (0x39e4U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER10                      (0x3a00U)
#define  UP_PA_USER_REGION_PA_DBG_PACP_PARAMETER12                      (0x3a04U)
#define  UP_PA_USER_REGION_PA_DBG_PA_RX_INFO_CONTROL                    (0x3a08U)
#define  UP_PA_USER_REGION_PA_DBG_RX_PWM_BURST_CLOSURE_LENGTH           (0x3a40U)
#define  UP_PA_USER_REGION_PA_DBG_RX_LS_PREPARE_LENGTH                  (0x3a44U)
#define  UP_PA_USER_REGION_PA_DBG_RX_PWM_G6G7_SYNC_LENGTH               (0x3a48U)
#define  UP_PA_USER_REGION_PA_DBG_USERDATA_VALID                        (0x3a4cU)
#define  UP_PA_USER_REGION_PA_DBG_START_FSM_HALT                        (0x3a50U)
#define  UP_PA_USER_REGION_PA_DBG_FSM_START                             (0x3a54U)
#define  UP_PA_USER_REGION_PA_DBG_FSM_BURST_TXLANE                      (0x3a58U)
#define  UP_PA_USER_REGION_PA_DBG_FSM_POWER                             (0x3a5cU)
#define  UP_COMPONENT_REGION_COMP_VERSION                               (0x0000U)
#define  UP_COMPONENT_REGION_COMP_INFO                                  (0x0004U)
#define  UP_COMPONENT_REGION_COMP_RESET                                 (0x0010U)
#define  UP_COMPONENT_REGION_COMP_OPTION_SUITE                          (0x0020U)
#define  UP_COMPONENT_REGION_COMP_REMAP_CTRL                            (0x0030U)
#define  UP_COMPONENT_REGION_COMP_REMAP_BASE                            (0x0034U)
#define  UP_COMPONENT_REGION_COMP_AXI_AUX_FIELD                         (0x0040U)
#define  UP_COMPONENT_REGION_COMP_DBG_DTB_MUX_SEL                       (0x0050U)
#define  UP_PA_STD_REGION_PA_PHY_TYPE                                   (0x3000U)
#define  UP_PA_STD_REGION_PA_AVAILTXDATALANES                           (0x3080U)
#define  UP_PA_STD_REGION_PA_AVAILRXDATALANES                           (0x3100U)
#define  UP_PA_STD_REGION_PA_MINRXTRAILINGCLOCKS                        (0x310cU)
#define  UP_PA_STD_REGION_PA_TXHSG1SYNCLENGTH                           (0x3148U)
#define  UP_PA_STD_REGION_PA_TXHSG1PREPARELENGTH                        (0x314cU)
#define  UP_PA_STD_REGION_PA_TXHSG2SYNCLENGTH                           (0x3150U)
#define  UP_PA_STD_REGION_PA_TXHSG2PREPARELENGTH                        (0x3154U)
#define  UP_PA_STD_REGION_PA_TXHSG3SYNCLENGTH                           (0x3158U)
#define  UP_PA_STD_REGION_PA_TXHSG3PREPARELENGTH                        (0x315cU)
#define  UP_PA_STD_REGION_PA_TXMK2EXTENSION                             (0x3168U)
#define  UP_PA_STD_REGION_PA_PEERSCRAMBLING                             (0x316cU)
#define  UP_PA_STD_REGION_PA_TXSKIP                                     (0x3170U)
#define  UP_PA_STD_REGION_PA_TXSKIPPERIOD                               (0x3174U)
#define  UP_PA_STD_REGION_PA_LOCAL_TX_LCC_ENABLE                        (0x3178U)
#define  UP_PA_STD_REGION_PA_PEER_TX_LCC_ENABLE                         (0x317cU)
#define  UP_PA_STD_REGION_PA_ACTIVETXDATALANES                          (0x3180U)
#define  UP_PA_STD_REGION_PA_CONNECTEDTXDATALANES                       (0x3184U)
#define  UP_PA_STD_REGION_PA_TXTRAILINGCLOCKS                           (0x3190U)
#define  UP_PA_STD_REGION_PA_TXPWRSTATUS                                (0x319cU)
#define  UP_PA_STD_REGION_PA_TXGEAR                                     (0x31a0U)
#define  UP_PA_STD_REGION_PA_TXTERMINATION                              (0x31a4U)
#define  UP_PA_STD_REGION_PA_HSSERIES                                   (0x31a8U)
#define  UP_PA_STD_REGION_PA_PWRMODE                                    (0x31c4U)
#define  UP_PA_STD_REGION_PA_ACTIVERXDATALANES                          (0x3200U)
#define  UP_PA_STD_REGION_PA_CONNECTEDRXDATALANES                       (0x3204U)
#define  UP_PA_STD_REGION_PA_RXPWRSTATUS                                (0x3208U)
#define  UP_PA_STD_REGION_PA_RXGEAR                                     (0x320cU)
#define  UP_PA_STD_REGION_PA_RXTERMINATION                              (0x3210U)
#define  UP_PA_STD_REGION_PA_SCRAMBLING                                 (0x3214U)
#define  UP_PA_STD_REGION_PA_MAXRXPWMGEAR                               (0x3218U)
#define  UP_PA_STD_REGION_PA_MAXRXHSGEAR                                (0x321cU)
#define  UP_PA_STD_REGION_PA_PACPREQTIMEOUT                             (0x3240U)
#define  UP_PA_STD_REGION_PA_PACPREQEOBTIMEOUT                          (0x3244U)
#define  UP_PA_STD_REGION_PA_REMOTEVERINFO                              (0x3280U)
#define  UP_PA_STD_REGION_PA_LOGICALLANEMAP                             (0x3284U)
#define  UP_PA_STD_REGION_PA_SLEEPNOCONFIGTIME                          (0x3288U)
#define  UP_PA_STD_REGION_PA_STALLNOCONFIGTIME                          (0x328cU)
#define  UP_PA_STD_REGION_PA_SAVECONFIGTIME                             (0x3290U)
#define  UP_PA_STD_REGION_PA_RXHSUNTERMINATIONCAPABILITY                (0x3294U)
#define  UP_PA_STD_REGION_PA_RXLSTERMINATIONCAPABILITY                  (0x3298U)
#define  UP_PA_STD_REGION_PA_HIBERN8TIME                                (0x329cU)
#define  UP_PA_STD_REGION_PA_TACTIVATE                                  (0x32a0U)
#define  UP_PA_STD_REGION_PA_LOCALVERINFO                               (0x32a4U)
#define  UP_PA_STD_REGION_PA_GRANULARITY                                (0x32a8U)
#define  UP_PA_STD_REGION_PA_MK2EXTENSIONGUARDBAND                      (0x32acU)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA0                           (0x32c0U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA1                           (0x32c4U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA2                           (0x32c8U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA3                           (0x32ccU)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA4                           (0x32d0U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA5                           (0x32d4U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA6                           (0x32d8U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA7                           (0x32dcU)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA8                           (0x32e0U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA9                           (0x32e4U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA10                          (0x32e8U)
#define  UP_PA_STD_REGION_PA_PWRMODEUSERDATA11                          (0x32ecU)
#define  UP_PA_STD_REGION_PA_PACPFRAMECOUNT                             (0x3300U)
#define  UP_PA_STD_REGION_PA_PACPERRORCOUNT                             (0x3304U)
#define  UP_PA_STD_REGION_PA_PHYTESTCONTROL                             (0x3308U)
#define  UP_BUS_MONITOR_REGION_BUS_EXT_ACCESS_RESULT                    (0x0200U)
#define  UP_BUS_MONITOR_REGION_BUS_REM_ACCESS_CHANNEL                   (0x0210U)
#define  UP_BUS_MONITOR_REGION_BUS_REM_ACCESS_ADDR                      (0x0214U)
#define  UP_BUS_MONITOR_REGION_BUS_REM_ACCESS_USER                      (0x0218U)
#define  UP_BUS_MONITOR_REGION_BUS_REM_ACCESS_WDATA                     (0x021cU)
#define  UP_BUS_MONITOR_REGION_BUS_TRANS_CAPTURE_CONFIG                 (0x0220U)
#define  UP_BUS_MONITOR_REGION_BUS_TRANS_CAPTURE_WDATA                  (0x0224U)
#define  UP_T_STD_REGION_T_NUM_CPORTS                                   (0x6000U)
#define  UP_T_STD_REGION_T_NUMTESTFEATURES                              (0x6004U)
#define  UP_T_STD_REGION_T_CONNECTIONSTATE                              (0x6080U)
#define  UP_T_STD_REGION_T_PEERDEVICEID                                 (0x6084U)
#define  UP_T_STD_REGION_T_PEERCPORTID                                  (0x6088U)
#define  UP_T_STD_REGION_T_TRAFFICCLASS                                 (0x608cU)
#define  UP_T_STD_REGION_T_PROTOCOLID                                   (0x6090U)
#define  UP_T_STD_REGION_T_CPORTFLAGS                                   (0x6094U)
#define  UP_T_STD_REGION_T_TXTOKENVALUE                                 (0x6098U)
#define  UP_T_STD_REGION_T_RXTOKENVALUE                                 (0x609cU)
#define  UP_T_STD_REGION_T_LOCALBUFFERSPACE                             (0x60a0U)
#define  UP_T_STD_REGION_T_PEERBUFFERSPACE                              (0x60a4U)
#define  UP_T_STD_REGION_T_CREDITSTOSEND                                (0x60a8U)
#define  UP_T_STD_REGION_T_CPORTMODE                                    (0x60acU)
#define  UP_T_STD_REGION_T_TC0TXMAXSDUSIZE                              (0x6180U)
#define  UP_T_STD_REGION_T_TC1TXMAXSDUSIZE                              (0x6184U)
#define  UP_T_STD_REGION_T_TSTCPORTID                                   (0x6200U)
#define  UP_T_STD_REGION_T_TSTSRCON                                     (0x6204U)
#define  UP_T_STD_REGION_T_TSTSRCPATTERN                                (0x6208U)
#define  UP_T_STD_REGION_T_TSTSRCINCREMENT                              (0x620cU)
#define  UP_T_STD_REGION_T_TSTSRCMESSAGESIZE                            (0x6210U)
#define  UP_T_STD_REGION_T_TSTSRCMESSAGECOUNT                           (0x6214U)
#define  UP_T_STD_REGION_T_TSTSRCINTERMESSAGEGAP                        (0x6218U)
#define  UP_T_STD_REGION_T_TSTDSTON                                     (0x6284U)
#define  UP_T_STD_REGION_T_TSTDSTERRORDETECTIONENABLE                   (0x6288U)
#define  UP_T_STD_REGION_T_TSTDSTPATTERN                                (0x628cU)
#define  UP_T_STD_REGION_T_TSTDSTINCREMENT                              (0x6290U)
#define  UP_T_STD_REGION_T_TSTDSTMESSAGECOUNT                           (0x6294U)
#define  UP_T_STD_REGION_T_TSTDSTMESSAGEOFFSET                          (0x6298U)
#define  UP_T_STD_REGION_T_TSTDSTMESSAGESIZE                            (0x629cU)
#define  UP_T_STD_REGION_T_TSTDSTFCCREDITS                              (0x62a0U)
#define  UP_T_STD_REGION_T_TSTDSTINTERFCTOKENGAP                        (0x62a4U)
#define  UP_T_STD_REGION_T_TSTDSTINITIALFCCREDITS                       (0x62a8U)
#define  UP_T_STD_REGION_T_TSTDSTERRORCODE                              (0x62acU)
#define  UP_DL_USER_REGION_DL_DBG_FSM_STATE                             (0x4800U)
#define  UP_DL_USER_REGION_DL_DBG_FSM_FORCE                             (0x4804U)
#define  UP_DL_USER_REGION_DL_DBG_FSM_STEP_CTRL                         (0x4808U)
#define  UP_DL_USER_REGION_DL_DBG_FSM_HALT                              (0x480cU)
#define  UP_DL_USER_REGION_DL_DBG_MODE                                  (0x4810U)
#define  UP_DL_USER_REGION_DL_DBG_STATUS                                (0x4814U)
#define  UP_DL_USER_REGION_DL_DBG_DL_RX_INFO_CTRL                       (0x4818U)
#define  UP_DL_USER_REGION_DL_DBG_OPTION_SUITE                          (0x481cU)
#define  UP_DL_USER_REGION_DL_DBG_ERROR_FLAGS                           (0x4840U)
#define  UP_DL_USER_REGION_DL_DBG_ERROR_IRQ_MASK                        (0x4844U)
#define  UP_DL_USER_REGION_DL_DBG_PA_INIT_RETRY_COUNT                   (0x4848U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_AFC_FRAME_COUNT                (0x4880U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_AFC_FRAME_COUNT                (0x4884U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_AFC_SEQ_NUM                    (0x4888U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_AFC_SEQ_NUM                    (0x488cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_DATA_FRAME_COUNT               (0x4890U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_DATA_FRAME_COUNT               (0x4894U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_DATA_SEQ_NUM                   (0x4898U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_DATA_SEQ_NUM                   (0x489cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_DATA_SEQ_NUM_READY             (0x48a0U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_DATA_SEQ_NUM_ACKED             (0x48a4U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_REPLAYED_DATA_FRAME_COUNT      (0x48a8U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_REPLAYED_DATA_SEQ_NUM          (0x48acU)
#define  UP_DL_USER_REGION_DL_DBG_TC1_TX_AFC_FRAME_COUNT                (0x4900U)
#define  UP_DL_USER_REGION_DL_DBG_TC1_RX_AFC_FRAME_COUNT                (0x4904U)
#define  UP_DL_USER_REGION_DL_DBG_TC1_TX_AFC_SEQ_NUM                    (0x4908U)
#define  UP_DL_USER_REGION_DL_DBG_TC1_RX_AFC_SEQ_NUM                    (0x490cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_CREDIT_R_BYTE                     (0x4c00U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_CREDIT_U_BYTE                     (0x4c04U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_CREDIT_A_BYTE                     (0x4c08U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_CREDIT_S_BYTE                     (0x4c0cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFF_INFO_ADDR                 (0x4c10U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFF_INFO_DATA                 (0x4c14U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_CURR_PLD_WPTR           (0x4c40U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_CURR_PLD_RPTR_BASE      (0x4c44U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_PLD_WPTR                (0x4c48U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_PLD_RPTR_BASE           (0x4c4cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_CURR_WSEQ_NUM           (0x4c50U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_CURR_RSEQ_NUM           (0x4c54U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_CURR_RSEQ_NUM_TO_REPLAY (0x4c58U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_WSEQ_NUM                (0x4c5cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_RSEQ_NUM                (0x4c60U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_RSEQ_NUM_TO_REPLAY      (0x4c64U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_TX_BUFFER_SEQ_NUM_FORCE           (0x4c68U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_CURR_RPTR               (0x4c80U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_CURR_WPTR               (0x4c84U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_CURR_WPTR_CONFIRMED     (0x4c88U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_RPTR                    (0x4c8cU)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_RPTR_FORCE              (0x4c90U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_WPTR                    (0x4c94U)
#define  UP_DL_USER_REGION_DL_DBG_TC0_RX_BUFFER_WPTR_HOLD               (0x4c98U)
#endif
...
//----------------------------------------------------------------------------------------------------------------------------
#define  CONV_UTMRLBA_LOW_VAL                                            0x7D303800U //UTP Task Management Request List Base Address 
#define  CONV_UTMRLBA_HIGH_VAL                                           0x00000000U //UTP Transfer Request List Base Address
...
#define  CONV_UCDBA_LOW_VAL                                              0x7D300800U //UTP  Command  Descriptor  Base  Address
#define  CONV_UCDBAU_HIGH_VAL                                            0x00000000U
#define  UCDBA_LOW_VAL                                                   0x1D300800U
#define  UCDBAU_HIGH_VAL                                                 0x00000000U
#define  CONV_DBA_LOW_VAL                                                0x7D301000U //Data  Base  Address
...
#define  UCD_OFFSET                                                      0x00000000U //UTP Command Descriptor 
#define  PRDT_OFFSET                                                     0x00000200U //Physical Region Description Table
...
#define  DBA_IRAM_LOW_VAL                                                0x1D020000U // IRAM Base Address
#define  DBAU_IRAM_HIGH_VAL                                              0x00000000U
#define  CONV_DBA_IRAM_LOW_VAL                                           0x7D020000U //  RAM Base Address +0x6000_0000 (remapped)
