...
int vmgr_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	if (atomic_read(&vmgr_data.dev_opened) != 0) {
		pr_info(
		"\n vpu: suspend In DEC(%d/%d/%d/%d/%d), ENC(%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d)\n",
		...
		vmgr_get_close(VPU_ENC_EXT7), vmgr_get_close(VPU_ENC_EXT8),
		vmgr_get_close(VPU_ENC_EXT9), vmgr_get_close(VPU_ENC_EXT10),
		vmgr_get_close(VPU_ENC_EXT11), vmgr_get_close(VPU_ENC_EXT2),
		vmgr_get_close(VPU_ENC_EXT13), vmgr_get_close(VPU_ENC_EXT4),
		vmgr_get_close(VPU_ENC_EXT15));
		...
		pr_info(
		"vpu: suspend Out DEC(%d/%d/%d/%d/%d), ENC(%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d)\n\n",
		vmgr_get_close(VPU_DEC), vmgr_get_close(VPU_DEC_EXT),
		vmgr_get_close(VPU_DEC_EXT2), vmgr_get_close(VPU_DEC_EXT3),
		vmgr_get_close(VPU_DEC_EXT4), vmgr_get_close(VPU_ENC),
		vmgr_get_close(VPU_ENC_EXT), vmgr_get_close(VPU_ENC_EXT2),
		...
		vmgr_get_close(VPU_ENC_EXT7), vmgr_get_close(VPU_ENC_EXT8),
		vmgr_get_close(VPU_ENC_EXT9), vmgr_get_close(VPU_ENC_EXT10),
		vmgr_get_close(VPU_ENC_EXT11), vmgr_get_close(VPU_ENC_EXT12),
		vmgr_get_close(VPU_ENC_EXT13), vmgr_get_close(VPU_ENC_EXT14),
		vmgr_get_close(VPU_ENC_EXT15));
	}
