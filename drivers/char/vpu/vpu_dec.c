...
static int _vdec_proc_init(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsJpuDecInit_Info, arg, sizeof(JDEC_INIT_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecInit_Info, arg, sizeof(VPU_4K_D2_INIT_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecInit_Info, arg, sizeof(HEVC_INIT_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecInit_Info, arg, sizeof(VP9_INIT_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecInit_Info, arg, sizeof(VDEC_INIT_t));
			}
			else
			{
...
static int _vdec_proc_exit(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsJpuDecInOut_Info, arg, sizeof(JPU_DECODE_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecInOut_Info, arg, sizeof(VPU_4K_D2_DECODE_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecInOut_Info, arg, sizeof(HEVC_DECODE_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecInOut_Info, arg, sizeof(VP9_DECODE_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecInOut_Info, arg, sizeof(VDEC_DECODE_t));
			}
			else
			{
...
static int _vdec_proc_reg_framebuffer(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsJpuDecBuffer_Info, arg, sizeof(JPU_SET_BUFFER_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecBuffer_Info, arg, sizeof(VPU_4K_D2_SET_BUFFER_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecBuffer_Info, arg, sizeof(HEVC_SET_BUFFER_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecBuffer_Info, arg, sizeof(VP9_SET_BUFFER_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecBuffer_Info, arg, sizeof(VDEC_SET_BUFFER_t));
			}
			else
			{
...
static int _vdec_proc_clear_bufferflag(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	if (fromKernel)
	{
		(void)memcpy(&vdata->gsDecClearBuffer_index, arg, sizeof(unsigned int));
	}
	else
	{
...
static int _vdec_result_init(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsJpuDecInit_Info, sizeof(JDEC_INIT_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecInit_Info, sizeof(VPU_4K_D2_INIT_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecInit_Info, sizeof(HEVC_INIT_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVp9DecInit_Info, sizeof(VP9_INIT_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecInit_Info, sizeof(VDEC_INIT_t));
			}
			else
			{
...
static int _vdec_result_decode(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsJpuDecInOut_Info, sizeof(JPU_DECODE_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecInOut_Info, sizeof(VPU_4K_D2_DECODE_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecInOut_Info, sizeof(HEVC_DECODE_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVp9DecInOut_Info, sizeof(VP9_DECODE_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecInOut_Info, sizeof(VDEC_DECODE_t));
			}
			else
			{
...
static int _vdec_proc_buf_status(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecBufStatus, arg, sizeof(VPU_4K_D2_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecBufStatus, arg, sizeof(HEVC_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecBufStatus, arg, sizeof(VP9_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecBufStatus, arg, sizeof(VDEC_RINGBUF_GETINFO_t));
			}
			else
			{
...
static int _vdec_proc_buf_fill(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecBufFill, arg, sizeof(VPU_4K_D2_RINGBUF_SETBUF_t));
			}
			else
			{
		...
		case STD_HEVC:
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecBufFill, arg, sizeof(HEVC_RINGBUF_SETBUF_t));
			}
			else
			{
		...
		default:
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecBufFill, arg, sizeof(VDEC_RINGBUF_SETBUF_t));
			}
			else
			{
...
static int _vdec_proc_update_wp(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecUpdateWP, arg, sizeof(VPU_4K_D2_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecUpdateWP, arg, sizeof(HEVC_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecUpdateWP, arg, sizeof(VP9_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecUpdateWP, arg, sizeof(VDEC_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
...
static int _vdec_proc_get_version(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	...
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsJpuDecVersion, arg, sizeof(JPU_GET_VERSION_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsV4kd2DecVersion, arg, sizeof(VPU_4K_D2_GET_VERSION_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsHevcDecVersion, arg, sizeof(HEVC_GET_VERSION_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVp9DecVersion, arg, sizeof(VP9_GET_VERSION_t));
			}
			else
			{
		...
		default:
		{
			if (fromKernel)
			{
				(void)memcpy(&vdata->gsVpuDecVersion, arg, sizeof(VDEC_GET_VERSION_t));
			}
			else
			{
...
static int _vdec_result_buf_status(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecBufStatus, sizeof(VPU_4K_D2_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecBufStatus, sizeof(HEVC_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVp9DecBufStatus, sizeof(VP9_RINGBUF_GETINFO_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecBufStatus, sizeof(VDEC_RINGBUF_GETINFO_t));
			}
			else
			{
...
static int _vdec_result_buf_fill(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecBufFill, sizeof(VPU_4K_D2_RINGBUF_SETBUF_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecBufFill, sizeof(HEVC_RINGBUF_SETBUF_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecBufFill, sizeof(VDEC_RINGBUF_SETBUF_t));
			}
			else
			{
...
static int _vdec_result_update_wp(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecUpdateWP, sizeof(VPU_4K_D2_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecUpdateWP, sizeof(HEVC_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVp9DecUpdateWP, sizeof(VP9_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecUpdateWP, sizeof(VDEC_RINGBUF_SETBUF_PTRONLY_t));
			}
			else
			{
...
static int _vdec_result_get_version(vpu_decoder_data* vdata, void* arg, bool fromKernel)
{
	switch (vdata->gsCodecType)
	{
		...
		case STD_MJPG:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsJpuDecVersion, sizeof(JPU_GET_VERSION_t));
			}
			else
			{
		...
		case STD_HEVC: case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsV4kd2DecVersion, sizeof(VPU_4K_D2_GET_VERSION_t));
			}
			else
			{
		...
		case STD_HEVC:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsHevcDecVersion, sizeof(HEVC_GET_VERSION_t));
			}
			else
			{
		...
		case STD_VP9:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVp9DecVersion, sizeof(VP9_GET_VERSION_t));
			}
			else
			{
		...
		default:
		{
			...
			if (fromKernel)
			{
				(void)memcpy(arg, &vdata->gsVpuDecVersion, sizeof(VDEC_GET_VERSION_t));
			}
			else
			{
...
long vdec_ioctl(struct file* filp, unsigned int cmd, unsigned long arg)
{
	...
	switch (cmd)
	{
		...
		case V_DEC_ALLOC_MEMORY_KERNEL:
		{
			...
			{
				(void)memcpy(&alloc_info, (MEM_ALLOC_INFO_t*)arg, sizeof(MEM_ALLOC_INFO_t));
			}
			else
			{
			...
			if (cmd == V_DEC_ALLOC_MEMORY_KERNEL)
			{
				(void)memcpy((MEM_ALLOC_INFO_t*)arg, &alloc_info, sizeof(MEM_ALLOC_INFO_t));
			}
			else
			{
		...
		case VPU_GET_FREEMEM_SIZE_KERNEL:
		{
			...
			{
				(void)memcpy((unsigned int*)arg, &szFreeMem, sizeof(szFreeMem));
			}
			else
			{
