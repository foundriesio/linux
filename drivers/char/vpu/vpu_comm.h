 ...
 */
#define DEFINED_CONFIG_VENC_CNT_16 defined(CONFIG_VENC_CNT_16)

#define DEFINED_CONFIG_VENC_CNT_15to16 \
	(defined(CONFIG_VENC_CNT_15) || DEFINED_CONFIG_VENC_CNT_16)

#define DEFINED_CONFIG_VENC_CNT_14to16 \
	(defined(CONFIG_VENC_CNT_14) || DEFINED_CONFIG_VENC_CNT_15to16)

#define DEFINED_CONFIG_VENC_CNT_13to16 \
	(defined(CONFIG_VENC_CNT_13) || DEFINED_CONFIG_VENC_CNT_14to16)

#define DEFINED_CONFIG_VENC_CNT_12to16 \
	(defined(CONFIG_VENC_CNT_12) || DEFINED_CONFIG_VENC_CNT_13to16)

#define DEFINED_CONFIG_VENC_CNT_11to16 \
	(defined(CONFIG_VENC_CNT_11) || DEFINED_CONFIG_VENC_CNT_12to16)

#define DEFINED_CONFIG_VENC_CNT_10to16 \
	(defined(CONFIG_VENC_CNT_10) || DEFINED_CONFIG_VENC_CNT_11to16)

#define DEFINED_CONFIG_VENC_CNT_9to16 \
	(defined(CONFIG_VENC_CNT_9) || DEFINED_CONFIG_VENC_CNT_10to16)

#define DEFINED_CONFIG_VENC_CNT_8to16 \
	(defined(CONFIG_VENC_CNT_8) || DEFINED_CONFIG_VENC_CNT_9to16)

#define DEFINED_CONFIG_VENC_CNT_7to16 \
	(defined(CONFIG_VENC_CNT_7) || DEFINED_CONFIG_VENC_CNT_8to16)

#define DEFINED_CONFIG_VENC_CNT_6to16 \
	(defined(CONFIG_VENC_CNT_6) || DEFINED_CONFIG_VENC_CNT_7to16)

#define DEFINED_CONFIG_VENC_CNT_5to16 \
	(defined(CONFIG_VENC_CNT_5) || DEFINED_CONFIG_VENC_CNT_6to16)

#define DEFINED_CONFIG_VENC_CNT_4to16 \
	(defined(CONFIG_VENC_CNT_4) || DEFINED_CONFIG_VENC_CNT_5to16)

#define DEFINED_CONFIG_VENC_CNT_3to16 \
	(defined(CONFIG_VENC_CNT_3) || DEFINED_CONFIG_VENC_CNT_4to16)

#define DEFINED_CONFIG_VENC_CNT_2to16 \
	(defined(CONFIG_VENC_CNT_2) || DEFINED_CONFIG_VENC_CNT_3to16)

#define DEFINED_CONFIG_VENC_CNT_1to16 \
	(defined(CONFIG_VENC_CNT_1) || DEFINED_CONFIG_VENC_CNT_2to16)
