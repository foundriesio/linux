...
extern int vmgr_hevc_enc_get_close(vputype type);
extern int vmgr_hevc_enc_set_close(vputype type, int value, int bfreemem);
extern int vmgr_hevc_enc_get_alive(void);

////////////////////////////////////////////////////////////////////////////////////
extern int vmgr_hevc_enc_process_ex(VpuList_t *cmd_list, vputype type, int Op, int *result);
