...
enum vdbg_mask_type {
	...
	VPU_DBG_MEMORY            = (1<<9),
	VPU_DBG_MEM_SEQ           = (1<<10),
	VPU_DBG_MEM_USAGE         = (1<<11),
	VPU_DBG_CLOSE             = (1<<12),
	VPU_DBG_IO_FB_INFO        = (1<<13),
	VPU_DBG_REG_DUMP          = (1<<14),
	VPU_DBG_PERF              = (1<<15),
	VPU_DBG_CMD               = (1<<16),
	VPU_DBG_VER_INFO          = (1<<17),
	VPU_DBG_BUF_STATUS        = (1<<18),
	VPU_DBG_FB_CLR_STATE      = (1<<19),
	VPU_DBG_DEV_REGED         = (1<<20),
};
