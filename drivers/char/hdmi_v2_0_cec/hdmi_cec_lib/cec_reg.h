...
#define IO_IH_MASK                              0x10000000
#define IO_IH_OFFSET                            0x00000100

//CEC Interrupt Status Register (Functional Operation Interrupts)
#define IO_IH_CEC_STAT0                         0x10000018

//Interruption Handler Decode Assist Register
#define IO_IH_DECODE                            0x100001C0
...
#define IO_IH_MUTE_CEC_STAT0                    0x10000218

//Global Interrupt Mute Control Register
#define IH_MUTE                                 0x100003FC
