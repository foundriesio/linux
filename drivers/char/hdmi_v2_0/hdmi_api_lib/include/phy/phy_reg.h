...
//PHY Configuration Register This register holds the power down, data enable
//polarity, and interface control of the HDMI Source PHY control
...
//Reserved as "spare" bit with no associated functionality
...
//PHY RXSENSE, PLL Lock, and HPD Status Register This register contains the
//following active high packet sent status indications
...
//PHY RXSENSE, PLL Lock, and HPD Interrupt Register This register contains the
//interrupt indication of the PHY_STAT0 status interrupts
...
//PHY RXSENSE, PLL Lock, and HPD Mask Register Mask register for generation of
//PHY_INT0 interrupts
#define PHY_MASK0  0x0000C018
#define PHY_MASK0_TX_PHY_LOCK_MASK  0x00000001
//Mask bit for PHY_INT0
...
//Slave address to be sent during read and write operations

//PHY I2C Address Configuration Register This register writes the address for
...
//Data MSB (datao[15:8]) to be written on register pointed by
...
//Data LSB (datao[7:0]) to be written on register pointed by
//phy_i2cm_address [7:0]

//PHY I2C Data Read Register 1
#define PHY_I2CM_DATAI_1  0x0000C090
#define PHY_I2CM_DATAI_1_DATAI_MASK  0x000000FF
//Data MSB (datai[15:8]) read from register pointed by phy_i2cm_address[7:0]

//PHY I2C Data Read Register 0
#define PHY_I2CM_DATAI_0  0x0000C094
#define PHY_I2CM_DATAI_0_DATAI_MASK  0x000000FF
//Data LSB (datai[7:0]) read from register pointed by phy_i2cm_address[7:0]

//PHY I2C RD/RD_EXT/WR Operation Register This register requests read and
//write operations from the I2C Master PHY
...
//PHY I2C Done Interrupt Register This register contains and configures I2C
//master PHY done interrupt
...
//PHY I2C error Interrupt Register This register contains and configures the
//I2C master PHY error interrupts
...
//PHY I2C Speed control Register This register wets the I2C Master PHY to
//work in either Fast or Standard mode
...
//1: Fast Mode 0: Standard Mode

//PHY I2C SW reset control register This register sets the I2C Master
//PHY software reset
...
//Defines the number of SFR clock cycles to meet tHD:DAT (300 ns)
...
//Configures the JTAG PHY interface output pin JTAG_TRST_N when in internal
//control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_trst_n when PHY_EXTERNAL=1
#define JTAG_PHY_CONFIG_I2C_JTAGZ_MASK  0x00000010
//Configures the JTAG PHY interface output pin I2C_JTAGZ to select the PHY
//configuration interface when in internal control mode (iphy_ext_ctrl=1'b0)
...
//Configures the JTAG PHY interface pin JTAG_TCK when in internal control
//mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tck when PHY_EXTERNAL=1

//PHY JTAG TAP In Control Register
#define JTAG_PHY_TAP_IN  0x0000C0D8
#define JTAG_PHY_TAP_IN_JTAG_TDI_MASK  0x00000001
//Configures the JTAG PHY interface pin JTAG_TDI when in internal control
//mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tdi when PHY_EXTERNAL=1
#define JTAG_PHY_TAP_IN_JTAG_TMS_MASK  0x00000010
//Configures the JTAG PHY interface pin JTAG_TMS when in internal control
//mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tms when PHY_EXTERNAL=1

//PHY JTAG TAP Out Control Register
#define JTAG_PHY_TAP_OUT  0x0000C0DC
#define JTAG_PHY_TAP_OUT_JTAG_TDO_MASK  0x00000001
//Read JTAG PHY interface input pin JTAG_TDO when in internal control
//mode (iphy_ext_ctrl=1'b0) or iphyext_jtag_tdo when PHY_EXTERNAL=1
#define JTAG_PHY_TAP_OUT_JTAG_TDO_EN_MASK  0x00000010
//Read JTAG PHY interface input pin JTAG_TDO_EN when in internal control
//mode (iphy_ext_ctrl=1'b0) or iphyext_jtag_tdo_en when PHY_EXTERNAL=1

//PHY JTAG Address Control Register
#define JTAG_PHY_ADDR  0x0000C0E0
#define JTAG_PHY_ADDR_JTAG_ADDR_MASK  0x000000FF
//Configures the JTAG PHY interface pin JTAG_ADDR[7:0] when in internal
//control mode (iphy_ext_ctrl=1'b0) or iphyext_jtag_addr[7:0] when
//PHY_EXTERNAL=1

#endif /* SRC_PHY_PHY_REG_H_ */
