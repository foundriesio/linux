...
int tcc_hdmi_phy_config(
	struct hdmi_tx_dev *dev,
	unsigned int pixel_clock, unsigned int tmds_clock,
	color_depth_t color_depth, int scdc_present, int enable_scramble);
...
ssize_t tcc_hdmi_proc_read_phy_regs(
