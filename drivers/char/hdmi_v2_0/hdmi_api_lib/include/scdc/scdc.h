...
#define SCDC_UPDATE_RESERVED 0x12
/* 0x12-0x1f - Reserved for Update Related Uses   */
...
#define SCDC_CONFIG_RESERVED 0x31
/* 0x31-0x3f - Reserved for configuration         */

#define SCDC_STATUS_FLAG_0 0x40	/* Status_Flag_0 */
#define SCDC_STATUS_FLAG_1 0x41	/* Status_Flag_1 */
#define SCDC_STATUS_RESERVED 0x42
/* 0x42-0x4f - Reserved for Status Related Uses   */
...
int scdc_set_tmds_bit_clock_ratio_and_scrambling(
	struct hdmi_tx_dev *dev, int tmds_enable, int scramble_enable);
...
int scdc_error_detection_core(
	struct hdmi_tx_dev *dev,
	struct hdmi_scdc_error_data *hdmi_scdc_error_data, int stage);
int scdc_error_detection(
	struct hdmi_tx_dev *dev,
