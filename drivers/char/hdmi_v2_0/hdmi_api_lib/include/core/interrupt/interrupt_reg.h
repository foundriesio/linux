...
//Active after successful transmission of an Audio Clock Regeneration
...
//Active after successful transmission of an NTSC VBI packet
#define IH_FC_STAT0_MAS_MASK  0x00000010
//Active after successful transmission of an MultiStream Audio packet
...
//Active after successful transmission of an Audio Metadata packet
#define IH_FC_STAT1_SPD_MASK  0x00000008
//Active after successful transmission of an Source Product Descriptor
//InfoFrame packet
#define IH_FC_STAT1_VSD_MASK  0x00000010
//Active after successful transmission of an Vendor Specific Data
//InfoFrame packet
...
#define IH_FC_STAT2_DRM_MASK	0x00000010
//Active after successful

//Audio Sampler Interrupt Status Register
//(FIFO Threshold, Underflow and Overflow Interrupts)
...
//Audio Sampler audio FIFO empty threshold (four samples) indication for the
//legacy HBR audio interface
...
//Interruption active at the ih_ahbdmaaud_stat0 register
#define IH_DECODE_IH_CEC_STAT0_MASK  0x00000002
//Interruption active at the ih_cec_stat0 register
#define IH_DECODE_IH_I2CM_STAT0_MASK  0x00000004
//Interruption active at the ih_i2cm_stat0 register
#define IH_DECODE_IH_PHY_MASK  0x00000008
//Interruption active at the ih_phy_stat0 or ih_i2cmphy_stat0 register
#define IH_DECODE_IH_AS_STAT0_MASK  0x00000010
//Interruption active at the ih_as_stat0 register
#define IH_DECODE_IH_FC_STAT2_VP_MASK  0x00000020
//Interruption active at the ih_fc_stat2 or ih_vp_stat0 register
#define IH_DECODE_IH_FC_STAT1_MASK  0x00000040
//Interruption active at the ih_fc_stat1 register
...
//When set to 1, mutes ih_fc_stat2[0]
#define IH_MUTE_FC_STAT2_LOWPRIORITY_OVERFLOW_MASK  0x00000002
//When set to 1, mutes ih_fc_stat2[1]
#define IH_MUTE_FC_STAT2_DRM_MASK  0x00000010
//When set to 1, mutes ih_fc_stat2[4]
...
//When set to 1, mutes ih_i2cmphy_stat0[0]
#define IH_MUTE_I2CMPHY_STAT0_I2CMPHYDONE_MASK  0x00000002
//When set to 1, mutes ih_i2cmphy_stat0[1]
...
//en set to 1, mutes ih_ahbdmaaud_stat0[1]
