 ...
 */
#ifndef __SRC_BSP_EDDC_REG_H__
#define __SRC_BSP_EDDC_REG_H__
...
//After writing 1'b1 to rd_ext bit a extended data read operation is started
//(E-DDC read operation)
...
//Read request interruption mask signal

//I2C DDC error Interrupt Register This register configures the I2C master
//arbitration lost and not acknowledge error interrupts
...
//relation between master and scl clock
#define I2CM_DIV  0x0001F81C
#define I2CM_DIV_SPARE_MASK  0x00000007
//This bit is a spare register with no associated functionality
...
//I2C DDC Segment Address Configuration Register This register configures the
//segment address for extended R/W destination and is used for EDID reading
...
//I2C DDC Segment Pointer Register This register configures the segment pointer
//for extended RD/WR request
...
//SCDC Control Register This register configures the SCDC update status read
//through the I2C master interface
#define I2CM_SCDC_READ_UPDATE  0x0001F850
#define I2CM_SCDC_READ_UPDATE_READ_UPDATE_MASK  0x00000001
//When set to 1'b1, a SCDC Update Read is performed and the read data loaded
//into registers i2cm_scdc_update0 and i2cm_scdc_update1
...
//Byte 0 of a I2C read buffer sequential read (from address i2cm_address)
...
//Byte 1 of a I2C read buffer sequential read (from address i2cm_address+1)
...
//Byte 2 of a I2C read buffer sequential read (from address i2cm_address+2)
...
//Byte 3 of a I2C read buffer sequential read (from address i2cm_address+3)
...
//Byte 4 of a I2C read buffer sequential read (from address i2cm_address+4)
...
//Byte 5 of a I2C read buffer sequential read (from address i2cm_address+5)
...
//Byte 6 of a I2C read buffer sequential read (from address i2cm_address+6)
...
//Byte 7 of a I2C read buffer sequential read (from address i2cm_address+7)
...
//Byte 0 of a SCDC I2C update sequential read
...
//Byte 1 of a SCDC I2C update sequential read

#endif /* __SRC_BSP_EDDC_REG_H__ */
