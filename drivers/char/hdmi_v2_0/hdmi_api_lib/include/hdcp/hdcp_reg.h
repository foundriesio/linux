...
#define A_APIINTSTAT_KSVSHA1CALCDONEINT_MASK  0x00000020 //Notifies that the HDCP13TCTRL core SHA1 verification has been done.
...
#define HDCPREG_AN7_HDCPREG_AN7_MASK  0x000000FF //Contains the value of AN[63:56]


//HDCP 2.2 Identification Register
#define HDCP22REG_ID 0x0001E400
#define HDCP22REG_ID_HDCP22_EXTERNALIF_MASK  0x00000002 //Indicates that External HDCP 2.2 interface is present
#define HDCP22REG_ID_HDCP22_3RDPARTY_MASK  0x00000004 //Indicates that External HDCP 2.2 interface is present and 3rd party HDCP 2.2 module is connected to this interface

// HDCP 2.2 Control Register
#define HDCP22REG_CTRL 0x0001E410
#define HDCP22REG_CTRL_HDCP22_SWITCH_LCK_MASK  0x00000001 //HDCP 2.2 switch lock
#define HDCP22REG_CTRL_HDCP22_OVR_EN_MASK  0x00000002 //HDCP 2.2 versus 1.4 switch override enable
#define HDCP22REG_CTRL_HDCP22_OVR_VAL_MASK  0x00000004 //HDCP 2.2 versus 1.4 switch override value
#define HDCP22REG_CTRL_HPD_OVR_EN_MASK  0x00000010 //HPD Override enable
#define HDCP22REG_CTRL_HPD_OVR_VAL_MASK  0x00000020 //HPD Override Value

//HDCP 2.2 Control Register 1
#define HDCP22REG_CTRL1 0x0001E414
#define HDCP22REG_CTRL1_HDCP22_AVMUTE_OVR_EN_MASK 0x00000001 //HDCP 2.2 versus 1.4 avmute override enable
#define HDCP22REG_CTRL1_HDCP22_AVMUTE_OVR_VAL_MASK 0x00000002 //HDCP AV_MUTE override value, which is sent through the HDCP 2.2 external interface when hdcp22reg_ctrl1.hdcp22_avmute_ovr_en is set.
#define HDCP22REG_CTRL1_HDCP22_CD_OVR_EN_MASK 0x00000008 //HDCP 2.2 versus 1.4 color depth override enable:
#define HDCP22REG_CTRL1_HDCP22_CD_OVR_VAL_MASK 0x000000F0 //HDCP color depth override value, which is sent through the HDCP 2.2 external interface when hdcp22reg_ctrl1.hdcp22_cd_ovr_en is set

// HDCP 2.2 Status Register
#define HDCP22REG_STS 0x0001E420
#define HDCP22REG_STS_HDMI_HPD_STS_MASK 0x00000001 //HDCP 2.2 HPD external interface status after lock mechanism
#define HDCP22REG_STS_HDCP_AVMUTE_STS_MASK 0x00000002 //HDCP 2.2 AVMUTE external interface status
#define HDCP22REG_STS_HDCP22_SWITCH_STS_MASK 0x00000004 //HDCP 2.2 HDCP 2.2 versus 1.4 switch status after lock mechanism
#define HDCP22REG_STS_HDCP_DECRYPTED_STS_MASK 0x00000008 //Value of HDCP 2.2 ist_hdcp_decrypted line. Provided for debug only

// HDCP 2.2 Interrupt Mask Register
#define HDCP22REG_MASK 0x0001E430
#define HDCP22REG_MASK_HDCP2_CAPABLE_MASK 0x00000001 //Active high interrupt mask to HDCP 2.2 capable rise interrupt status
#define HDCP22REG_MASK_HDCP2_NOT_CAPABLE_MASK 0x00000002 //Active high interrupt mask to HDCP 2.2 not capable rise interrupt status
#define HDCP22REG_MASK_HDCP_AUTHENTICATION_LOST_MASK 0x00000004 //Active high interrupt mask to HDCP 2.2 authentication lost interrupt status
#define HDCP22REG_MASK_HDCP_AUTHENTICATED_MASK 0x00000008 //Active high interrupt mask to HDCP 2.2 authenticated interrupt status
#define HDCP22REG_MASK_HDCP_AUTHENTICATION_FAIL_MASK 0x00000010 //Active high interrupt mask to HDCP 2.2 authentication fail interrupt status
#define HDCP22REG_MASK_HDCP_DECRYPTED_CHG_MASK 0x00000020 //Active high interrupt mask to HDCP 2.2 decrypted value change interrupt status

// HDCP 2.2 interrupt Sticky Bit Status Register
#define HDCP22REG_STAT 0x0001E434
#define HDCP22REG_STAT_ST_HDCP2_CAPABLE_MASK 0x00000001 //HDCP 2.2 capable rise interrupt status sticky bit. Clear by Write 1 to this bit field
#define HDCP22REG_STAT_ST_HDCP2_NOT_CAPABLE_MASK 0x00000002 //HDCP 2.2 not capable rise interrupt status sticky bit. Clear by Write 1 to this bit field
#define HDCP22REG_STAT_ST_HDCP_AUTHENTICATION_LOST_MASK 0x00000004 //HDCP 2.2 authentication lost interrupt status sticky bit. Clear by Write 1 to this bit field
#define HDCP22REG_STAT_ST_HDCP_AUTHENTICATED_MASK 0x00000008 //HDCP 2.2 authenticated interrupt status sticky bit. Clear by Write 1 to this bit field
#define HDCP22REG_STAT_ST_HDCP_AUTHENTICATION_FAIL_MASK 0x00000010 //HDCP 2.2 authentication fail interrupt status sticky bit. Clear by Write 1 to this bit field
#define HDCP22REG_STAT_ST_HDCP_DECRYPTED_CHG_MASK 0x00000020 //HDCP 2.2 decrypted value change interrupt status sticky bit. Clear by Write 1 to this bit field

// HDCP 2.2 Interrupt Mute Vector
#define HDCP22REG_MUTE 0x0001E438
#define HDCP22REG_MUTE_HDCP2_CAPABLE_MASK 0x00000001 //Active high interrupt mute to HDCP 2.2 capable rise interrupt status
#define HDCP22REG_MUTE_HDCP2_NOT_CAPABLE_MASK 0x00000002 //Active high interrupt mute to HDCP 2.2 not capable rise interrupt status
#define HDCP22REG_MUTE_HDCP_AUTHENTICATION_LOST_MASK 0x00000004 //Active high interrupt mute to HDCP 2.2 authentication lost interrupt status
#define HDCP22REG_MUTE_HDCP_AUTHENTICATED_MASK 0x00000008 //Active high interrupt mute to HDCP 2.2 authenticated interrupt status
#define HDCP22REG_MUTE_HDCP_AUTHENTICATION_FAIL_MASK 0x00000010 //Active high interrupt mute to HDCP 2.2 authentication fail interrupt status
#define HDCP22REG_MUTE_HDCP_DECRYPTED_CHG_MASK 0x00000020 //Active high interrupt mute to HDCP 2.2 decrypted value change interrupt status
