...
//When set, the new N and CTS values are only used when aud_n1 register is
//written
...
//Audio Clock Regenerator CTS Register 2 For CTS expected values, refer to
//the HDMI 1
...
//If the CTS_manual bit equals 0b, this registers contains audCTS[19:0]
//generated by the Cycle time counter according to the specified timing
#define AUD_CTS3_N_SHIFT_MASK  0x000000E0
//N_shift factor configuration: N_shift | Shift Factor | Action 0 | 1 |
...
//Fs factor configuration: ifsfactor[2:0] | Audio Clock | Action 0 | 128xFs |
//If you select the Bypass SPDIF DRU unit in coreConsultant, the input
//audio clock (either I2S or SPDIF according to configuration) is used at the
//audio packetizer to calculate the CTS value and ACR packet insertion rate
