...
//Audio I2S Software FIFO Reset, Select, and Enable Control Register 0 This
//register configures the I2S input enable that indicates which input I2S
//channels have valid data
#define AUD_CONF0  0x0000C400
#define AUD_CONF0_I2S_IN_EN_MASK  0x0000000F
//Action I2S_in_en[0] - I2Sdata[0] enable I2S_in_en[1] - I2Sdata[1] enable
//I2S_in_en[2] - I2Sdata[2] enable I2S_in_en[3] - I2Sdata[3] enable
...
//1b: Selects I2S Audio Interface 0b: Selects the second (SPDIF/GPA)
//interface, in configurations with more that one audio interface
//(DOUBLE/GDOUBLE)
#define AUD_CONF0_SPARE_2_MASK  0x00000040
//This field is a "spare" bit with no associated functionality
#define AUD_CONF0_SW_AUDIO_FIFO_RST_MASK  0x00000080
//Audio FIFOs software reset - Writing 0b: no action taken - Writing
//1b: Resets all audio FIFOs Reading from this register always returns 0b

//Audio I2S Width and Mode Configuration Register 1 This register configures
//the I2S mode and data width of the input data
#define AUD_CONF1  0x0000C404
#define AUD_CONF1_I2S_WIDTH_MASK  0x0000001F
//I2S input data width I2S_width[4:0] | Action
...
//Audio I2S NLPCM and HBR configuration Register 2 This register configures
//the I2S Audio Data mapping
#define AUD_CONF2  0x0000C40C
#define AUD_CONF2_HBR_MASK  0x00000001
//I2S HBR Mode Enable
#define AUD_CONF2_NLPCM_MASK  0x00000002
//I2S NLPCM Mode Enable
#define AUD_CONF2_INSERT_PCUV  0x00000004
//I2S Insert PCUV

//I2S Mask Interrupt Register This register masks the interrupts present in
//the I2S module
