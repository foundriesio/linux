...
static void halVideoSampler_InternalDataEnableGenerator(
	struct hdmi_tx_dev *dev, u8 bit)
{
	LOG_TRACE1(bit);
...
static void halVideoSampler_VideoMapping(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(dev,
		 TX_INVID0, TX_INVID0_VIDEO_MAPPING_MASK, value);
}
...
static void halVideoSampler_StuffingGy(struct hdmi_tx_dev *dev, u16 value)
{
	...
	hdmi_dev_write_mask(dev,
		 TX_INSTUFFING, TX_INSTUFFING_GYDATA_STUFFING_MASK, 1);
}
...
static void halVideoSampler_StuffingRcr(struct hdmi_tx_dev *dev, u16 value)
{
	...
	hdmi_dev_write_mask(dev,
		 TX_INSTUFFING, TX_INSTUFFING_RCRDATA_STUFFING_MASK, 1);
}
...
static void halVideoSampler_StuffingBcb(struct hdmi_tx_dev *dev, u16 value)
{
	...
	hdmi_dev_write_mask(dev,
		 TX_INSTUFFING, TX_INSTUFFING_BCBDATA_STUFFING_MASK, 1);
}
