...
//Chroma decimation configuration: decmode[1:0] | Chroma Decimation
//00 | decimation disabled
//01 | Hd (z) =1 10 | Hd(z)=1/ 4 + 1/2z^(-1 )+1/4 z^(-2)
//11 | Hd(z)x2^(11)= -5+12z^(-2) - 22z^(-4)+39z^(-8) +109z^(-10)
//-204z^(-12)+648z^(-14) + 1024z^(-15) +648z^(-16) -204z^(-18)
//+109z^(-20)- 65z^(-22) +39z^(-24) -22z^(-26) +12z^(-28)-5z^(-30)
#define CSC_CFG_SPARE_1_MASK  0x0000000C
//This is a spare register with no associated functionality
#define CSC_CFG_INTMODE_MASK  0x00000030
//Chroma interpolation configuration: intmode[1:0] | Chroma Interpolation
//00 | interpolation disabled 01 | Hu (z) =1 + z^(-1)
//10 | Hu(z)=1/ 2 + z^(-11)+1/2 z^(-2) 11 | interpolation disabled
#define CSC_CFG_SPARE_2_MASK  0x00000040
//This is a spare register with no associated functionality
#define CSC_CFG_CSC_LIMIT_MASK  0x00000080
//When set (1'b1), the range limitation values defined in registers
//csc_mat_uplim and csc_mat_dnlim are applied to the output of the Color
...
//Defines the cscscale[1:0] scale factor to apply to all coefficients in
//Color Space
//Conversion
#define CSC_SCALE_SPARE_MASK  0x0000000C
//The is a spare register with no associated functionality
#define CSC_SCALE_CSC_COLOR_DEPTH_MASK  0x000000F0
//Color space converter color depth configuration:
//csc_colordepth[3:0] | Action 0000 | 24 bit per
//pixel video (8 bit per component)

//Color Space Converter Matrix A1 Coefficient Register MSB
//Notes: - The coefficients used in the CSC matrix use only 15 bits for
//the internal computations
#define CSC_COEF_A1_MSB  0x00010408
#define CSC_COEF_A1_MSB_CSC_COEF_A1_MSB_MASK  0x000000FF
//Color Space Converter Matrix A1 Coefficient Register MSB

//Color Space Converter Matrix A1 Coefficient Register LSB
//Notes: - The coefficients used in the CSC matrix use only 15 bits for
//the internal computations
...
//Color Space Converter Matrix A2 Coefficient Register MSB
...
//Color Space Converter Matrix A2 Coefficient Register LSB
...
//Color Space Converter Matrix A3 Coefficient Register MSB
...
//Color Space Converter Matrix A3 Coefficient Register LSB
...
//Color Space Converter Matrix A4 Coefficient Register MSB
...
//Color Space Converter Matrix A4 Coefficient Register LSB
...
//Color Space Converter Matrix B1 Coefficient Register MSB
...
//Color Space Converter Matrix B1 Coefficient Register LSB
...
//Color Space Converter Matrix B2 Coefficient Register MSB
...
//Color Space Converter Matrix B2 Coefficient Register LSB
...
//Color Space Converter Matrix B3 Coefficient Register MSB
...
//Color Space Converter Matrix B3 Coefficient Register LSB
...
//Color Space Converter Matrix B4 Coefficient Register MSB
...
//Color Space Converter Matrix B4 Coefficient Register LSB
...
//Color Space Converter Matrix C1 Coefficient Register MSB
...
//Color Space Converter Matrix C1 Coefficient Register LSB
...
//Color Space Converter Matrix C2 Coefficient Register MSB
...
//Color Space Converter Matrix C2 Coefficient Register LSB
...
//Color Space Converter Matrix C3 Coefficient Register MSB
...
//Color Space Converter Matrix C3 Coefficient Register LSB
...
//Color Space Converter Matrix C4 Coefficient Register MSB
...
//Color Space Converter Matrix C4 Coefficient Register LSB

//Color Space Converter Matrix Output Up Limit Register MSB For more
//details, refer to the HDMI 1
#define CSC_LIMIT_UP_MSB  0x00010468
#define CSC_LIMIT_UP_MSB_CSC_LIMIT_UP_MSB_MASK  0x000000FF
//Color Space Converter Matrix Output Upper Limit Register MSB

//Color Space Converter Matrix output Up Limit Register LSB For more
//details, refer to the HDMI 1
#define CSC_LIMIT_UP_LSB  0x0001046C
#define CSC_LIMIT_UP_LSB_CSC_LIMIT_UP_LSB_MASK  0x000000FF
//Color Space Converter Matrix Output Upper Limit Register LSB

//Color Space Converter Matrix output Down Limit Register MSB For more
//details, refer to the HDMI 1
...
//Color Space Converter Matrix output Down Limit Register LSB For more
//details, refer to the HDMI 1
