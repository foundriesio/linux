...
void fc_packet_sample_flat(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCONF, FC_AUDSCONF_AUD_PACKET_SAMPFLT_MASK, value);
}
...
void fc_packet_layout(struct hdmi_tx_dev *dev, u8 bit)
{
	LOG_TRACE1(bit);
	hdmi_dev_write_mask(
		dev, FC_AUDSCONF, FC_AUDSCONF_AUD_PACKET_LAYOUT_MASK, bit);
}

void fc_validity_right(struct hdmi_tx_dev *dev, u8 bit, unsigned int channel)
{
...
void fc_validity_left(struct hdmi_tx_dev *dev, u8 bit, unsigned int channel)
{
	LOG_TRACE2(bit, channel);
	if (channel < 4)
...
void fc_user_right(struct hdmi_tx_dev *dev, u8 bit, unsigned int channel)
{
	LOG_TRACE2(bit, channel);
	if (channel < 4)
...
void fc_user_left(struct hdmi_tx_dev *dev, u8 bit, unsigned int channel)
{
	LOG_TRACE2(bit, channel);
	if (channel < 4)
...
void fc_iec_cgmsA(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL0, FC_AUDSCHNL0_OIEC_CGMSA_MASK, value);
}
...
void fc_iec_copyright(struct hdmi_tx_dev *dev, u8 bit)
{
	LOG_TRACE1(bit);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL0, FC_AUDSCHNL0_OIEC_COPYRIGHT_MASK, bit);
}
...
void fc_iec_pcm_mode(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL2, FC_AUDSCHNL2_OIEC_PCMAUDIOMODE_MASK, value);
}
...
void fc_iec_source(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL2, FC_AUDSCHNL2_OIEC_SOURCENUMBER_MASK, value);
}

void fc_iec_channel_right(
	struct hdmi_tx_dev *dev, u8 value, unsigned int channel)
{
...
void fc_iec_clock_accuracy(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL7, FC_AUDSCHNL7_OIEC_CLKACCURACY_MASK, value);
}
...
void fc_iec_sampling_freq(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL7, FC_AUDSCHNL7_OIEC_SAMPFREQ_MASK, value);
}
...
void fc_iec_original_sampling_freq(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL8, FC_AUDSCHNL8_OIEC_ORIGSAMPFREQ_MASK, value);
}
...
void fc_iec_word_length(struct hdmi_tx_dev *dev, u8 value)
{
	LOG_TRACE1(value);
	hdmi_dev_write_mask(
		dev, FC_AUDSCHNL8, FC_AUDSCHNL8_OIEC_WORDLENGTH_MASK, value);
}
