...
//Input video mode: 1b: Interlaced 0b: Progressive
#define FC_INVIDCONF_R_V_BLANK_IN_OSC_MASK  0x00000002
//Used for CEA861-D modes with fractional Vblank
//(for example, modes 5, 6, 7, 10, 11, 20, 21, and 22)
#define FC_INVIDCONF_DVI_MODEZ_MASK  0x00000008
//Active low 0b: DVI mode selected 1b: HDMI mode selected
#define FC_INVIDCONF_DE_IN_POLARITY_MASK  0x00000010
//Data enable input polarity 1b: Active high 0b: Active low
#define FC_INVIDCONF_HSYNC_IN_POLARITY_MASK  0x00000020
//Hsync input polarity 1b: Active high 0b: Active low
#define FC_INVIDCONF_VSYNC_IN_POLARITY_MASK  0x00000040
//Vsync input polarity 1b: Active high 0b: Active low
#define FC_INVIDCONF_HDCP_KEEPOUT_MASK  0x00000080
//Start/stop HDCP keepout window generation 1b: Active
...
//Input video Horizontal active pixel region width (0
...
//Input video Horizontal blanking pixel region width this bit field holds
//bits 9:8 of number of Horizontal blanking pixels
#define FC_INHBLANK1_H_IN_BLANK_12_MASK  0x0000001C
//Input video Horizontal blanking pixel region width If configuration
//parameter DWC_HDMI_TX_14 = True (1), this bit field holds bit 12:10 of
...
//Input video Horizontal active edge delay
...
//Input video Vsync active pulse width
...
//Configuration of the control period minimum duration
//(minimum of 12 pixel clock cycles; refer to HDMI 1
...
//Configuration of the extended control period minimum duration
//(minimum of 32 pixel clock cycles; refer to HDMI 1
...
//Configuration of the maximum spacing between consecutive extended control
...
//When in control mode, configures 8 bits that fill the channel 0 data lines
...
//When in control mode, configures 6 bits that fill the channel 1 data lines
//not used to transmit the preamble (for more clarification, refer to the HDMI 1
...
//When in control mode, configures 6 bits that fill the channel 2 data lines
//not used to transmit the preamble (for more clarification, refer to the HDMI 1

//Frame Composer AVI Packet Configuration Register 3
#define FC_AVICONF3  0x0000405C
#define FC_AVICONF3_CN_MASK  0x00000003
//IT content type according to CEA the specification
#define FC_AVICONF3_YQ_MASK  0x0000000C
//YCC Quantization range according to the CEA specification
...
//Value of "set_avmute" in the GCP packet Once the AVmute is set, the frame
//composer schedules the GCP packet with AVmute set in the packet scheduler to
//be sent once (may only be transmitted between the active edge of VSYNC and
...
//Y2, Bit 2 of rgc_ycc_indication
...
//This register configures the Vendor Specific InfoFrame IEEE
...
//1b: layout 1 0b: layout 0 If DWC_HDMI_TX_20 is defined and register
//field fc_multistream_ctrl
...
//Sampling frequency (channel status bits 31 and 30)
...
//Configures the number of low priority packets or null packets consecutively
//attended before checking high priority queue status or audio samples
//availability
...
//ISRC1 Indication of packet continuation (ISRC2 will be transmitted)
#define FC_ISCR1_0_ISRC_VALID_MASK  0x00000002
//ISRC1 Valid control signal
...
//Frame Composer ISRC1 Packet Body Register 16; configures ISRC1 packet body
//of the ISRC1 packet
...
//Frame Composer ISRC2 Packet Body Register 15; configures the ISRC2 packet
//body of the ISRC2 packet
...
//Frame Composer Data Island Auto Packet Scheduling Register 0 Configures the
//Frame Composer RDRB(1)/Manual(0) data island packet insertion for SPD, VSD,
//ISRC2, ISRC1 and ACP packets
...
//Frame Composer Data Island Auto Packet Scheduling Register 1 Configures the
//Frame Composer (FC) RDRB frame interpolation for SPD, VSD, ISRC2, ISRC1 and
//ACP packet insertion on data island when FC is on RDRB mode for the listed
//packets
...
//Frame Composer Data Island Auto packet scheduling Register 2 Configures the
//Frame Composer (FC) RDRB line interpolation and number of packets in frame for
//SPD, VSD, ISRC2, ISRC1 and ACP packet insertion on data island when FC is on
...
//Frame Composer Data Island Manual Packet Request Register Requests to the
//Frame Composer the data island packet insertion for NULL, SPD, VSD, ISRC2,
//ISRC1 and ACP packets when FC_DATAUTO0 bit is in manual mode for the packet
//requested
...
//Frame Composer Data Island Auto Packet Scheduling Register 3 Configures the
//Frame Composer Automatic(1)/RDRB(0) data island packet insertion for AVI,
//GCP, AUDI and ACR packets
#define FC_DATAUTO3  0x000042DC
#define FC_DATAUTO3_ACR_AUTO_MASK  0x00000001
//Enables ACR packet insertion
#define FC_DATAUTO3_AUDI_AUTO_MASK  0x00000002
//Enables AUDI packet insertion
#define FC_DATAUTO3_GCP_AUTO_MASK  0x00000004
//Enables GCP packet insertion
#define FC_DATAUTO3_AVI_AUTO_MASK  0x00000008
//Enables AVI packet insertion
#define FC_DATAUTO3_AMP_AUTO_MASK  0x00000010
//Enables AMP packet insertion
#define FC_DATAUTO3_NVBI_AUTO_MASK  0x00000020
//Enables NTSC VBI packet insertion

//Frame Composer Round Robin ACR Packet Insertion Register 0 Configures the
//Frame Composer (FC) RDRB frame interpolation for ACR packet insertion on
...
//Frame Composer Round Robin ACR Packet Insertion Register 1 Configures the
//Frame Composer (FC) RDRB line interpolation and number of packets in frame
//for the ACR packet insertion on data island when FC is on RDRB mode this
//packet
...
//Frame Composer Round Robin AUDI Packet Insertion Register 2 Configures the
//Frame Composer (FC) RDRB frame interpolation for AUDI packet insertion on
//data island when FC is on RDRB mode for this packet
#define FC_RDRB2  0x000042E8
#define FC_RDRB2_AUDIFRAMEINTERPOLATION_MASK  0x0000000F
//Audio frame interpolation

//Frame Composer Round Robin AUDI Packet Insertion Register 3 Configures the
//Frame Composer (FC) RDRB line interpolation and number of packets in frame
//for the AUDI packet insertion on data island when FC is on RDRB mode this
//packet
...
//Frame Composer Round Robin GCP Packet Insertion Register 4 Configures the
//Frame Composer (FC) RDRB frame interpolation for GCP packet insertion on
//data island when FC is on RDRB mode for this packet
#define FC_RDRB4  0x000042F0
#define FC_RDRB4_GCPFRAMEINTERPOLATION_MASK  0x0000000F
//Frames interpolated between GCP packets

//Frame Composer Round Robin GCP Packet Insertion Register 5 Configures the
//Frame Composer (FC) RDRB line interpolation and number of packets in frame
//for the GCP packet insertion on data island when FC is on RDRB mode this
//packet
...
//Frame Composer Round Robin AVI Packet Insertion Register 6 Configures the
//Frame Composer (FC) RDRB frame interpolation for AVI packet insertion on
//data island when FC is on RDRB mode for this packet
#define FC_RDRB6  0x000042F8
#define FC_RDRB6_AVIFRAMEINTERPOLATION_MASK  0x0000000F
//Frames interpolated between AVI packets

//Frame Composer Round Robin AVI Packet Insertion Register 7 Configures the
//Frame Composer (FC) RDRB line interpolation and number of packets in frame
//for the AVI packet insertion on data island when FC is on RDRB mode this
//packet
...
//Mask bit for FC_INT2
#define FC_MASK2_LOWPRIORITY_OVERFLOW_MASK  0x00000002
//Mask bit for FC_INT2
#define FC_MASK2_DRM_MASK  0x00000010
// Mask bit for FC_INT2.DRM interrupt bit
...
//Configures the video pixel repetition ratio to be sent on the AVI InfoFrame
...
//When set (1'b1), this field activates the HDMI 2
...
//This field, when set (1'b1), activates the HDMI 2
...
//ACR packet transmission control 1b: Transmission enabled 0b: Transmission
//disabled
#define FC_PACKET_TX_EN_GCP_TX_EN_MASK  0x00000002
//GCP transmission control 1b: Transmission enabled 0b: Transmission disabled
#define FC_PACKET_TX_EN_AVI_TX_EN_MASK  0x00000004
//AVI packet transmission control 1b: Transmission enabled 0b: Transmission
//disabled
#define FC_PACKET_TX_EN_AUDI_TX_EN_MASK  0x00000008
//AUDI packet transmission control 1b: Transmission enabled 0b: Transmission
//disabled
#define FC_PACKET_TX_EN_AUT_TX_EN_MASK  0x00000010
//ACP, SPD, VSIF, ISRC1, and SRC2 packet transmission control 1b: Transmission
//enabled 0b: Transmission disabled
#define FC_PACKET_TX_EN_AMP_TX_EN_MASK  0x00000020
//AMP transmission control 1b: Transmission enabled 0b: Transmission disabled
#define FC_PACKET_TX_EN_NVBI_TX_EN_MASK  0x00000040
//NTSC VBI transmission control 1b: Transmission enabled 0b: Transmission
//disabled
#define FC_PACKET_TX_EN_DRM_TX_EN_MASK  0x00000080
//DRM transmission control 1b:Transmission enabled 0b:Transmission disblaed
...
//Active Space Handler Control 1b: Fixed active space value mode enabled
#define FC_ACTSPC_HDLR_CFG_ACTSPC_HDLR_TGL_MASK  0x00000002
//Active Space handler control 1b: Active space 1 value is different from
//Active Space 2 value
...
//2D Input video vertical active pixel region width
...
//Frame Composer GMD Packet Status Register Gamut metadata packet status bit
//information for no_current_gmd, next_gmd_field, gmd_packet_sequence and
...
//Frame Composer GMD Packet Enable Register This register enables Gamut
//metadata (GMD) packet transmission
#define FC_GMD_EN  0x00004404
#define FC_GMD_EN_GMDENABLETX_MASK  0x00000001
//Gamut Metadata packet transmission enable (1b)

//Frame Composer GMD Packet Update Register This register performs an GMD
//packet content update according to the configured packet body
//(FC_GMD_PB0 to FC_GMD_PB27) and packet header (FC_GMD_HB)
#define FC_GMD_UP  0x00004408
#define FC_GMD_UP_GMDUPDATEPACKET_MASK  0x00000001
//Gamut Metadata packet update

//Frame Composer GMD Packet Schedule Configuration Register This register
//configures the number of GMD packets to be inserted per frame (starting
//always in the line where the active Vsync appears) and the line spacing
//between the transmitted GMD packets
...
//Frame Composer GMD Packet Profile and Gamut Sequence Configuration Register
...
#define FC_DRM_UP_PACKET_UPDATE_MASK  0x00000001
//DRM packet update

//Frame Composer DRM Packet Header Register Array
#define FC_DRM_HB0_DATA_BYTE  0x000045A0
#define FC_DRM_HB1_DATA_BYTE  0x000045A4

//Frame Composer DRM Packet Body Register Array
#define FC_DRM_PB0_DATA_BYTE  0x000045A8
#define FC_DRM_PB1_DATA_BYTE  0x000045AC
#define FC_DRM_PB2_DATA_BYTE  0x000045B0
#define FC_DRM_PB3_DATA_BYTE  0x000045B4
#define FC_DRM_PB4_DATA_BYTE  0x000045B8
#define FC_DRM_PB5_DATA_BYTE  0x000045BC
#define FC_DRM_PB6_DATA_BYTE  0x000045C0
#define FC_DRM_PB7_DATA_BYTE  0x000045C4
#define FC_DRM_PB8_DATA_BYTE  0x000045C8
#define FC_DRM_PB9_DATA_BYTE  0x000045CC
#define FC_DRM_PB10_DATA_BYTE  0x000045D0
#define FC_DRM_PB11_DATA_BYTE  0x000045D4
#define FC_DRM_PB12_DATA_BYTE  0x000045D8
#define FC_DRM_PB13_DATA_BYTE  0x000045DC
#define FC_DRM_PB14_DATA_BYTE  0x000045E0
#define FC_DRM_PB15_DATA_BYTE  0x000045E4
#define FC_DRM_PB16_DATA_BYTE  0x000045E8
#define FC_DRM_PB17_DATA_BYTE  0x000045EC
#define FC_DRM_PB18_DATA_BYTE  0x000045F0
#define FC_DRM_PB19_DATA_BYTE  0x000045F4
#define FC_DRM_PB20_DATA_BYTE  0x000045F8
#define FC_DRM_PB21_DATA_BYTE  0x000045FC
#define FC_DRM_PB22_DATA_BYTE  0x00004600
#define FC_DRM_PB23_DATA_BYTE  0x00004604
#define FC_DRM_PB24_DATA_BYTE  0x00004608
#define FC_DRM_PB25_DATA_BYTE  0x0000460C



//Frame Composer video/audio Force Enable Register This register allows to
//force the controller to output audio and video data the values configured in
//the FC_DBGAUD and FC_DBGTMDS registers
#define FC_DBGFORCE  0x00004800
#define FC_DBGFORCE_FORCEVIDEO_MASK  0x00000001
//Force fixed video output with FC_DBGTMDSx register contents
#define FC_DBGFORCE_FORCEAUDIO_MASK  0x00000010
//Force fixed audio output with FC_DBGAUDxCHx register contents

//Frame Composer Audio Data Channel 0 Register 0 Configures the audio fixed
//data to be used in channel 0 when in fixed audio selection
...
//Frame Composer Audio Data Channel 0 Register 1 Configures the audio fixed
//data to be used in channel 0 when in fixed audio selection
...
//Frame Composer Audio Data Channel 0 Register 2 Configures the audio fixed
//data to be used in channel 0 when in fixed audio selection
...
//Frame Composer Audio Data Channel 1 Register 0 Configures the audio fixed
//data to be used in channel 1 when in fixed audio selection
...
//Frame Composer Audio Data Channel 1 Register 1 Configures the audio fixed
//data to be used in channel 1 when in fixed audio selection
...
//Frame Composer Audio Data Channel 1 Register 2 Configures the audio fixed
//data to be used in channel 1 when in fixed audio selection
...
//Frame Composer Audio Data Channel 2 Register 0 Configures the audio fixed
//data to be used in channel 2 when in fixed audio selection
...
//Frame Composer Audio Data Channel 2 Register 1 Configures the audio fixed
//data to be used in channel 2 when in fixed audio selection
...
//Frame Composer Audio Data Channel 2 Register 2 Configures the audio fixed
//data to be used in channel 2 when in fixed audio selection
...
//Frame Composer Audio Data Channel 3 Register 0 Configures the audio fixed
//data to be used in channel 3 when in fixed audio selection
...
//Frame Composer Audio Data Channel 3 Register 1 Configures the audio fixed
//data to be used in channel 3 when in fixed audio selection
...
//Frame Composer Audio Data Channel 3 Register 2 Configures the audio fixed
//data to be used in channel 3 when in fixed audio selection
...
//Frame Composer Audio Data Channel 4 Register 0 Configures the audio fixed
//data to be used in channel 4 when in fixed audio selection
...
//Frame Composer Audio Data Channel 4 Register 1 Configures the audio fixed
//data to be used in channel 4 when in fixed audio selection
...
//Frame Composer Audio Data Channel 4 Register 2 Configures the audio fixed
//data to be used in channel 4 when in fixed audio selection
...
//Frame Composer Audio Data Channel 5 Register 0 Configures the audio fixed
//data to be used in channel 5 when in fixed audio selection
...
//Frame Composer Audio Data Channel 5 Register 1 Configures the audio fixed
//data to be used in channel 5 when in fixed audio selection
...
//Frame Composer Audio Data Channel 5 Register 2 Configures the audio fixed
//data to be used in channel 5 when in fixed audio selection
...
//Frame Composer Audio Data Channel 6 Register 0 Configures the audio fixed
//data to be used in channel 6 when in fixed audio selection
...
//Frame Composer Audio Data Channel 6 Register 1 Configures the audio fixed
//data to be used in channel 6 when in fixed audio selection
...
//Frame Composer Audio Data Channel 6 Register 2 Configures the audio fixed
//data to be used in channel 6 when in fixed audio selection
...
//Frame Composer Audio Data Channel 7 Register 0 Configures the audio fixed
//data to be used in channel 7 when in fixed audio selection
...
//Frame Composer Audio Data Channel 7 Register 1 Configures the audio fixed
//data to be used in channel 7 when in fixed audio selection
...
//Frame Composer Audio Data Channel 7 Register 2 Configures the audio fixed
//data to be used in channel 7 when in fixed audio selection
