...
#define FC_MASK2_DRM_MASK  0x00000010  // Mask bit for FC_INT2.DRM interrupt bit
...
#define FC_PACKET_TX_EN_DRM_TX_EN_MASK  0x00000080 //DRM transmission control 1b:Transmission enabled 0b:Transmission disblaed
...
#define FC_DRM_UP_PACKET_UPDATE_MASK  0x00000001 //DRM packet update
