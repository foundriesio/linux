...
//HDCP clock synchronous disable signal

//Main Controller Software Reset Register Main controller software reset request
//per clock domain
...
//Pixel Repetition software reset request
#define MC_SWRSTZREQ_II2SSWRST_REQ_MASK  0x00000008
//I2S audio software reset request
#define MC_SWRSTZREQ_ISPDIFSWRST_REQ_MASK  0x00000010
//SPDIF audio software reset request
...
//Video path Feed Through enable bit: - 1b: Color Space Converter is in the
//video data path

//Main Controller PHY Reset Register
#define MC_PHYRSTZ  0x00010014
#define MC_PHYRSTZ_PHYRSTZ_MASK  0x00000001
//HDMI Source PHY active low reset control for PHY GEN1, active high reset
//control for PHY GEN2
