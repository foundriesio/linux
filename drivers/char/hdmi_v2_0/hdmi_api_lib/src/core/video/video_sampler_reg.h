...
//0x03: RGB 4:4:4/10 bits 0x05: RGB 4:4:4/12 bits
...
//This register defines the value of gydata[15:8] when TX_INSTUFFING[0]
//(gydata_stuffing) is set to 1b

//Video Input rcr Data Channel Stuffing Register 0
#define TX_RCRDATA0  0x00000810
#define TX_RCRDATA0_RCRDATA_MASK  0x000000FF
//This register defines the value of rcrydata[7:0] when TX_INSTUFFING[1]
...
//This register defines the value of rcrydata[15:8] when TX_INSTUFFING[1]
//(rcrdata_stuffing) is set to 1b

//Video Input bcb Data Channel Stuffing Register 0
#define TX_BCBDATA0  0x00000818
#define TX_BCBDATA0_BCBDATA_MASK  0x000000FF
//This register defines the value of bcbdata[7:0] when TX_INSTUFFING[2]
...
//This register defines the value of bcbdata[15:8] when TX_INSTUFFING[2]
//(bcbdata_stuffing) is set to 1b
