...
int32_t tcc_hsm_sp_cmd_get_version(
	uint32_t device_id, uint32_t *major, uint32_t *minor);
int32_t tcc_hsm_sp_cmd_set_mode(
	uint32_t device_id, uint32_t keyIndex, uint32_t algorithm,
	uint32_t opMode, uint32_t residual, uint32_t sMsg);
int32_t tcc_hsm_sp_cmd_set_key(
	uint32_t device_id, uint32_t keyIndex, uint32_t keyType,
	uint32_t keyMode, uint8_t *key, uint32_t keySize);
int32_t tcc_hsm_sp_cmd_set_iv(
	uint32_t device_id, uint32_t keyIndex, uint8_t *iv, uint32_t ivSize);
int32_t tcc_hsm_sp_cmd_set_kldata(
	uint32_t device_id, uint32_t keyIndex, uintptr_t *klData,
	uint32_t klDataSize);
