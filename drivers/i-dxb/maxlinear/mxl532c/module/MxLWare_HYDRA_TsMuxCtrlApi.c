...
// move to here from  MxL_HYDRA_CfgTSPadMux() because of  compile warning: the frame size of 1120 bytes is larger than 1024 bytes [-Wframe-larger-than=]
MXL_REG_FIELD_T mxl561_568_xpt_ts[MXL_HYDRA_DEMOD_MAX][MXL_HYDRA_XPT_TS_MAX] = {
...
MXL_REG_FIELD_T mxl541_581_xpt_ts[MXL_HYDRA_DEMOD_MAX][MXL_HYDRA_XPT_TS_MAX] = {
// Data                         // Clock                       // Sync                        // Valid
...
MXL_REG_FIELD_T mxl582_584_xpt_ts[MXL_HYDRA_DEMOD_MAX][MXL_HYDRA_XPT_TS_MAX] = {
// Data                         // Clock                       // Sync                        // Valid
...
MXL_REG_FIELD_T mxl544_xpt_ts[MXL_HYDRA_DEMOD_MAX][MXL_HYDRA_XPT_TS_MAX] = {
// Data                         // Clock                       // Sync                        // Valid
...
MXL_REG_FIELD_T xpt_demod_sel[MXL_HYDRA_DEMOD_MAX] = {
                                                    {XPT_DMD0_SEL},
                                                    {XPT_DMD1_SEL},
                                                    {XPT_DMD2_SEL},
                                                    {XPT_DMD3_SEL},
