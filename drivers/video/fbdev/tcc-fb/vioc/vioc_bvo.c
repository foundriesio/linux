...
struct bvo_spec bvo_spec_val[BVO_TIMING_MAX] = {
	// bvo_timing, HSIZE, VSIZE, PXDW, CLKDIV, IV, IH, IP, DP, NI,
	// TV, LPW, LPC, LSWC, LEWC, FPW, FLC, FSWC, FEWC, FPW2, FLC2,
	// FSWC2, FEWC2
	{BVO_TIMING_NTSC,
	 720,
	 480,
...
struct bvo_regs bvo_regs_val[BVO_FMT_MAX] = {
	/*
	 * {  bvo_format,   BVO_XOFF,   BVO_YOFF,      conv0,
	 *  conv1,      conv2,      conv3,      conv4,      conv5,
	 *  SCPHASE,    nothing,    CONFIG1,       SIZE,         HS,
	 *  VSOL,       VSOH,        SEL,        SEH,   HD_hsync,
	 *  HD_vsync,       CGMS,     CC_AGC,    TCONFIG,    txt_cfg,
	 *  CONFIG2,     CHROMA,timing_sync,
	 *  N0_N22,N1_N2_N3_N4,N5_N6_N7_N8,
	 *  N9_N10_N11,N12_N13_N14,N15_N16_N17,N19_N20_N21,
	 *  ROUNDSTEP,ext_rst_dr0,ext_rst_dr1,ext_rst_dr2,ext_rst_dr3,
	 *  STARV0,     STARV1,     STARV2,     STARV3,    VBICTRL,
	 *  VBIDATA0,   VBIDATA1,   VBIDATA2,   VBIDATA3,    SIGDATA}
	 */
	{BVO_FMT_NTSC_J, 0x000001FC, 0x00120012, 0x00001000, 0x00000000,
	 0x00001000,     0x00000000, 0x00001000, 0x00000000, 0x000003BC,
	 REG_VAL_NA,     0xBC06002A, 0x020D0D68, 0x00F80000, 0x00000001,
	 0x00F80004,     0x06B40107, 0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,     REG_VAL_NA, 0x00000000, REG_VAL_NA, 0x0FFF0801,
	 0x00000000,     REG_VAL_NA, 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,     0x00000000, 0x00000000, 0x00000000, 0x00F62081,
	 REG_VAL_NA,     REG_VAL_NA, REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x801E0B40,     0x00000960, 0x03E80D48, REG_VAL_NA, REG_VAL_NA,
	 REG_VAL_NA,     REG_VAL_NA, REG_VAL_NA, 0x00000000},
	{BVO_FMT_NTSC_M, 0x000001FC, 0x00120012, 0x00001000, 0x00000000,
	 0x00001000,     0x00000000, 0x00001000, 0x00000000, 0x000003BC,
	 REG_VAL_NA,     0xBC06000A, 0x020D0D68, 0x00F80000, 0x00000001,
	 0x00F80004,     0x06B40107, 0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,     REG_VAL_NA, 0x00000000, REG_VAL_NA, 0x0FFF0801,
	 0x00000000,     REG_VAL_NA, 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,     0x00000000, 0x00000000, 0x00000000, 0x00F62081,
	...
	{BVO_FMT_NTSC_M_MV, 0x000001FC, 0x00120012, 0x00001000,
	 ...
	 0x00000000,	0x000003BC, REG_VAL_NA, 0xBC06000A,
	 0x020D0D68,	0x00F80000, 0x00000001, 0x00F80004,
	 0x06B40107,	0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,	0x00070000, 0x00000000, REG_VAL_NA,
	 0x0FFF0801,	0x00000000, REG_VAL_NA, 0x0000003B,
	 0x1125111D,	0x1B000701, 0x07F8241B, 0x0F0F000C,
	 0x02080060,	0x03FF0205, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x801E0B40,	0x00000960, 0x03E80D48, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_60, 0x000001FC, 0x00120012, 0x00001000, 0x00000000,
	 0x00001000,     0x00000000, 0x00001000, 0x00000000, 0x000003AC,
	 REG_VAL_NA,     0xBC0600AA, 0x020D0D68, 0x00F80000, 0x00000001,
	 0x00F80004,     0x06B40107, 0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,     REG_VAL_NA, 0x00000000, REG_VAL_NA, 0x0FFF0801,
	 0x00000000,     REG_VAL_NA, 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,     0x00000000, 0x00000000, 0x00000000, 0x00F62081,
	...
	{BVO_FMT_PAL_60_MV, 0x000001FC, 0x00120012, 0x00001000,
	 0x00000000,	0x00001000, 0x00000000, 0x00001000,
	 0x00000000,	0x000003AC, REG_VAL_NA, 0xBC0600AA,
	 0x020D0D68,	0x00F80000, 0x00000001, 0x00F80004,
	 0x06B40107,	0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,	0x00070000, 0x00000000, REG_VAL_NA,
	 0x0FFF0801,	0x00000000, REG_VAL_NA, 0x0000003E,
	 0x1125111D,	0x1B000701, 0x07F8241B, 0x0F0F000C,
	 0x02080060,	0x03FF0205, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x801E0B40,	0x00000960, 0x03E80D48, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_BG, 0x00000260, 0x00160016, 0x00001000, 0x00000000,
	 0x00001000,     0x00000000, 0x00001000, 0x00000000, 0x000003B4,
	 REG_VAL_NA,     0xBC06006A, 0x02710D80, 0x00FC0000, 0x00000001,
	 0x00FC0003,     0x06C00139, 0x07BC013B, REG_VAL_NA, REG_VAL_NA,
	 0x00000000,     REG_VAL_NA, 0x00000000, REG_VAL_NA, 0x0FFF0801,
	 0x00000000,     REG_VAL_NA, 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,     0x00000000, 0x00000000, 0x00000000, 0x00F62081,
	 REG_VAL_NA,     REG_VAL_NA, REG_VAL_NA, REG_VAL_NA, 0x00002424,
	 0x80240B40,     0x00000960, 0x03E80D48, REG_VAL_NA, REG_VAL_NA,
	 REG_VAL_NA,     REG_VAL_NA, REG_VAL_NA, 0x00000000},
	{BVO_FMT_PAL_BG_MV, 0x00000260, 0x00160016, 0x00001000,
	 0x00000000,	0x00001000, 0x00000000, 0x00001000,
	 0x00000000,	0x000003B4, REG_VAL_NA, 0xBC06006A,
	 0x02710D80,	0x00FC0000, 0x00000001, 0x00FC0003,
	 0x06C00139,	0x07BC013B, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,	0x00070000, 0x00000000, REG_VAL_NA,
	 0x0FFF0801,	0x00000000, REG_VAL_NA, 0x0000002B,
	 0x222A221A,	0x1C030205, 0x03FE143D, 0x7EFE0154,
	 0x02060160,	0x01550504, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, 0x00002424,
	 0x80240B40,	0x00000960, 0x03E80D48, REG_VAL_NA,
	 REG_VAL_NA,	REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_BG_WSS, 0x00000260, 0x00160016, 0x00001000,
	 0x00000000,	 0x00001000, 0x00000000, 0x00001000,
	 0x00000000,	 0x000003B4, REG_VAL_NA, 0xBC06006A,
	 0x02710D80,	 0x00FC0000, 0x00000001, 0x00FC0003,
	 0x06C00139,	 0x07BC013B, REG_VAL_NA, REG_VAL_NA,
	 0x00A00CCA,	 REG_VAL_NA, 0x00000000, REG_VAL_NA,
	 0x0FFF0801,	 0x00000000, REG_VAL_NA, 0x00000000,
	 0x00000000,	 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,	 0x00000000, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,	 REG_VAL_NA, REG_VAL_NA, 0x00002424,
	 0x80240B40,	 0x00000960, 0x03E80D48, REG_VAL_NA,
	 REG_VAL_NA,	 REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_BG_WSS_MV,
	 ...
	 REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_M, 0x000001FC, 0x00120012, 0x00001000, 0x00000000,
	 0x00001000,    0x00000000, 0x00001000, 0x00000000, 0x000003BC,
	 REG_VAL_NA,    0xBC0600FA, 0x020D0D68, 0x00F80000, 0x00000001,
	 0x00F80004,    0x06B40107, 0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,    REG_VAL_NA, REG_VAL_NA, REG_VAL_NA, 0x0FFF0801,
	 0x00000000,    REG_VAL_NA, 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,    0x00000000, 0x00000000, 0x00000000, 0x00F62081,
	 REG_VAL_NA,    REG_VAL_NA, REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x801E0B40,    0x00000960, 0x03E80D48, REG_VAL_NA, REG_VAL_NA,
	...
	{BVO_FMT_PAL_M_MV, 0x000001FC, 0x00120012, 0x00001000,
	 0x00000000,       0x00001000, 0x00000000, 0x00001000,
	 0x00000000,       0x000003BC, REG_VAL_NA, 0xBC0600FA,
	 0x020D0D68,       0x00F80000, 0x00000001, 0x00F80004,
	 0x06B40107,       0x07AC010A, REG_VAL_NA, REG_VAL_NA,
	 0x00200000,       0x00070000, REG_VAL_NA, REG_VAL_NA,
	 0x0FFF0801,       0x00000000, REG_VAL_NA, 0x0000003A,
	 0x1125111D,       0x1B000701, 0x07F8241B, 0x0F0F000C,
	 0x02080060,       0x03FF0205, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,       REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x801E0B40,       0x00000960, 0x03E80D48, REG_VAL_NA,
	 REG_VAL_NA,       REG_VAL_NA, REG_VAL_NA, REG_VAL_NA,
	 0x00000000},
	{BVO_FMT_PAL_NC_WSS, 0x00000260, 0x00160016, 0x00001000,
	 0x00000000,	 0x00001000, 0x00000000, 0x00001000,
	 0x00000000,	 0x000003B4, REG_VAL_NA, 0xBC06006A,
	 0x02710D80,	 0x00FC0000, 0x00000001, 0x00FC0003,
	 0x06C00139,	 0x07BC013B, REG_VAL_NA, REG_VAL_NA,
	 0x00A00C02,	 REG_VAL_NA, 0x00000000, REG_VAL_NA,
	 0x0FFF0C01,	 0x00000000, REG_VAL_NA, 0x00000000,
	 0x00000000,	 0x00000000, 0x00000000, 0x00000000,
	 0x00000000,	 0x00000000, 0x00F62081, REG_VAL_NA,
	 REG_VAL_NA,	 REG_VAL_NA, REG_VAL_NA, 0x00002424,
	 0x80240B40,	 0x00000960, 0x03E80D48, REG_VAL_NA,
...
#define bvo_read(val, base, off)                                           \
	do {                                                               \
		...
		pr_info("0x%02x: 0x%08x -> 0x%08x %s\n", off, val, r,      \
			(val != r) ? ((val == REG_VAL_NA) ? "Don't care" : \
							    "mismatch") :  \
				     "");                                  \
	} while (0)
...
void internal_tve_init(void)
{
	...
	// dprintk("%s\n", __func__);
	//
	// ViocTve_np = of_find_compatible_node(NULL, NULL,
	// "telechips,tcc-tve");
	//
	// if (ViocTve_np) {
 ...
 */
void internal_tve_set_cgms_helper(
	unsigned char odd_field_en, unsigned char even_field_en,
	unsigned int key)
{
