...
#define DRV_MODULE_VERSION "Telechips GMAC\n"
...
struct tcc_gmac_core_ops {
	...
	void (*timestamp_irq_enable)(void __iomem *ioaddr);
	void (*timestamp_irq_disable)(void __iomem *ioaddr);
};
...
struct tcc_gmac_ptp_ops {
	int (*init)(void __iomem *ioaddr, u32 sec, u32 nsec);
	void (*set_ssinc)(void __iomem *ioaddr, unsigned int ssinc);
	void (*digital_rollover_enable)(void __iomem *ioaddr);
	void (*digital_rollover_disable)(void __iomem *ioaddr);
	void (*enable)(void __iomem *ioaddr);
	void (*disable)(void __iomem *ioaddr);
	void (*trig_irq_enable)(void __iomem *ioaddr);
	void (*trig_irq_disable)(void __iomem *ioaddr);
