...
static ssize_t hevc_power_store(struct class *cls, struct class_attribute *attr, const char *buf, size_t count);
static ssize_t hevc_power_show(struct class *cls, struct class_attribute *attr, char *buf);
static ssize_t vp9_power_store(struct class *cls, struct class_attribute *attr, const char *buf, size_t count);
static ssize_t vp9_power_show(struct class *cls, struct class_attribute *attr, char *buf);
...
static struct class_attribute clktest_class_attrs[] = {
	...
	__ATTR(hevc_power, S_IRUGO | S_IWUSR , hevc_power_show, hevc_power_store),
	__ATTR(vp9_power, S_IRUGO | S_IWUSR , vp9_power_show, vp9_power_store),
...
static ssize_t hevc_power_store(struct class *cls, struct class_attribute *attr, const char *buf, size_t count)
{
	...
	printk("Video HEVC Power Control\n");
	error = kstrtoul(buf, 10, &data);
	if(error)
		return error;
	...
	printk("Video HEVC Power Control done\n");
...
static ssize_t vp9_power_store(struct class *cls, struct class_attribute *attr, const char *buf, size_t count)
{
	...
	printk("Video VP9 Power Control\n");
	error = kstrtoul(buf, 10, &data);
	if(error)
		return error;
	...
	printk("Video VP9 Power Control done\n");
