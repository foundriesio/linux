...
#ifdef	CONFIG_PM
/*-------------------------------------------------------------------------*/
#if !defined (CONFIG_ARCH_TCC896X) && !defined(CONFIG_ARCH_TCC802X) && !defined(CONFIG_ARCH_TCC899X) && !defined(CONFIG_ARCH_TCC803X) && !defined(CONFIG_ARCH_TCC901X) && !defined(CONFIG_ARCH_TCC805X)
