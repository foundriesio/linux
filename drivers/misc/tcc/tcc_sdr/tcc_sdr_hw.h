...
#define DRMR_RADIO_FIFO_THRESH_Msk			(3U << DRMR_RADIO_FIFO_THRESH_Pos)
#define DRMR_RADIO_FIFO_THRESH_64			(0U << DRMR_RADIO_FIFO_THRESH_Pos)
#define DRMR_RADIO_FIFO_THRESH_128			(1U << DRMR_RADIO_FIFO_THRESH_Pos)
#define DRMR_RADIO_FIFO_THRESH_256			(2U << DRMR_RADIO_FIFO_THRESH_Pos)

#define DRMR_RADIO_PORTSEL_Pos			(8)
#define DRMR_RADIO_PORTSEL_Msk			(3U << DRMR_RADIO_PORTSEL_Pos)
#define DRMR_RADIO_PORTSEL_1			(0U << DRMR_RADIO_PORTSEL_Pos)
#define DRMR_RADIO_PORTSEL_2			(1U << DRMR_RADIO_PORTSEL_Pos)
#define DRMR_RADIO_PORTSEL_4			(2U << DRMR_RADIO_PORTSEL_Pos)

#define DRMR_RADIO_ENABLE_MODE_Pos			(4)
#define DRMR_RADIO_ENABLE_MODE_Msk			(1U << DRMR_RADIO_ENABLE_MODE_Pos)
#define DRMR_RADIO_DISABLE					(0U << DRMR_RADIO_ENABLE_MODE_Pos)
#define DRMR_RADIO_ENABLE					(1U << DRMR_RADIO_ENABLE_MODE_Pos)

#define DRMR_RADIO_BITMODE_Pos	(0)
#define DRMR_RADIO_BITMODE_Msk	(0xFU << DRMR_RADIO_BITMODE_Pos)
#define DRMR_RADIO_BITMODE_16	(0U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_20	(1U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_24	(2U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_30	(3U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_32	(4U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_40	(5U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_48	(6U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_60	(7U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_64	(8U << DRMR_RADIO_BITMODE_Pos)	
#define DRMR_RADIO_BITMODE_80	(9U << DRMR_RADIO_BITMODE_Pos)	
