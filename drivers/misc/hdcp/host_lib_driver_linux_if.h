...
#ifndef __HOST_LIB_DRIVER_LINUX_IF_H
#define __HOST_LIB_DRIVER_LINUX_IF_H
 ...
 * reported.
 */
#define HL_DRV_IOC_MEMINFO	_IOR('H', HL_DRV_NR_MEMINFO, \
 ...
 * return -EBUSY.
 */
#define HL_DRV_IOC_LOAD_CODE	_IOW('H', HL_DRV_NR_LOAD_CODE, \
 ...
 *
 */
#define HL_DRV_IOC_READ_DATA	_IOWR('H', HL_DRV_NR_READ_DATA, \
				      struct hl_drv_ioc_data)
#define HL_DRV_IOC_WRITE_DATA	_IOW('H', HL_DRV_NR_WRITE_DATA, \
				      struct hl_drv_ioc_data)
 ...
 */
#define HL_DRV_IOC_MEMSET_DATA	_IOW('H', HL_DRV_NR_MEMSET_DATA, \
				     struct hl_drv_ioc_data)
 ...
 */
#define HL_DRV_IOC_READ_HPI	_IOWR('H', HL_DRV_NR_READ_HPI, \
				      struct hl_drv_ioc_hpi_reg)
#define HL_DRV_IOC_WRITE_HPI	_IOW('H', HL_DRV_NR_WRITE_HPI, \
				     struct hl_drv_ioc_hpi_reg)
...
#endif // __HOST_LIB_DRIVER_LINUX_IF_H
