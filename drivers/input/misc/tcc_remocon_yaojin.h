/*
 * IR driver for remote controller : tcc_remocon_yaojin.h
 *
...
#ifndef __TCC_REMOCON_YAOJIN_H__
#define __TCC_REMOCON_YAOJIN_H__
...
#endif	// __TCC_REMOCON_YAOJIN_H__
