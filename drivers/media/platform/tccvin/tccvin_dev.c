...
int tccvin_set_scaler(tccvin_cif_t * cif, struct tccvin_v4l2 * v4l2) {
	...
	unsigned int	width	= v4l2->vin_window.width;
	unsigned int	height	= v4l2->vin_window.height;
...
int tccvin_set_wmixer(tccvin_dev_t * vdev) {
	...
	VIOC_WMIX_SetPosition(pWMIXer, 0, vdev->v4l2.vin_window.left, vdev->v4l2.vin_window.top);
...
int tccvin_cif_set_resolution(tccvin_dev_t * vdev, unsigned int width, unsigned int height, unsigned int pixelformat) {
	...
	vdev->v4l2.vin_window.left		= 0;
	vdev->v4l2.vin_window.top		= 0;
	vdev->v4l2.vin_window.width		= vdev->v4l2.format.fmt.pix.width;
	vdev->v4l2.vin_window.height		= vdev->v4l2.format.fmt.pix.height;
