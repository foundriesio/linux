...
// video source
#include "../videosource/videosource_types.h"
...
typedef struct tccvin_cif {
	// videosource
	videosource_format_t		videosource_format;
...
extern int tccvin_g_operation_mode(tccvin_dev_t * vdev, int * mode);
extern int tccvin_s_operation_mode(tccvin_dev_t * vdev, int * mode);
...
extern int tccvin_v4l2_streamon(tccvin_dev_t * vdev, int is_handover_needed);
extern int	tccvin_v4l2_streamoff(tccvin_dev_t * vdev, int is_handover_needed);
