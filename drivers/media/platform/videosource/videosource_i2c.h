...
extern int DDI_I2C_Write_Remote(unsigned short remote_addr, unsigned char* data, unsigned short reg_bytes, unsigned short data_bytes);
extern int DDI_I2C_Read_Remote(unsigned short remote_addr, unsigned short reg, unsigned char reg_bytes, unsigned char * val, unsigned short val_bytes);
