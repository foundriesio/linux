...
/*******************************************************************************
*
*    TCC805x DataSheet PART 9 CM BUS
*
********************************************************************************/
...
} CM_VPIC_IRQEN0_IDX_TYPE;

typedef union {
    unsigned long				nREG;
    CM_VPIC_IRQEN0_IDX_TYPE     bREG;
} CM_VPIC_IRQEN0_TYPE;

typedef struct {
    unsigned VPIC_IRQEN1       :32;
} CM_VPIC_IRQEN1_IDX_TYPE;

typedef union {
    unsigned long				nREG;
    CM_VPIC_IRQEN1_IDX_TYPE     bREG;
} CM_VPIC_IRQEN1_TYPE;

typedef struct {
    unsigned VPIC_IRQEN2       :32;
} CM_VPIC_IRQEN2_IDX_TYPE;

typedef union {
    unsigned long				nREG;
    CM_VPIC_IRQEN2_IDX_TYPE     bREG;
} CM_VPIC_IRQEN2_TYPE;
...
typedef struct _CM_TSD_CFG {
    ...
    unsigned                VPIC_IRQEN_0;   // 0x2C
    unsigned                VPIC_IRQEN_1;   // 0x30
    unsigned                VPIC_IRQEN_2;   // 0x34
    unsigned                :32;            // 0x38
    unsigned                :32;            // 0x3C
