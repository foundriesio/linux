...
struct CM_VPIC_IRQEN0_IDX_TYPE {
	unsigned VPIC_IRQEN0:32;
};

union CM_VPIC_IRQEN0_TYPE {
	unsigned long nREG;
	struct CM_VPIC_IRQEN0_IDX_TYPE bREG;
};

struct CM_VPIC_IRQEN1_IDX_TYPE {
	unsigned VPIC_IRQEN1:32;
};

union CM_VPIC_IRQEN1_TYPE {
	unsigned long nREG;
	struct CM_VPIC_IRQEN1_IDX_TYPE bREG;
};

struct CM_VPIC_IRQEN2_IDX_TYPE {
	unsigned VPIC_IRQEN2:32;
};

union CM_VPIC_IRQEN2_TYPE {
	unsigned long nREG;
	struct CM_VPIC_IRQEN2_IDX_TYPE bREG;
};
...
struct _CM_TSD_CFG {
	...
	unsigned int VPIC_IRQEN_0;	// 0x2C
	unsigned int VPIC_IRQEN_1;	// 0x30
	unsigned int VPIC_IRQEN_2;	// 0x34
	unsigned:32;		// 0x38
	unsigned:32;		// 0x3C
