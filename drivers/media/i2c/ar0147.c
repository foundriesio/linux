...
const struct reg_sequence ar0147_reg_init[] = {
	/*
	 * [1280x990 30fps parallel 12bit]
	 * 1280x944 is video data resolution
	 * 1280x990 is total resolution including embedded data
	 */
	...
	{0x33E0, 0x0C80, 0}, // TEST_ASIL_ROWS
	{0x3004, 0x0020, 0}, // X_ADDR_START_
	{0x3008, 0x051F, 0}, // X_ADDR_END_
	{0x3002, 0x000C, 0}, // Y_ADDR_START_
	{0x3006, 0x03BB, 0}, // Y_ADDR_END_
